...
To generate a modulemap to expose iegen generated bindings as a framework submodule add another project configuration file containing the following configuration:

.. literalinclude:: /../examples/feautures/modulemap/HelloExample/HelloExample/cxx/modulemap.iegen.yaml
   :language: yaml
