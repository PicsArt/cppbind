...
internal constructor(_id: Long) : AutoCloseable {
    ...
    fun getStringMap(): Map<String, String> {
        ...
        for (i in 0..result.first.size - 1) {
            ...
            val jdk_to_kotlin_elem1_result = elem1_result as String
            val jdk_to_kotlin_elem2_result = elem2_result as String
            jdk_to_kotlin_result.put(jdk_to_kotlin_elem1_result, jdk_to_kotlin_elem2_result)
        }
