...
internal constructor(obj: IEGenObject) : AutoCloseable {
    companion object {
        ...
        const val iegenCxxTypeName: String = "iegen::example::MapItem"
    }
...
internal constructor(obj: IEGenObject) : AutoCloseable {
    companion object {
        ...
        const val iegenCxxTypeName: String = "iegen::example::MapExamples"
    }
    ...
    fun getMixedMap(): Map<String, MapItem> {
        ...
        for (i_result in 0..result.first.size - 1) {
            ...
            val jdktokotlinelem2_result = MapItem(IEGenObject(elem2_result, true))
