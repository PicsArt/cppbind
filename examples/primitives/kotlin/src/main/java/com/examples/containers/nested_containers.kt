 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 09/14/2021-13:38.
...
internal constructor(_id: Long) : AutoCloseable {
    ...
    fun getNestedIntVector(): List<List<Int>> {
        ...
        for (value_result in result) {
            val actual_value_result = value_result as IntArray
    ...
    fun getNestedIntMap(): Map<Int, Map<Int, Int>> {
        ...
        for (i_result in 0..result.first.size - 1) {
            ...
            val elem2_result = result.second.get(i_result) as Pair<IntArray, IntArray>
    ...
    fun mixedExampleWithManyArgs(v1: List<List<Int>>, v2: List<List<Int>>, m1: Map<Int, Map<Int, Int>>, m2: Map<Int, Map<Int, Int>>): Unit {
        ...
        val result = jMixedexamplewithmanyargs(getObjId(), kotlin_to_jdk_v1, kotlin_to_jdk_v2, kotlin_to_jdk_m1, kotlin_to_jdk_m2)
    ...
    fun setVectorOfIntMaps(v: List<Map<Int, Int>>): Unit {
        ...
        val result = jSetvectorofintmaps(getObjId(), kotlin_to_jdk_v)
        
        return result
    }

    fun getVectorOfIntMaps(): List<Map<Int, Int>> {
        val result = jGetvectorofintmaps(getObjId())
        val jdk_to_kotlin_result: MutableList<Map<Int, Int>> = mutableListOf()
        for (value_result in result) {
            val actual_value_result = value_result as Pair<IntArray, IntArray>
    ...
    fun setMapOfIntVectors(m: Map<Int, List<Int>>): Unit {
        ...
        val result = jSetmapofintvectors(getObjId(), kotlin_to_jdk_m)
        
        return result
    }

    fun getMapOfIntVectors(): Map<Int, List<Int>> {
        val result = jGetmapofintvectors(getObjId())
        val jdk_to_kotlin_result = HashMap<Int, List<Int>>()
        for (i_result in 0..result.first.size - 1) {
            val elem1_result = result.first.get(i_result)
            val elem2_result = result.second.get(i_result) as IntArray
    ...
    fun setComplexStringVector(v: List<List<List<String>>>): Unit {
        ...
        val result = jSetcomplexstringvector(getObjId(), kotlin_to_jdk_v)
        
        return result
    }

    fun getComplexStringVector(): List<List<List<String>>> {
        val result = jGetcomplexstringvector(getObjId())
        val jdk_to_kotlin_result: MutableList<List<List<String>>> = mutableListOf()
        for (value_result in result) {
            val actual_value_result = value_result as ObjectArray
            val jdk_to_kotlin_actual_value_result: MutableList<List<String>> = mutableListOf()
            for (value_actual_value_result in actual_value_result) {
                val actual_value_actual_value_result = value_actual_value_result as ObjectArray
                ...
                for (value_actual_value_actual_value_result in actual_value_actual_value_result) {
                    val actual_value_actual_value_actual_value_result = value_actual_value_actual_value_result as String
    ...
    fun setComplexStringMap(m: Map<String, Map<String, Map<String, String>>>): Unit {
        ...
        val result = jSetcomplexstringmap(getObjId(), kotlin_to_jdk_m)
        
        return result
    }

    fun getComplexStringMap(): Map<String, Map<String, Map<String, String>>> {
        val result = jGetcomplexstringmap(getObjId())
        val jdk_to_kotlin_result = HashMap<String, Map<String, Map<String, String>>>()
        for (i_result in 0..result.first.size - 1) {
            val elem1_result = result.first.get(i_result) as String
            val elem2_result = result.second.get(i_result) as Pair<ObjectArray, ObjectArray>
            
            val jdk_to_kotlin_elem2_result = HashMap<String, Map<String, String>>()
            for (i_elem2_result in 0..elem2_result.first.size - 1) {
                val elem1_elem2_result = elem2_result.first.get(i_elem2_result) as String
                val elem2_elem2_result = elem2_result.second.get(i_elem2_result) as Pair<ObjectArray, ObjectArray>
                
                val jdk_to_kotlin_elem2_elem2_result = HashMap<String, String>()
                for (i_elem2_elem2_result in 0..elem2_elem2_result.first.size - 1) {
                    val elem1_elem2_elem2_result = elem2_elem2_result.first.get(i_elem2_elem2_result) as String
                    val elem2_elem2_elem2_result = elem2_elem2_result.second.get(i_elem2_elem2_result) as String
