...
internal constructor(_id: Long) : AutoCloseable {
    ...
    ///// External wrapper functions ////////////
    private external fun jAddintvector(id: Long, v: IntArray, __err_obj__: ErrorObj): Unit
    private external fun jAddobjvector(id: Long, v: LongArray, __err_obj__: ErrorObj): Unit
    private external fun jAddstringvector(id: Long, v: StringArray, __err_obj__: ErrorObj): Unit
    private external fun jGetstringvector(id: Long, __err_obj__: ErrorObj): StringArray
    private external fun jGetobjvector(id: Long, __err_obj__: ErrorObj): LongArray
    private external fun jGetintvector(id: Long, __err_obj__: ErrorObj): IntArray
    private external fun jSet_this(id: Long, self: Any): Unit
    private external fun jFinalize(id: Long): Unit
}