...
internal constructor(obj: CppBindObject) : AutoCloseable, Exception() {
    companion object {
        ...
        protected fun constructHelper(err_num: Int): Long {
        ...
        public fun cppbindConstructObject(id: Long, owner: Boolean = false): SimpleBaseException {
            ...
            val obj : SimpleBaseException
            when (idType) {
                SimpleChildException.cppbindCxxTypeName -> obj = SimpleChildException(CppBindObject(id, owner))
                else -> obj = SimpleBaseException(CppBindObject(id, owner))
            }
            return obj
        }
    }
    ...
    constructor(err_num: Int): this(CppBindObject(constructHelper(err_num), true)) {
    }
