...
internal constructor(_id: Long) : StdException(_id) {
    ...
    private external fun jWhat(id: Long, __err_obj__: ErrorObj): String
}
...
internal constructor(_id: Long) : AutoCloseable, Exception() {
    ...
    ///// External wrapper functions ////////////
    private external fun jErrnum(id: Long, __err_obj__: ErrorObj): Int
...
internal constructor(_id: Long) : AutoCloseable {
    ...
    val value: Int
        get() {
            val err = ErrorObj()
            val result = jValue(getObjId(), err)
            if (err.typeId != 0) {
                when (err.typeId) {
                    1 -> {
                        val excObj = StdException(err.ptrId)
    ...
    ///// External wrapper functions ////////////
    private external fun jValue(id: Long, __err_obj__: ErrorObj): Int
    private external fun jSet_this(id: Long, self: Any): Unit
    private external fun jFinalize(id: Long): Unit
}
...
internal constructor(_id: Long) : AutoCloseable {
    companion object {
        ...
        fun getByKey(m: Map<Int, Int>, key: Int): Int {
            ...
            val err = ErrorObj()
            val result = jGetbykey(kotlin_to_jdk_m, key, err)
            if (err.typeId != 0) {
                when (err.typeId) {
                    1 -> {
        ...
        @JvmStatic
        private external fun jGetbykey(m: Pair<IntArray, IntArray>, key: Int, __err_obj__: ErrorObj): Int
        ...
        @JvmStatic
        private external fun jNoop(__err_obj__: ErrorObj): Unit
        ...
        @JvmStatic
        private external fun jReturninteger(do_throw: Boolean, __err_obj__: ErrorObj): Long
        ...
        @JvmStatic
        private external fun jRaiseerrorbytype(err_type: String, __err_obj__: ErrorObj): Unit
    }
