...
internal constructor(obj: IEGenObject) : AutoCloseable {
    companion object {
        ...
        const val iegenCxxTypeName: String = "iegen::Object"

        public fun iegenConstructObject(id: Long, owner: Boolean = false): Object {
            val idType = jGettypebyid(id)
            when (idType) {
                ObjectUsage.iegenCxxTypeName -> return ObjectUsage(IEGenObject(id, owner))
