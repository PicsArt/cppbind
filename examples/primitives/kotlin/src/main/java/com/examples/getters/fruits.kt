        ...
        get() {
            ...
            for (value_result in result) {
                ...
                when (value_resultType) {
                    "iegen::example::Apple" -> jdktokotlinvalue_result = Apple(IEGenObject(value_result))
                    "iegen::example::Pineapple" -> jdktokotlinvalue_result = Pineapple(IEGenObject(value_result))
                    else -> jdktokotlinvalue_result = Fruit(IEGenObject(value_result))
                }
                jdktokotlinresult.add(jdktokotlinvalue_result)
            }
