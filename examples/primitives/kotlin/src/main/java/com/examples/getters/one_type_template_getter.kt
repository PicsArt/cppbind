...
internal constructor(_id: Long) : AutoCloseable {
    ...
    open var simpleItemWithType: SimpleItem
        get() {
            val result = jItemwithtypeSimpleItem(getObjId())
            val jdk_to_kotlin_result = SimpleItem(result)
            return jdk_to_kotlin_result
        }
        set(value) {
            val kotlin_to_jdk_value = value.getObjId()
            jSetitemwithtypeSimpleItem(getObjId(), kotlin_to_jdk_value)
        }
    ...
    ///// External wrapper functions ////////////
    private external fun jItemSimpleItem(id: Long): Long
    private external fun jSetitemSimpleItem(id: Long, value: Long): Unit
    private external fun jItemwithtypeSimpleItem(id: Long): Long
    private external fun jSetitemwithtypeSimpleItem(id: Long, value: Long): Unit
    private external fun jValue(id: Long): Int
    private external fun jSetvalue(id: Long, value: Int): Unit
    private external fun jSet_this(id: Long, self: Any): Unit
    private external fun jFinalize(id: Long): Unit
