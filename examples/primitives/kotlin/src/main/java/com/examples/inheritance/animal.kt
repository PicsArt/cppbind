...
interface IAnimal : AutoCloseable {
    ...
    companion object {
        public fun iegenDowncast(id: Long, owner: Boolean = false): IAnimal {
            val idType = jGettypebyid(id)
            when (idType) {
                "iegen::example::LittleFrog" -> return LittleFrog(IEGenObject(id, owner))
                "iegen::example::Frog" -> return Frog(IEGenObject(id, owner))
                "iegen::example::Mammals::Dolphin" -> return IMammals.Dolphin(IEGenObject(id, owner))
                "iegen::example::AquaticAnimal" -> return AquaticAnimal(IEGenObject(id, owner))
                "iegen::example::TerrestrialAnimal" -> return TerrestrialAnimalImpl(IEGenObject(id, owner))
...
interface ITerrestrialAnimal : IAnimal {
    ...
    companion object {
        public fun iegenDowncast(id: Long, owner: Boolean = false): ITerrestrialAnimal {
            val idType = jGettypebyid(id)
            when (idType) {
                "iegen::example::LittleFrog" -> return LittleFrog(IEGenObject(id, owner))
                "iegen::example::Frog" -> return Frog(IEGenObject(id, owner))
...
internal constructor(obj: IEGenObject) : IAnimal, AutoCloseable {
    companion object {
        ...
        @JvmStatic
        private external fun jConstructor(): Long
        public fun iegenDowncast(id: Long, owner: Boolean = false): AquaticAnimal {
            val idType = jGettypebyid(id)
            when (idType) {
                "iegen::example::LittleFrog" -> return LittleFrog(IEGenObject(id, owner))
                "iegen::example::Frog" -> return Frog(IEGenObject(id, owner))
...
internal constructor(obj: IEGenObject) : AutoCloseable {
    ...
    fun getAnimal(): IAnimal {
        ...
        jdktokotlinresult = IAnimal.iegenDowncast(result)
    ...
    fun getAquaticAnimal(): AquaticAnimal {
        ...
        jdktokotlinresult = AquaticAnimal.iegenDowncast(result)
        return jdktokotlinresult
    }
