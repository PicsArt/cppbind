 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 02/04/2022-09:31.
...
internal constructor(_id: Long, _owner: Boolean = false) : AutoCloseable {
    companion object {
        ...
        protected fun construct_helper(little_frog: LittleFrog): Long {val kotlintojdklittle_frog = little_frog.id
