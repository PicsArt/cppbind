...
internal constructor(_id: Long) : AutoCloseable {
    companion object {
        ...
        fun getAnimalTypeName(animal: IAnimal): String {
            val kotlin_to_jdk_animal = animal.id
            val result = jGetanimaltypename(kotlin_to_jdk_animal)
        ...
        fun getAquaticAnimalTypeName(animal: AquaticAnimal): String {
            val kotlin_to_jdk_animal = animal.id
            val result = jGetaquaticanimaltypename(kotlin_to_jdk_animal)
    ...
    fun getAnimal(): IAnimal {
        ...
        val jdk_to_kotlin_result = AnimalImpl(result)
        return jdk_to_kotlin_result
    }

    fun getAquaticAnimal(): AquaticAnimal {
        val result = jGetaquaticanimal(id)
        val jdk_to_kotlin_result = AquaticAnimal(result)
        return jdk_to_kotlin_result
    }

    fun getFrog(): Frog {
        val result = jGetfrog(id)
        val jdk_to_kotlin_result = Frog(result)
        return jdk_to_kotlin_result
    }
