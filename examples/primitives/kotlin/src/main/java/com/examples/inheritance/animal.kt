 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 02/11/2022-07:19.
...
internal constructor(_id: Long, _owner: Boolean = false) : Frog(_id, _owner) {
    companion object {
...
internal constructor(_id: Long, _owner: Boolean = false) : AutoCloseable {
    ...
    constructor(little_frog: LittleFrog): this(construct_helper(little_frog), true) {
    }
    ...
    fun getAnimal(): IAnimal {
        ...
        when (resultType) {
            "iegen::example::LittleFrog" -> jdktokotlinresult = LittleFrog(result)
            "iegen::example::Frog" -> jdktokotlinresult = Frog(result)
            "iegen::example::Mammals::Dolphin" -> jdktokotlinresult = IMammals.Dolphin(result)
            "iegen::example::AquaticAnimal" -> jdktokotlinresult = AquaticAnimal(result)
            "iegen::example::TerrestrialAnimal" -> jdktokotlinresult = TerrestrialAnimalImpl(result)
            else -> jdktokotlinresult = AnimalImpl(result)
        }
    ...
    fun getAquaticAnimal(): AquaticAnimal {
        ...
        when (resultType) {
            ...
            "iegen::example::Frog" -> jdktokotlinresult = Frog(result)
            "iegen::example::Mammals::Dolphin" -> jdktokotlinresult = IMammals.Dolphin(result)
            else -> jdktokotlinresult = AquaticAnimal(result)
        }
        return jdktokotlinresult
    }
