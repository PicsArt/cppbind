    ...
    companion object {
        ...
        public fun cppbindConstructObject(id: Long, owner: Boolean = false): IBase {
            ...
            when (idType) {
                ...
                Date.cppbindCxxTypeName -> obj = Date(CppBindObject(id, owner))
                TimeImpl.cppbindCxxTypeName -> obj = TimeImpl(CppBindObject(id, owner))
                else -> obj = BaseImpl(CppBindObject(id, owner))
            }
            return obj
        }
    }
