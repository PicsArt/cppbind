...
interface IBase : AutoCloseable {
    ...
    companion object {
        public fun iegenDowncast(id: Long, owner: Boolean = false): IBase {
            ...
            when (idType) {
                "iegen::example::DateTime" -> return DateTime(IEGenObject(id, owner))
                "iegen::example::Date" -> return Date(IEGenObject(id, owner))
                "iegen::example::Time" -> return TimeImpl(IEGenObject(id, owner))
