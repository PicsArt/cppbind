 ...
 * 
 * This file is generated by cppbind on 09/08/2022-10:54.
...
internal constructor(obj: CppBindObject) : Vehicle(obj) {
    companion object {
        ...
        public fun cppbindConstructObject(id: Long, owner: Boolean = false): Bicycle {
            ...
            when (idType) {
                ElectricBicycle.cppbindCxxTypeName -> return ElectricBicycle(CppBindObject(id, owner))
                else -> return Bicycle(CppBindObject(id, owner))
            }
        }
    }
