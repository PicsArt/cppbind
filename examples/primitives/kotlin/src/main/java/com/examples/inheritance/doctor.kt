 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 03/02/2022-14:39.
...
internal constructor(obj: IEGenObject) : AutoCloseable {
    ...
    fun getGoodVirtualDoctor(): IGoodVirtualDoctor {
        ...
        when (resultType) {
            "iegen::example::GoodYoungDoctor" -> jdktokotlinresult = GoodYoungDoctor(IEGenObject(result))
            else -> jdktokotlinresult = GoodVirtualDoctorImpl(IEGenObject(result))
        }
        return jdktokotlinresult
    }
