 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 02/11/2022-06:42.
...
internal constructor(_id: Long, _owner: Boolean = false) : AutoCloseable {
    ...
    var parallelogram: IParallelogram
        get() {
            ...
            when (resultType) {
                "iegen::example::Rectangle" -> jdktokotlinresult = RectangleImpl(result)
                "iegen::example::Rhombus" -> jdktokotlinresult = RhombusFigureImpl(result)
                "iegen::example::Square" -> jdktokotlinresult = Square(result)
                else -> jdktokotlinresult = ParallelogramImpl(result)
            }
        ...
        get() {
            val result = jVehicle(id)
                ...
                if (result == 0L)
                    ...
                    val resultType = jGettypebyid(result)
                    when (resultType) {
                        "iegen::example::Bicycle" -> jdktokotlinresult = Bicycle(result, true)
                        else -> jdktokotlinresult = Vehicle(result, true)
                    }
                }
            return jdktokotlinresult
        }
        ...
        get() {
            ...
            for (value_result in result) {
                    ...
                    when (value_resultType) {
                        "iegen::example::DateTime" -> jdktokotlinvalue_result = DateTime(value_result, true)
                        else -> jdktokotlinvalue_result = Date(value_result, true)
                    }
