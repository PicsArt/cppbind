...
internal constructor(obj: IEGenObject) : AutoCloseable {
    ...
    var parallelogram: IParallelogram
        get() {
            ...
            val jdktokotlinresult = ParallelogramImpl(IEGenObject(result))
    ...
    var nullableParallelogram: IParallelogram?
        get() {
            ...
            val jdktokotlinresult = if (result == 0L) null else ParallelogramImpl(IEGenObject(result))
            return jdktokotlinresult
        }
        set(value) {
...
internal constructor(obj: IEGenObject) : AutoCloseable {
    ...
    var vehicle: Vehicle?
        get() {
            ...
            val jdktokotlinresult = if (result == 0L) null else Vehicle(IEGenObject(result, true))
            return jdktokotlinresult
        }
        set(value) {
            val kotlintojdkvalue = value?.id ?: 0L
    ...
    val events: List<Date>
        get() {
            ...
            for (value_result in result) {
                val jdktokotlinvalue_result = Date(IEGenObject(value_result, true))
