...
internal constructor(obj: IEGenObject) : AutoCloseable {
    companion object {
        ...
        const val iegenCxxTypeName: String = "iegen::example::GeometricFigure"
    }
    ...
    var parallelogram: IParallelogram
        get() {
            ...
            jdktokotlinresult = IParallelogram.iegenConstructObject(result)
...
internal constructor(obj: IEGenObject) : AutoCloseable {
    companion object {
        ...
        const val iegenCxxTypeName: String = "iegen::example::MyVehicle"
    }
    ...
    var vehicle: Vehicle?
        get() {
            ...
            if (result == 0L)
                ...
                jdktokotlinresult = Vehicle.iegenConstructObject(result, true)
            }
            return jdktokotlinresult
        }
        set(value) {
...
internal constructor(obj: IEGenObject) : AutoCloseable {
    companion object {
        ...
        const val iegenCxxTypeName: String = "iegen::example::MyBicycle"
    }
...
internal constructor(obj: IEGenObject) : AutoCloseable {
    companion object {
        ...
        const val iegenCxxTypeName: String = "iegen::example::MyCalendar"
    }
    ...
    val events: List<Date>
        get() {
            ...
            for (value_result in result) {
                ...
                jdktokotlinvalue_result = Date.iegenConstructObject(value_result, true)
