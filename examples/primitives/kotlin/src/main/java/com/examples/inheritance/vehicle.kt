...
internal constructor(obj: IEGenObject) : AutoCloseable {
    companion object {
        ...
        const val iegenCxxTypeName: String = "iegen::example::Vehicle"

        public fun iegenConstructObject(id: Long, owner: Boolean = false): Vehicle {
            val idType = jGettypebyid(id)
            when (idType) {
                Bicycle.iegenCxxTypeName -> return Bicycle(IEGenObject(id, owner))
