 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 07/29/2021-12:04.
...
internal constructor(_id: Long) : AutoCloseable {
    companion object {
        ...
        @JvmStatic
        private external fun jMultiplyby(size: FloatArray, n: Int, __err_obj__: ErrorObj): FloatArray
        ...
        fun doubleSizeF(resolution: Point2D.Float): Point2D.Float {
            ...
            val err = ErrorObj()
            val result = jDoublesizef(kotlin_to_jdk_resolution, err)
            if (err.typeId != 0) {
                when (err.typeId) {
                    1 -> {
                        val excObj = StdException(err.ptrId)
        ...
        @JvmStatic
        private external fun jDoublesizef(resolution: FloatArray, __err_obj__: ErrorObj): FloatArray
    }
