...
internal constructor(_id: Long) : AutoCloseable {
    companion object {
        ...
        @JvmStatic
        private external fun jMax(first: Long, second: Long, __err_obj__: ErrorObj): Long
        ...
        @JvmStatic
        private external fun jMax_1(first: Long, second: Long, __err_obj__: ErrorObj): Long
        ...
        @JvmStatic
        private external fun jChecknonnullarg(number: Long, __err_obj__: ErrorObj): Unit
        ...
        @JvmStatic
        private external fun jChecknonnullreturn(__err_obj__: ErrorObj): Long
    }
    ...
    var nullable: NumberDouble?
        get() {
            val err = ErrorObj()
            val result = jNullable(getObjId(), err)
            if (err.typeId != 0) {
                when (err.typeId) {
                    1 -> {
                        val excObj = StdException(err.ptrId)
        ...
        set(value) {
            ...
            jSetnullable(getObjId(), kotlin_to_jdk_value, err)
            if (err.typeId != 0) {
                when (err.typeId) {
                    1 -> {
                        val excObj = StdException(err.ptrId)
    ...
    var nonNull: NumberDouble
        get() {
            val err = ErrorObj()
            val result = jNonnull(getObjId(), err)
            if (err.typeId != 0) {
                when (err.typeId) {
                    1 -> {
                        val excObj = StdException(err.ptrId)
        ...
        set(value) {
            ...
            jSetnonnull(getObjId(), kotlin_to_jdk_value, err)
            if (err.typeId != 0) {
                when (err.typeId) {
                    1 -> {
                        val excObj = StdException(err.ptrId)
    ...
    ///// External wrapper functions ////////////
    private external fun jNullable(id: Long, __err_obj__: ErrorObj): Long
    private external fun jSetnullable(id: Long, value: Long, __err_obj__: ErrorObj): Unit
    private external fun jNonnull(id: Long, __err_obj__: ErrorObj): Long
    private external fun jSetnonnull(id: Long, value: Long, __err_obj__: ErrorObj): Unit
