...
internal constructor(_id: Long) : AutoCloseable {
    ...
    val count: Int
        get() {
            val err = ErrorObj()
            val result = jCount(getObjId(), err)
            if (err.typeId != 0) {
                when (err.typeId) {
                    1 -> {
    ...
    private external fun jCount(id: Long, __err_obj__: ErrorObj): Int
    private external fun jPlus(id: Long, counter: Long, __err_obj__: ErrorObj): Long
    private external fun jCompareto(id: Long, counter: Long, __err_obj__: ErrorObj): Int
    private external fun jGt(id: Long, counter: Long, __err_obj__: ErrorObj): Boolean
    private external fun jAdd(id: Long, counter: Long, __err_obj__: ErrorObj): Long
