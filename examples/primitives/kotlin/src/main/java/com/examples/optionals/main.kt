...
assert(op.optionalShortWithDefault().compareTo(10) == 0)
...
assert(op.optionalUnsignedCharWithDefault().compareTo(100u) == 0)
...
assert(op.optionalCharWithDefault(':') == ':')
assert(op.optionalUnsignedCharWithDefault(200u).compareTo(200u) == 0)
assert(op.optionalLongWithDefault(8L) == 8L)
assert(op.optionalFloatWithDefault(5.0F) == 5.0F)
assert(op.optionalShortWithDefault(5).compareTo(5) == 0)
