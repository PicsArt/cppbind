 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 02/10/2022-13:39.
...
internal constructor(_id: Long, _owner: Boolean = false) : AutoCloseable {
    ...
    fun optionalPtrWithNullptrDefault(task: Task? = null): Task? {
        ...
        val jdktokotlinresult = if (result == 0L) null else Task(result)
    ...
    fun optionalSharedPtrWithNullptrDefault(person: Person? = null): Person? {
        ...
        val jdktokotlinresult = if (result == 0L) null else Person(result, true)
        return jdktokotlinresult
    }
    ...
    fun optionalRefWithDefaultComplexValue(task: Task): Task {
        ...
        val result = jOptionalrefwithdefaultcomplexvalue(id, kotlintojdktask)
        val jdktokotlinresult = Task(result, true)
        return jdktokotlinresult
    }

    fun optionalByValWithDefaultComplexValue(task: Task): Task {
        val kotlintojdktask = task.id
        val result = jOptionalbyvalwithdefaultcomplexvalue(id, kotlintojdktask)
        val jdktokotlinresult = Task(result, true)
        return jdktokotlinresult
    }
