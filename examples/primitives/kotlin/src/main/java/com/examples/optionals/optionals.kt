...
internal constructor(obj: CppBindObject) : AutoCloseable {
    ...
    fun singleComplexDefaultValue(): Task {
        val result = jSinglecomplexdefaultvalue_1(cppbindObjId)
    ...
    fun multipleMixedDefaultValues(): String {
        val result = jMultiplemixeddefaultvalues_1(cppbindObjId)
    ...
    fun multipleMixedDefaultValues(task: Task, i: Int = 1): String {
        val kotlintojdktask = task.cppbindObjId
        val result = jMultiplemixeddefaultvalues_2(cppbindObjId, kotlintojdktask, i, task)
