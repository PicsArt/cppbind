...
internal constructor(obj: CppBindObject) : AutoCloseable {
    ...
    fun optionalUnsignedCharWithDefault(num: UByte = 100u): UByte {
        ...
        val result = jOptionalunsignedcharwithdefault(id, kotlintojdknum)
    ...
    fun optionalCharPointerWithDefault(optionalStr: String = "def"): String {
        ...
        val result = jOptionalcharpointerwithdefault(id, kotlintojdkoptionalStr)
    ...
    private external fun jOptionalunsignedcharwithdefault(id: Long, num: Int): Int
