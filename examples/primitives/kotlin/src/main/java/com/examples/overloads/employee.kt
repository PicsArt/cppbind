...
internal constructor(_id: Long) : AutoCloseable {
    ...
    val email: String
        get() {
            val err = ErrorObj()
            val result = jEmail(getObjId(), err)
            if (err.typeId != 0) {
                when (err.typeId) {
                    1 -> {
                        val excObj = StdException(err.ptrId)
    ...
    private external fun jSetdata(id: Long, name: String, age: Int, email: String, __err_obj__: ErrorObj): Unit
    private external fun jSetdata_1(id: Long, age: Int, __err_obj__: ErrorObj): Unit
    private external fun jName(id: Long, __err_obj__: ErrorObj): String
    private external fun jEmail(id: Long, __err_obj__: ErrorObj): String
    private external fun jAge(id: Long, __err_obj__: ErrorObj): Int
