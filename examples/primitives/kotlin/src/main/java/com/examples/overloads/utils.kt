...
internal constructor(_id: Long) : AutoCloseable {
    companion object {
        ...
        @JvmStatic
        private external fun jSum(first: Int, second: Int, __err__obj__: ErrorObj): Int
        ...
        @JvmStatic
        private external fun jSum_1(first: Float, second: Float, __err__obj__: ErrorObj): Float
    ...
    private external fun jConcatenate(id: Long, first: String, second: String, __err__obj__: ErrorObj): String
    private external fun jConcatenate_1(id: Long, first: String, second: String, third: String, __err__obj__: ErrorObj): String
