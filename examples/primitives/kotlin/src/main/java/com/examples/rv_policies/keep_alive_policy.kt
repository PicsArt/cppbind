...
internal constructor(_id: Long, _owner: Boolean = false) : IChild3 {
    companion object {
        init {
            System.loadLibrary("wrapper_jni")
        }
...
internal constructor(_id: Long, _owner: Boolean = false) : AutoCloseable {
    ...
    constructor(name: String, child1: Child1, child2: Child2, _child3: IChild3): this(construct_helper(name, child1, child2, _child3), true) {
    ...
    var child1: Child1
        get() {
            ...
            val jdktokotlinresult = Child1(result)
    ...
    val child2: Child2
        get() {
            ...
            val jdktokotlinresult = Child2(result, true)
            return jdktokotlinresult
        }
    ...
    var child3: IChild3
        get() {
            ...
            val jdktokotlinresult = Child3Impl(result)
            jdktokotlinresult.keepIEGenReference(this)
            return jdktokotlinresult
        }
        set(value) {
...
internal constructor(_id: Long, _owner: Boolean = false) : AutoCloseable {
    ...
    val children1: List<Child1>
        get() {
            ...
            for (value_result in result) {
                val jdktokotlinvalue_result = Child1(value_result)
    ...
    val children2: List<Child2>
        get() {
            ...
            for (value_result in result) {
                val jdktokotlinvalue_result = Child2(value_result, true)
                jdktokotlinresult.add(jdktokotlinvalue_result)
            }
            return jdktokotlinresult
        }
