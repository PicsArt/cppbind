...
internal constructor(_id: Long, _owner: Boolean = false) : AutoCloseable {
    ...
    constructor(valuePtr: Value, valueRef: ValueSharedRef): this(construct_helper(valuePtr, valueRef), true) {
    }
    
    fun getPtrDefault(): Value {
        val result = jGetptrdefault(id)
        val jdktokotlinresult = Value(result, true)
    ...
    fun getSharedRefDefault(): ValueSharedRef {
        ...
        val jdktokotlinresult = ValueSharedRef(result, true)
        return jdktokotlinresult
    }
