...
internal constructor(_id: Long) : AutoCloseable {
    ...
    private external fun jSetcostwithcarsharedptr(id: Long, sp: Long, __err__obj__: ErrorObj): Unit
    private external fun jGetnewcarsharedptr(id: Long, __err__obj__: ErrorObj): Long
