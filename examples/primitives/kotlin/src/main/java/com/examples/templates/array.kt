 ...
 * 
 * This file is generated by cppbind on 07/01/2022-12:20.
...
internal constructor(obj: CppBindObject) : AutoCloseable {
    companion object {
        ...
        protected fun construct_helper(array: ArrayFloat2): Long {
        ...
        protected fun construct_helper(array: List<Float>): Long {
            val kotlintojdkarray = FloatArray(array.size) 
            var index_array = 0
            for (value_array in array) {
                
                kotlintojdkarray[index_array] = value_array
                ++index_array
            }
            val id = jConstructor_1(kotlintojdkarray, array)
            return id
        }

        @JvmStatic
        private external fun jConstructor_1(array: FloatArray, vararg extraObjs: Any?): Long
        /**
    ...
    constructor(array: ArrayFloat2): this(CppBindObject(construct_helper(array), true)) {
    }

    constructor(array: List<Float>): this(CppBindObject(construct_helper(array), true)) {
    }
...
internal constructor(obj: CppBindObject) : AutoCloseable {
    companion object {
        ...
        protected fun construct_helper(array: ArrayFloat3): Long {
            val kotlintojdkarray = array.cppbindObjId
            val id = jConstructor(kotlintojdkarray, array)
            return id
        }
    ...
    constructor(array: ArrayFloat3): this(CppBindObject(construct_helper(array), true)) {
    }
...
internal constructor(obj: CppBindObject) : AutoCloseable {
    companion object {
        ...
        protected fun construct_helper(array: ArrayInt2): Long {
            val kotlintojdkarray = array.cppbindObjId
            val id = jConstructor(kotlintojdkarray, array)
            return id
        }
        ...
        protected fun construct_helper(array: List<Int>): Long {
        ...
        @JvmStatic
        private external fun jConstructor_1(array: IntArray, vararg extraObjs: Any?): Long
        /**
         * An internal property to keep an information about the underlying C++ object type.
         * It is intended to be used by the generated code.
         */
    ...
    constructor(array: ArrayInt2): this(CppBindObject(construct_helper(array), true)) {
    }

    constructor(array: List<Int>): this(CppBindObject(construct_helper(array), true)) {
    }
...
internal constructor(obj: CppBindObject) : AutoCloseable {
    companion object {
        ...
        protected fun construct_helper(array: ArrayInt3): Long {
            val kotlintojdkarray = array.cppbindObjId
            val id = jConstructor(kotlintojdkarray, array)
            return id
        }
    ...
    constructor(array: ArrayInt3): this(CppBindObject(construct_helper(array), true)) {
    }
...
fun addToElements(a: ArrayInt2, num: Int): ArrayInt2 {
    val kotlintojdka = a.cppbindObjId
    val result = jAddtoelements_1(kotlintojdka, num, a)
    val jdktokotlinresult = ArrayInt2(CppBindObject(result, true))
    return jdktokotlinresult
}
...
internal constructor(obj: CppBindObject) : AutoCloseable {
    companion object {
        ...
        protected fun construct_helper(arr: List<Float>): Long {
            val kotlintojdkarr = FloatArray(arr.size) 
            var index_arr = 0
            for (value_arr in arr) {
                
                kotlintojdkarr[index_arr] = value_arr
                ++index_arr
            }
    ...
    constructor(arr: List<Float>): this(CppBindObject(construct_helper(arr), true)) {
    }
...
private external fun jAddtoelements_1(a: Long, num: Int, vararg extraObjs: Any?): Long
