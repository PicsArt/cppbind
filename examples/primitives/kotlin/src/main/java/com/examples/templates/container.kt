...
interface IContainer : AutoCloseable {
    ...
    companion object {
        public fun iegenDowncast(id: Long, owner: Boolean = false): IContainer {
            ...
            when (idType) {
                "iegen::example::Stack<iegen::example::Project>" -> return StackPrj(IEGenObject(id, owner))
                "iegen::example::Stack<iegen::example::Task>" -> return StackTask(IEGenObject(id, owner))
                "iegen::example::Stack<iegen::example::Number<int>>" -> return StackNumInt(IEGenObject(id, owner))
