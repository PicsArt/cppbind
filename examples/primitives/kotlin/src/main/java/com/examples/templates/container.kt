...
interface IContainer : AutoCloseable {
    ...
    companion object {
        public fun iegenConstructObject(id: Long, owner: Boolean = false): IContainer {
            val idType = jGettypebyid(id)
            when (idType) {
                StackPrj.iegenCxxTypeName -> return StackPrj(IEGenObject(id, owner))
                StackTask.iegenCxxTypeName -> return StackTask(IEGenObject(id, owner))
                StackNumInt.iegenCxxTypeName -> return StackNumInt(IEGenObject(id, owner))
                else -> return ContainerImpl(IEGenObject(id, owner))
            }
        }
    }
}
...
internal constructor(obj : IEGenObject) : IContainer {
    companion object {
        ...
        const val iegenCxxTypeName: String = "iegen::example::Container"
    }
...
internal constructor(obj: IEGenObject) : AutoCloseable {
    companion object {
        ...
        const val iegenCxxTypeName: String = "iegen::example::ContainerHolder"
    }
    ...
    val container: IContainer
        get() {
            ...
            jdktokotlinresult = IContainer.iegenConstructObject(result)
