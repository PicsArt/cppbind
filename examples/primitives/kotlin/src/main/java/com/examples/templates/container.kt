 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 02/11/2022-07:02.
...
internal constructor(_id: Long, _owner: Boolean = false) : AutoCloseable {
    ...
    val container: IContainer
        get() {
            ...
            when (resultType) {
                "iegen::example::Stack<iegen::example::Project>" -> jdktokotlinresult = StackPrj(result)
                "iegen::example::Stack<iegen::example::Task>" -> jdktokotlinresult = StackTask(result)
                "iegen::example::Stack<iegen::example::Number<int>>" -> jdktokotlinresult = StackNumInt(result)
                else -> jdktokotlinresult = ContainerImpl(result)
            }
