...
internal constructor(obj: IEGenObject) : AutoCloseable {
    companion object {
        ...
        const val iegenCxxTypeName: String = "iegen::example::Pair<std::string, std::shared_ptr<iegen::example::Employee>>"
    }
...
internal constructor(obj: IEGenObject) : AutoCloseable {
    companion object {
        ...
        @JvmStatic
        private external fun jConstructor(first: String, second: Long): Long
        const val iegenCxxTypeName: String = "iegen::example::Pair<std::string, std::shared_ptr<iegen::example::Student>>"
    }
