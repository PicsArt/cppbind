...
internal constructor(obj: CppBindObject) : IContainer, AutoCloseable {
    companion object {
         ...
         * enough information.
         */
        protected fun construct_helper(stack: StackPrj): Long {
            val kotlintojdkstack = stack.cppbindObjId
            val id = jConstructor_1(kotlintojdkstack, stack)
            return id
        }

        @JvmStatic
        private external fun jConstructor_1(stack: Long, vararg extraObjs: Any?): Long

        protected fun construct_helper(st: Project): Long {
            val kotlintojdkst = st.cppbindObjId
            val id = jConstructor_2(kotlintojdkst, st)
            return id
        }

        @JvmStatic
        private external fun jConstructor_2(st: Long, vararg extraObjs: Any?): Long
        /**
     ...
     * enough information.
     */
    constructor(stack: StackPrj): this(CppBindObject(construct_helper(stack), true)) {
    }
...
internal constructor(obj: CppBindObject) : IContainer, AutoCloseable {
    companion object {
         ...
         * enough information.
         */
        protected fun construct_helper(stack: StackTask): Long {
            val kotlintojdkstack = stack.cppbindObjId
            val id = jConstructor_1(kotlintojdkstack, stack)
            return id
        }
     ...
     * enough information.
     */
    constructor(stack: StackTask): this(CppBindObject(construct_helper(stack), true)) {
    }
...
internal constructor(obj: CppBindObject) : IContainer, AutoCloseable {
    companion object {
         ...
         * enough information.
         */
        protected fun construct_helper(stack: StackNumInt): Long {
            val kotlintojdkstack = stack.cppbindObjId
            val id = jConstructor_1(kotlintojdkstack, stack)
            return id
        }
     ...
     * enough information.
     */
    constructor(stack: StackNumInt): this(CppBindObject(construct_helper(stack), true)) {
    }
