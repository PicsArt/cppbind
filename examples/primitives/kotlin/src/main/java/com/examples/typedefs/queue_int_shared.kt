...
internal constructor(_id: Long, _owner: Boolean = false) : AutoCloseable {
    companion object {
        ...
        protected fun construct_helper(q: QueueIntShared): Long {val kotlintojdkq = q.id
        ...
        fun getInvQueue(v: List<Int>): QueueIntShared {
            ...
            val jdktokotlinresult = QueueIntShared(result, true)
    ...
    constructor(q: QueueIntShared): this(construct_helper(q), true) {
    }
