...
extern "C" JNIEXPORT jshortArray Java_com_examples_basic_1types_ShortKt_jAdd1(JNIEnv* env, jclass, jshortArray v, jshort a, ...){
    ...
    try {
        decltype(auto) result = cppbind::example::add(jnitocxxv, a);
...
extern "C" JNIEXPORT jobject Java_com_examples_basic_1types_ShortKt_jAdd2(JNIEnv* env, jclass, jobject p1, jobject p2, ...){
    ...
    try {
        decltype(auto) result = cppbind::example::add(jnitocxxp1, jnitocxxp2);
