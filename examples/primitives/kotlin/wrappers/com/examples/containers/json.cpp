...
extern "C" JNIEXPORT void Java_com_examples_containers_JsonExamples_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    delete static_cast<iegen::example::JsonExamples*>(iegen_obj_id_ptr);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_containers_JsonExamples_jConstructor(JNIEnv* env, jobject obj){
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_JSONEXAMPLES), ptr});
    }
...
extern "C" JNIEXPORT void Java_com_examples_containers_JsonExamples_jSetjsonmatrix(JNIEnv* env, jobject obj, jobjectid id, jobjectArray jm){
    

    std::vector<std::vector<nlohmann::json>> jnitocxxjm;
    auto _jnitocxxjm = iegen::getObjectArray(env, jm);
    for (auto& value__jnitocxxjm : _jnitocxxjm) {
        
        std::vector<nlohmann::json> jnitocxxvalue__jnitocxxjm;
        auto _jnitocxxvalue__jnitocxxjm = iegen::getObjectArray(env, value__jnitocxxjm);
        for (auto& value__jnitocxxvalue__jnitocxxjm : _jnitocxxvalue__jnitocxxjm) {
            auto jnitocxxvalue__jnitocxxvalue__jnitocxxjm = nlohmann::json::parse(iegen::jni_to_string(env, value__jnitocxxvalue__jnitocxxjm));
...
extern "C" JNIEXPORT jobjectArray Java_com_examples_containers_JsonExamples_jGetjsonmatrix(JNIEnv* env, jobject obj, jobjectid id){
    ...
    try {
        ...
        for (auto& value_result : result) {
            ...
            for (auto& value_value_result : value_result) {
                jstring cxxtojnivalue_value_result = iegen::string_to_jni(env, value_value_result.dump(4));
