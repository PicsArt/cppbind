 ...
 * 
 * This file is generated by cppbind on 06/06/2022-12:19.
...
extern "C" JNIEXPORT jlong Java_com_examples_containers_VectorItem_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_containers_VectorItem_jConstructor(JNIEnv* env, jobject obj, jint _value, ...){
    ...
    try {
        cppbind::example::VectorItem* ptr = new cppbind::example::VectorItem(_value);
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_VECTORITEM), ptr});
    }
...
extern "C" JNIEXPORT jlong Java_com_examples_containers_VectorExamples_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
    auto cppbind_obj_id_ptr = cppbind_obj_id->ptr;
...
extern "C" JNIEXPORT jobjectid Java_com_examples_containers_VectorExamples_jConstructor(JNIEnv* env, jobject obj){
    try {
        cppbind::example::VectorExamples* ptr = new cppbind::example::VectorExamples();
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_VECTOREXAMPLES), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/cppbind/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jobjectidArray Java_com_examples_containers_VectorExamples_jGetobjvector(JNIEnv* env, jobject obj, jobjectid id){
    ...
    try {
        ...
        size_t index_result = 0;
        for (auto& value_result : result) {
            cppbind::example::VectorItem* cxxtojnivalue_result_ptr = const_cast<cppbind::example::VectorItem*>(value_result);
...
extern "C" JNIEXPORT jdoubleArray Java_com_examples_containers_VectorKt_jGetsquaredvector(JNIEnv* env, jclass cls, jdoubleArray v, ...){
    ...
    try {
        const auto& result = cppbind::example::getSquaredVector(jnitocxxv);
