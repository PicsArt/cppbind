 ...
 * 
 * This file is generated by cppbind on 05/30/2022-11:24.
...
extern "C" JNIEXPORT void Java_com_examples_cppbind_exception_1helpers_StdException_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
...
extern "C" JNIEXPORT jlong Java_com_examples_cppbind_exception_1helpers_StdException_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
...
extern "C" JNIEXPORT jstring Java_com_examples_cppbind_exception_1helpers_StdException_jWhat(JNIEnv* env, jobject obj, jobjectid id){
...
extern "C" JNIEXPORT jstring Java_com_examples_cppbind_exception_1helpers_Std_1exc_1classesKt_jGettypebyid(JNIEnv* env, jclass cls, jobjectid id) {
    validateID(id);
