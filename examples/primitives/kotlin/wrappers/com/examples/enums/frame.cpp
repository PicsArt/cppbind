...
extern "C" JNIEXPORT jlong Java_com_examples_enums_Frame_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
...
extern "C" JNIEXPORT jint Java_com_examples_enums_Frame_jGetnextcolor(JNIEnv* env, jobject obj, jobjectid id, jint color, ...){
