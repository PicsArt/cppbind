...
extern "C" JNIEXPORT jint Java_com_examples_exceptions_Integer_jValue(JNIEnv* env, jobject obj, jobjectid id, jobject err_obj){
    validateID(id);
    iegen::exceptions::Integer* this_object = reinterpret_cast<iegen::exceptions::Integer*>(id);
    int err_type_id = 0;
    void* err_ptr = nullptr;
...
extern "C" JNIEXPORT jint Java_com_examples_exceptions_Exc_jGetbykey(JNIEnv* env, jobject obj, jmapobject m, jint key, jobject err_obj){
