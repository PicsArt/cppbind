...
extern "C" JNIEXPORT jstring Java_com_examples_exceptions_SystemError_jWhat(JNIEnv* env, jobject obj, jobjectid id, jobject err_obj){
...
extern "C" JNIEXPORT jstring Java_com_examples_exceptions_FileError_jWhat(JNIEnv* env, jobject obj, jobjectid id, jobject err_obj){
...
extern "C" JNIEXPORT jint Java_com_examples_exceptions_SimpleBaseException_jErrnum(JNIEnv* env, jobject obj, jobjectid id, jobject err_obj){
...
extern "C" JNIEXPORT jint Java_com_examples_exceptions_SimpleChildException_jErrnum(JNIEnv* env, jobject obj, jobjectid id, jobject err_obj){
...
extern "C" JNIEXPORT jint Java_com_examples_exceptions_Exc_jGetbykey(JNIEnv* env, jobject obj, jmapobject m, jint k, jobject err_obj){
    ...
    for (size_t i = 0; i < tmp_key_jni_to_cxx_m.size(); ++i) {
        auto ktmp = tmp_key_jni_to_cxx_m[i];
        auto vtmp = tmp_val_jni_to_cxx_m[i];
        
        
        jni_to_cxx_m.insert({ ktmp, vtmp });
    }
    ...
    try {
      auto result = iegen::exceptions::Exc::getByKey(jni_to_cxx_m, k);
...
extern "C" JNIEXPORT void Java_com_examples_exceptions_Exc_jNoop(JNIEnv* env, jobject obj, jobject err_obj){
...
extern "C" JNIEXPORT jobjectid Java_com_examples_exceptions_Exc_jReturninteger(JNIEnv* env, jobject obj, jboolean do_throw, jobject err_obj){
...
extern "C" JNIEXPORT void Java_com_examples_exceptions_Exc_jRaiseerrorbytype(JNIEnv* env, jobject obj, jstring err_type, jobject err_obj){
