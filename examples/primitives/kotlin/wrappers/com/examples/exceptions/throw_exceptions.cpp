 ...
 * 
 * This file is generated by cppbind on 06/06/2022-11:58.
...
extern "C" JNIEXPORT jlong Java_com_examples_exceptions_ThrowExc_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
...
extern "C" JNIEXPORT jstring Java_com_examples_exceptions_ThrowExc_jProp2(JNIEnv* env, jobject obj, jobjectid id){
    validateID(id);
...
extern "C" JNIEXPORT void Java_com_examples_exceptions_ThrowExc_jSetprop2(JNIEnv* env, jobject obj, jobjectid id, jstring s, ...){
    validateID(id);
