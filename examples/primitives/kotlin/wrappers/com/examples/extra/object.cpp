 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 07/30/2021-13:33.
...
extern "C" JNIEXPORT jstring Java_com_examples_extra_Object_jToreprstring(JNIEnv* env, jobject obj, jobjectid id){
    ...
    try {
      auto result = this_object->toReprString();
