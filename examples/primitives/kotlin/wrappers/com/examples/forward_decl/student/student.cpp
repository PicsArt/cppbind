 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 09/07/2021-08:50.
...
extern "C" JNIEXPORT void Java_com_examples_forward_1decl_student_Student_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    std::shared_ptr<iegen::example::Student> jni_to_cxx_id;
    jni_to_cxx_id = *reinterpret_cast<std::shared_ptr<iegen::example::Student>*>(id);
    jni_to_cxx_id.reset();
}
