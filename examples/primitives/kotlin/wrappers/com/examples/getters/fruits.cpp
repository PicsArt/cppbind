 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 08/12/2021-10:27.
...
extern "C" JNIEXPORT jint Java_com_examples_getters_Fruit_jType(JNIEnv* env, jobject obj, jobjectid id){
    validateID(id);
    iegen::example::Fruit* this_object = reinterpret_cast<iegen::example::Fruit*>(id);try {
...
extern "C" JNIEXPORT jint Java_com_examples_getters_Apple_jType(JNIEnv* env, jobject obj, jobjectid id){
    ...
    iegen::example::Apple* this_object = dynamic_cast<iegen::example::Apple*>(baseptr);try {
        auto result = this_object->type();
        jint cxx_to_jni_result = (jint)result;
        return cxx_to_jni_result;
    }
...
extern "C" JNIEXPORT jint Java_com_examples_getters_Pineapple_jType(JNIEnv* env, jobject obj, jobjectid id){
    validateID(id);
    iegen::example::Fruit* baseptr = reinterpret_cast<iegen::example::Fruit*>(id);
    iegen::example::Pineapple* this_object = dynamic_cast<iegen::example::Pineapple*>(baseptr);try {
        auto result = this_object->type();
        jint cxx_to_jni_result = (jint)result;
        return cxx_to_jni_result;
    }
...
extern "C" JNIEXPORT jobjectidArray Java_com_examples_getters_Fruits_jFruitsApple(JNIEnv* env, jobject obj, jobjectid id){
    validateID(id);
    iegen::example::Fruits* this_object = reinterpret_cast<iegen::example::Fruits*>(id);try {
...
extern "C" JNIEXPORT void Java_com_examples_getters_Fruits_jSetallfruitsApplePineapple(JNIEnv* env, jobject obj, jobjectid id, jobjectidArray arg0){
    ...
    for (auto& value__jni_to_cxx_arg0 : _jni_to_cxx_arg0) {
        ...
        this_object->setAllFruits<iegen::example::Apple, iegen::example::Pineapple>(jni_to_cxx_arg0);
    }
