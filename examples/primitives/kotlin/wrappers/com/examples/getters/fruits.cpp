...
extern "C" JNIEXPORT void Java_com_examples_getters_Fruits_jSetallfruitsApplePineapple(JNIEnv* env, jobject obj, jobjectid id, jobjectidArray arg0){
    ...
    for (auto& value__jnitocxxarg0 : _jnitocxxarg0) {
        ...
        iegen::example::Fruit* jnitocxxvalue__jnitocxxarg0 = nullptr;
        if (iegen_obj_value__jnitocxxarg0_ptr) {
            if (strcmp(iegen_obj_value__jnitocxxarg0->type, "iegen::example::Fruit") == 0)
                jnitocxxvalue__jnitocxxarg0 = static_cast<iegen::example::Fruit*>(iegen_obj_value__jnitocxxarg0_ptr);
            else if (strcmp(iegen_obj_value__jnitocxxarg0->type, "iegen::example::Apple") == 0)
                jnitocxxvalue__jnitocxxarg0 = static_cast<iegen::example::Apple*>(iegen_obj_value__jnitocxxarg0_ptr);
            else if (strcmp(iegen_obj_value__jnitocxxarg0->type, "iegen::example::Pineapple") == 0)
                jnitocxxvalue__jnitocxxarg0 = static_cast<iegen::example::Pineapple*>(iegen_obj_value__jnitocxxarg0_ptr);
            else {
                std::cerr << "Unexpected object type: " << iegen_obj_value__jnitocxxarg0->type << std::endl;
                exit(1);
            }
        }
