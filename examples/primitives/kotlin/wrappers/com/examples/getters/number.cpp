 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 09/07/2021-10:32.
...
extern "C" JNIEXPORT void Java_com_examples_getters_NumberInt_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    std::shared_ptr<iegen::example::Number<int>> jni_to_cxx_id;
    jni_to_cxx_id = *reinterpret_cast<std::shared_ptr<iegen::example::Number<int>>*>(id);
    jni_to_cxx_id.reset();
}
...
extern "C" JNIEXPORT void Java_com_examples_getters_NumberDouble_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    std::shared_ptr<iegen::example::Number<double>> jni_to_cxx_id;
    jni_to_cxx_id = *reinterpret_cast<std::shared_ptr<iegen::example::Number<double>>*>(id);
    jni_to_cxx_id.reset();
}
