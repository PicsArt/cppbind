...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_Bicycle_jConstructor(JNIEnv* env, jobject obj, jint numberOfSeats){
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup("iegen::example::Bicycle"), new std::shared_ptr<iegen::example::Vehicle>(baseptr)});
    }
...
extern "C" JNIEXPORT jstring Java_com_examples_inheritance_Bicycle_jType(JNIEnv* env, jobject obj, jobjectid id){
    ...
    std::shared_ptr<iegen::example::Bicycle> jnitocxxid = std::dynamic_pointer_cast<iegen::example::Bicycle>(*reinterpret_cast<std::shared_ptr<iegen::example::Vehicle>*>(iegen_obj_id->ptr));
