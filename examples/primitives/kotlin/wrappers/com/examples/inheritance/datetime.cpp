...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_TimeImpl_jConstructor(JNIEnv* env, jobject obj, jint h, jint m, jint s){
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup("iegen::example::Time"), new std::shared_ptr<iegen::example::Base>(baseptr)});
    }
...
extern "C" JNIEXPORT jstring Java_com_examples_inheritance_ITimeHelper_jValue(JNIEnv* env, jobject obj, jobjectid id){
    ...
    validateID(id);
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    std::shared_ptr<iegen::example::Time> jnitocxxid = std::dynamic_pointer_cast<iegen::example::Time>(*reinterpret_cast<std::shared_ptr<iegen::example::Base>*>(iegen_obj_id->ptr));
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_DateTime_jConstructor(JNIEnv* env, jobject obj, jint d, jint mo, jint y, jint h, jint mi, jint s){
    ...
    try {
        ...
        std::shared_ptr<iegen::example::Base> baseptr = std::dynamic_pointer_cast<iegen::example::Base>(this_object);
        return reinterpret_cast<jlong>(new IEGenCObject {strdup("iegen::example::DateTime"), new std::shared_ptr<iegen::example::Base>(baseptr)});
    }
    catch (const std::exception& e) {
          jclass handlerCls = env->FindClass("com/examples/iegen/exceptionUtils/ExceptionHandler");
          jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jstring Java_com_examples_inheritance_DateTime_jValue(JNIEnv* env, jobject obj, jobjectid id){
    ...
    validateID(id);
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    std::shared_ptr<iegen::example::DateTime> jnitocxxid = std::dynamic_pointer_cast<iegen::example::DateTime>(*reinterpret_cast<std::shared_ptr<iegen::example::Base>*>(iegen_obj_id->ptr));
