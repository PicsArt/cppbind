...
const char* IEGEN_IEGEN_EXAMPLE_IGOODVIRTUALDOCTOR = "iegen::example::GoodVirtualDoctor";
...
extern "C" JNIEXPORT void Java_com_examples_inheritance_Doctor_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_DOCTOR) == 0)
        delete static_cast<iegen::example::Doctor*>(iegen_obj_id_ptr);
    else if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_SURGEON) == 0)
...
iegen::example::Doctor* recover_obj_from_IegenExample_Doctor(jobjectid id) {
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    auto iegen_obj_id_ptr = iegen_obj_id ? iegen_obj_id->ptr : nullptr;
    if (iegen_obj_id_ptr) {
        if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_DOCTOR) == 0)
            return static_cast<iegen::example::Doctor*>(iegen_obj_id_ptr);
        else if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_SURGEON) == 0)
            return static_cast<iegen::example::Surgeon*>(iegen_obj_id_ptr);
        else {
            std::cerr << "Unexpected object type: " << iegen_obj_id->type << std::endl;
            exit(1);
        }
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_Doctor_jConstructor(JNIEnv* env, jobject obj, jstring doctor_name){
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_DOCTOR), ptr});
    }
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_Surgeon_jConstructor(JNIEnv* env, jobject obj, jstring surgeon_name){
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_SURGEON), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/iegen/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT void Java_com_examples_inheritance_GoodVirtualDoctorImpl_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    auto iegen_obj_id_ptr = iegen_obj_id ? iegen_obj_id->ptr : nullptr;
    if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_IGOODVIRTUALDOCTOR) == 0)
        delete static_cast<iegen::example::GoodVirtualDoctor*>(iegen_obj_id_ptr);
    else if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_GOODYOUNGDOCTOR) == 0)
...
iegen::example::GoodVirtualDoctor* recover_obj_from_IegenExample_IGoodVirtualDoctor(jobjectid id) {
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    auto iegen_obj_id_ptr = iegen_obj_id ? iegen_obj_id->ptr : nullptr;
    if (iegen_obj_id_ptr) {
        if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_IGOODVIRTUALDOCTOR) == 0)
            return static_cast<iegen::example::GoodVirtualDoctor*>(iegen_obj_id_ptr);
        else if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_GOODYOUNGDOCTOR) == 0)
            return static_cast<iegen::example::GoodYoungDoctor*>(iegen_obj_id_ptr);
        else {
            std::cerr << "Unexpected object type: " << iegen_obj_id->type << std::endl;
            exit(1);
        }
...
extern "C" JNIEXPORT void Java_com_examples_inheritance_GoodDoctor_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    auto iegen_obj_id_ptr = iegen_obj_id ? iegen_obj_id->ptr : nullptr;
    if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_GOODDOCTOR) == 0)
        delete static_cast<iegen::example::GoodDoctor*>(iegen_obj_id_ptr);
    else if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_GOODOLDDOCTOR) == 0)
...
iegen::example::GoodDoctor* recover_obj_from_IegenExample_GoodDoctor(jobjectid id) {
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    auto iegen_obj_id_ptr = iegen_obj_id ? iegen_obj_id->ptr : nullptr;
    if (iegen_obj_id_ptr) {
        if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_GOODDOCTOR) == 0)
            return static_cast<iegen::example::GoodDoctor*>(iegen_obj_id_ptr);
        else if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_GOODOLDDOCTOR) == 0)
            return static_cast<iegen::example::GoodOldDoctor*>(iegen_obj_id_ptr);
        else if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_GOODYOUNGDOCTOR) == 0)
            return static_cast<iegen::example::GoodYoungDoctor*>(iegen_obj_id_ptr);
        else {
            std::cerr << "Unexpected object type: " << iegen_obj_id->type << std::endl;
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_GoodDoctor_jConstructor(JNIEnv* env, jobject obj, jstring doctor_name){
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_GOODDOCTOR), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/iegen/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_GoodYoungDoctor_jConstructor(JNIEnv* env, jobject obj, jstring doctor_name){
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_GOODYOUNGDOCTOR), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/iegen/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_GoodOldDoctor_jConstructor(JNIEnv* env, jobject obj, jstring doctor_name){
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_GOODOLDDOCTOR), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/iegen/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_DoctorInfo_jConstructor(JNIEnv* env, jobject obj, jobjectid s){
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_DOCTORINFO), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/iegen/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jstring Java_com_examples_inheritance_DoctorInfo_jGetdoctorname(JNIEnv* env, jobject obj, jobjectid id, jobjectid d){
    ...
    iegen::example::Doctor* jnitocxxd = recover_obj_from_IegenExample_Doctor(d);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_DoctorInfo_jGetgoodvirtualdoctor(JNIEnv* env, jobject obj, jobjectid id){
    ...
    try {
        ...
        if (status == 0) {
            ...
            type_result = strdup(IEGEN_IEGEN_EXAMPLE_IGOODVIRTUALDOCTOR);
        }
...
extern "C" JNIEXPORT jstring Java_com_examples_inheritance_DoctorInfo_jGetgooddoctorname(JNIEnv* env, jobject obj, jobjectid id, jobjectid d){
    ...
    iegen::example::GoodDoctor* jnitocxxd = recover_obj_from_IegenExample_GoodDoctor(d);
