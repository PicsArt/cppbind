...
extern "C" JNIEXPORT jlong Java_com_examples_inheritance_AnimalImpl_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
...
extern "C" JNIEXPORT jboolean Java_com_examples_inheritance_IAnimalHelper_jIsequalto(JNIEnv* env, jobject obj, jobjectid id, jobjectid a, ...){
...
extern "C" JNIEXPORT jlong Java_com_examples_inheritance_TerrestrialAnimalImpl_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
    auto cppbind_obj_id_ptr = cppbind_obj_id->ptr;
    if (strcmp(cppbind_obj_id->type, CPPBIND_CPPBIND_EXAMPLE_ITERRESTRIALANIMAL) == 0)
        return reinterpret_cast<jlong>(static_cast<cppbind::example::TerrestrialAnimal*>(cppbind_obj_id_ptr));
...
extern "C" JNIEXPORT jlong Java_com_examples_inheritance_AquaticAnimal_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
    auto cppbind_obj_id_ptr = cppbind_obj_id->ptr;
    if (strcmp(cppbind_obj_id->type, CPPBIND_CPPBIND_EXAMPLE_AQUATICANIMAL) == 0)
        return reinterpret_cast<jlong>(static_cast<cppbind::example::AquaticAnimal*>(cppbind_obj_id_ptr));
...
extern "C" JNIEXPORT jlong Java_com_examples_inheritance_AnimalUsage_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
    auto cppbind_obj_id_ptr = cppbind_obj_id->ptr;
