...
std::shared_ptr<cppbind::example::ElectricBicycle> recover_obj_from_CppbindExample_ElectricBicycle(jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
    auto cppbind_obj_id_ptr = cppbind_obj_id ? cppbind_obj_id->ptr : nullptr;
    if (cppbind_obj_id_ptr) {
        if (strcmp(cppbind_obj_id->type, CPPBIND_CPPBIND_EXAMPLE_ELECTRICBICYCLE) == 0)
            return *static_cast<std::shared_ptr<cppbind::example::ElectricBicycle>*>(cppbind_obj_id_ptr);
        else if (strcmp(cppbind_obj_id->type, CPPBIND_CPPBIND_EXAMPLE_ELECTRICCITYBICYCLE) == 0)
           return *static_cast<std::shared_ptr<cppbind::example::ElectricCityBicycle>*>(cppbind_obj_id_ptr);
        else {
...
extern "C" JNIEXPORT jstring Java_com_examples_inheritance_ElectricBicycle_jType([[maybe_unused]] JNIEnv* env, jobject, jobjectid id){
    ...
    jnitocxxid = recover_obj_from_CppbindExample_ElectricBicycle(id);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_MountainBicycle_jConstructor([[maybe_unused]] JNIEnv* env, jobject, jint number_of_seats, ...){
    using namespace cppbind::example;
    
    try {
        cppbind::example::MountainBicycle* this_object = new cppbind::example::MountainBicycle(number_of_seats);
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_MOUNTAINBICYCLE), new std::shared_ptr<cppbind::example::MountainBicycle>(this_object)});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/cppbind/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jstring Java_com_examples_inheritance_MountainBicycle_jType([[maybe_unused]] JNIEnv* env, jobject, jobjectid id){
    using namespace cppbind::example;
    
    validateID(id);
    std::shared_ptr<cppbind::example::MountainBicycle> jnitocxxid;
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
    auto cppbind_obj_id_ptr = cppbind_obj_id ? cppbind_obj_id->ptr : nullptr;
    jnitocxxid = *static_cast<std::shared_ptr<cppbind::example::MountainBicycle>*>(cppbind_obj_id_ptr);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_ElectricCityBicycle_jConstructor([[maybe_unused]] JNIEnv* env, jobject, jint number_of_seats, ...){
    using namespace cppbind::example;
    
    try {
        cppbind::example::ElectricCityBicycle* this_object = new cppbind::example::ElectricCityBicycle(number_of_seats);
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_ELECTRICCITYBICYCLE), new std::shared_ptr<cppbind::example::ElectricCityBicycle>(this_object)});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/cppbind/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jstring Java_com_examples_inheritance_ElectricCityBicycle_jType([[maybe_unused]] JNIEnv* env, jobject, jobjectid id){
    using namespace cppbind::example;
    
    validateID(id);
    std::shared_ptr<cppbind::example::ElectricCityBicycle> jnitocxxid;
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
    auto cppbind_obj_id_ptr = cppbind_obj_id ? cppbind_obj_id->ptr : nullptr;
    jnitocxxid = *static_cast<std::shared_ptr<cppbind::example::ElectricCityBicycle>*>(cppbind_obj_id_ptr);
