...
extern "C" JNIEXPORT void Java_com_examples_inheritance_Date_jFinalize(JNIEnv*, jobject, jobjectid id){
...
extern "C" JNIEXPORT jlong Java_com_examples_inheritance_Date_jGetcxxid(JNIEnv*, jobject, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_Date_jConstructor([[maybe_unused]] JNIEnv* env, jobject, jint d, jint m, jint y, ...){
    using namespace cppbind::example;
    
    
    
    try {
        cppbind::example::Date* this_object = new cppbind::example::Date(d, m, y);
...
extern "C" JNIEXPORT jstring Java_com_examples_inheritance_Date_jValue([[maybe_unused]] JNIEnv* env, jobject, jobjectid id){
    using namespace cppbind::example;
...
extern "C" JNIEXPORT jstring Java_com_examples_inheritance_Date_jDate([[maybe_unused]] JNIEnv* env, jobject, jobjectid id){
    using namespace cppbind::example;
    validateID(id);
    ...
    jnitocxxid = recover_obj_from_CppbindExample_Date(id);
    try {
        decltype(auto) result = jnitocxxid->date();
        jstring cxxtojniresult = env->NewStringUTF(result.data());
        return cxxtojniresult;
    }
...
extern "C" JNIEXPORT jstring Java_com_examples_inheritance_DateKt_jGettypebyid(JNIEnv* env, jclass, jobjectid id) {
    validateID(id);
