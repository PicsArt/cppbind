...
extern "C" JNIEXPORT void Java_com_examples_inheritance_ParallelogramImpl_jFinalize(JNIEnv*, jobject, jobjectid id){
...
extern "C" JNIEXPORT jlong Java_com_examples_inheritance_ParallelogramImpl_jGetcxxid(JNIEnv*, jobject, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
...
extern "C" JNIEXPORT jdouble Java_com_examples_inheritance_IParallelogramHelper_jArea([[maybe_unused]] JNIEnv* env, jobject, jobjectid id){
    using namespace cppbind::example;
    validateID(id);
...
extern "C" JNIEXPORT jdouble Java_com_examples_inheritance_IParallelogramHelper_jPerimeter([[maybe_unused]] JNIEnv* env, jobject, jobjectid id){
    using namespace cppbind::example;
...
extern "C" JNIEXPORT jstring Java_com_examples_inheritance_ParallelogramKt_jGettypebyid(JNIEnv* env, jclass, jobjectid id) {
    validateID(id);
