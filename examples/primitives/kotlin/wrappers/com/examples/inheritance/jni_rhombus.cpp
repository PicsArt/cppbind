...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_RhombusFigureImpl_jConstructor([[maybe_unused]] JNIEnv* env, jobject, jdouble diagonal1, jdouble diagonal2, ...){
    ...
    try {
        cppbind::example::Rhombus* ptr = new cppbind::example::Rhombus(diagonal1, diagonal2);
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_IRHOMBUSFIGURE), ptr});
    }
