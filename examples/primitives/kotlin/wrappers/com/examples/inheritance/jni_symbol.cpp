...
extern "C" JNIEXPORT jlong Java_com_examples_inheritance_SignImpl_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_SignImpl_jConstructor(JNIEnv* env, jobject obj){
    try {
        cppbind::example::Sign* ptr = new cppbind::example::Sign();
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_ISIGN), ptr});
    }
...
extern "C" JNIEXPORT jlong Java_com_examples_inheritance_Text_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
    auto cppbind_obj_id_ptr = cppbind_obj_id->ptr;
    if (strcmp(cppbind_obj_id->type, CPPBIND_CPPBIND_EXAMPLE_TEXT) == 0)
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_Text_jConstructor(JNIEnv* env, jobject obj){
    try {
        cppbind::example::Text* ptr = new cppbind::example::Text();
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_TEXT), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/cppbind/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_Digit_jConstructor(JNIEnv* env, jobject obj){
    try {
        cppbind::example::Digit* ptr = new cppbind::example::Digit();
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_DIGIT), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/cppbind/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jlong Java_com_examples_inheritance_SymbolUsage_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
    auto cppbind_obj_id_ptr = cppbind_obj_id->ptr;
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_SymbolUsage_jConstructor(JNIEnv* env, jobject obj){
    try {
        cppbind::example::SymbolUsage* ptr = new cppbind::example::SymbolUsage();
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_SYMBOLUSAGE), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/cppbind/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_SymbolUsage_jConstructor_11(JNIEnv* env, jobject obj, jobjectid d, ...){
    ...
    try {
        cppbind::example::SymbolUsage* ptr = new cppbind::example::SymbolUsage(jnitocxxd);
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_SYMBOLUSAGE), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/cppbind/exceptionUtils/ExceptionHandler");
