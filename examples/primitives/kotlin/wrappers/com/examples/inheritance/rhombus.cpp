 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 08/05/2021-12:27.
...
extern "C" JNIEXPORT void Java_com_examples_inheritance_RhombusFigure_jSet_1this(JNIEnv* env, jobject obj, jobjectid id, jobject self){
}
