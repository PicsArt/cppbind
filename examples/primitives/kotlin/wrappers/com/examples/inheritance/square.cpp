...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_Square_jConstructor(JNIEnv* env, jobject obj, jdouble side){
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup("iegen::example::Square"), baseptr});
    }
...
extern "C" JNIEXPORT jdouble Java_com_examples_inheritance_Square_jArea(JNIEnv* env, jobject obj, jobjectid id){
    ...
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    auto iegen_obj_id_ptr = iegen_obj_id ? iegen_obj_id->ptr : nullptr;
    auto base_id = reinterpret_cast<iegen::example::Parallelogram*>(iegen_obj_id_ptr);
