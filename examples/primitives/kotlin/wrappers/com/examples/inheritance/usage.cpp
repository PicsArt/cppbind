...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_GeometricFigure_jParallelogram(JNIEnv* env, jobject obj, jobjectid id){
    validateID(id);
    iegen::example::GeometricFigure* this_object = reinterpret_cast<iegen::example::GeometricFigure*>(id);try {
...
extern "C" JNIEXPORT void Java_com_examples_inheritance_GeometricFigure_jSetparallelogram(JNIEnv* env, jobject obj, jobjectid id, jobjectid p){
    validateID(id);
    iegen::example::GeometricFigure* this_object = reinterpret_cast<iegen::example::GeometricFigure*>(id);
    auto jni_to_cxx_p =  reinterpret_cast<iegen::example::Parallelogram*>(p);try {
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_MyVehicle_jVehicle(JNIEnv* env, jobject obj, jobjectid id){
    validateID(id);
    auto this_object = *reinterpret_cast<std::shared_ptr<iegen::example::MyVehicle>*>(id);try {
...
extern "C" JNIEXPORT void Java_com_examples_inheritance_MyVehicle_jSetvehicle(JNIEnv* env, jobject obj, jobjectid id, jobjectid v){
    ...
    auto this_object = *reinterpret_cast<std::shared_ptr<iegen::example::MyVehicle>*>(id);
    std::shared_ptr<iegen::example::Vehicle> jni_to_cxx_v;
    jni_to_cxx_v = *reinterpret_cast<std::shared_ptr<iegen::example::Vehicle>*>(v);try {
