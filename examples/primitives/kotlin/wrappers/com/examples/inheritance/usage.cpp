...
extern const char* IEGEN_IEGEN_EXAMPLE_IPARALLELOGRAM;
...
iegen::example::Parallelogram* recover_obj_from_IegenExample_IParallelogram(jobjectid);
std::shared_ptr<iegen::example::Vehicle> recover_obj_from_IegenExample_Vehicle(jobjectid);
std::shared_ptr<iegen::example::Date> recover_obj_from_IegenExample_Date(jobjectid);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_GeometricFigure_jConstructor(JNIEnv* env, jobject obj, jobjectid p){
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_GEOMETRICFIGURE), ptr});
    }
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_GeometricFigure_jParallelogram(JNIEnv* env, jobject obj, jobjectid id){
    ...
    try {
        ...
        if (status == 0) {
            ...
            type_result = strdup(IEGEN_IEGEN_EXAMPLE_IPARALLELOGRAM);
        }
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_MyVehicle_jConstructor(JNIEnv* env, jobject obj, jobjectid v, jobjectid cv){
    ...
    jnitocxxv = recover_obj_from_IegenExample_Vehicle(v);
    
    std::shared_ptr<const iegen::example::Vehicle> jnitocxxcv;
    jnitocxxcv = recover_obj_from_IegenExample_Vehicle(cv);
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_MYVEHICLE), new std::shared_ptr<iegen::example::MyVehicle>(this_object)});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/iegen/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_MyBicycle_jConstructor(JNIEnv* env, jobject obj, jobjectid b){
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_MYBICYCLE), new std::shared_ptr<iegen::example::MyBicycle>(this_object)});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/iegen/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_MyCalendar_jConstructor(JNIEnv* env, jobject obj, jobjectidArray events){
    ...
    for (auto& value__jnitocxxevents : _jnitocxxevents) {
        ...
        jnitocxxvalue__jnitocxxevents = recover_obj_from_IegenExample_Date(value__jnitocxxevents);
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_MYCALENDAR), new std::shared_ptr<iegen::example::MyCalendar>(this_object)});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/iegen/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT void Java_com_examples_inheritance_MyCalendar_jAddevent(JNIEnv* env, jobject obj, jobjectid id, jobjectid e){
    ...
    jnitocxxe = recover_obj_from_IegenExample_Date(e);
    ...
    try {
        ...
        for (auto& value_result : result) {
            ...
            if (status == 0) {
                ...
                type_value_result = strdup(IEGEN_IEGEN_EXAMPLE_DATE);
            }
