...
extern "C" JNIEXPORT jobjectid Java_com_examples_inheritance_MyVehicle_jConstructor(JNIEnv* env, jobject obj, jobjectid v, jobjectid cv){
    ...
    auto iegen_obj_cv = reinterpret_cast<IEGenCObject*>(cv);
    auto iegen_obj_cv_ptr = iegen_obj_cv ? iegen_obj_cv->ptr : nullptr;
    std::shared_ptr<const iegen::example::Vehicle> jnitocxxcv;
    if (strcmp(iegen_obj_cv->type, "iegen::example::Vehicle") == 0)
        jnitocxxcv = *static_cast<std::shared_ptr<const iegen::example::Vehicle>*>(iegen_obj_cv_ptr);
    else if (strcmp(iegen_obj_cv->type, "iegen::example::Bicycle") == 0)
        jnitocxxcv = *static_cast<std::shared_ptr<iegen::example::Bicycle>*>(iegen_obj_cv_ptr);
    else {
        std::cerr << "Unexpected object type: " << iegen_obj_cv->type << std::endl;
        exit(1);
    }
    try {
...
extern "C" JNIEXPORT void Java_com_examples_inheritance_MyVehicle_jSetconstvehicle(JNIEnv* env, jobject obj, jobjectid id, jobjectid v){
    ...
    if (iegen_obj_v_ptr) {
        if (strcmp(iegen_obj_v->type, "iegen::example::Vehicle") == 0)
            jnitocxxv = *static_cast<std::shared_ptr<const iegen::example::Vehicle>*>(iegen_obj_v_ptr);
        else if (strcmp(iegen_obj_v->type, "iegen::example::Bicycle") == 0)
            jnitocxxv = *static_cast<std::shared_ptr<iegen::example::Bicycle>*>(iegen_obj_v_ptr);
        else {
            std::cerr << "Unexpected object type: " << iegen_obj_v->type << std::endl;
