...
extern "C" JNIEXPORT void Java_com_examples_inheritance_Vehicle_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_VEHICLE) == 0)
        delete static_cast<std::shared_ptr<iegen::example::Vehicle>*>(iegen_obj_id_ptr);
    else if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_BICYCLE) == 0)
...
std::shared_ptr<iegen::example::Vehicle> recover_obj_from_IegenExample_Vehicle(jobjectid id) {
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    auto iegen_obj_id_ptr = iegen_obj_id ? iegen_obj_id->ptr : nullptr;
    if (iegen_obj_id_ptr) {
        if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_VEHICLE) == 0)
...
extern "C" JNIEXPORT jint Java_com_examples_inheritance_Vehicle_jNumberofseats(JNIEnv* env, jobject obj, jobjectid id){
    ...
    jnitocxxid = recover_obj_from_IegenExample_Vehicle(id);
    try {
