...
extern "C" JNIEXPORT jlong Java_com_examples_nested_1types_List_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
...
extern "C" JNIEXPORT jlong Java_com_examples_nested_1types_List_00024Item_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
    auto cppbind_obj_id_ptr = cppbind_obj_id->ptr;
...
extern "C" JNIEXPORT jlong Java_com_examples_nested_1types_List_00024Item_00024Value_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
    auto cppbind_obj_id_ptr = cppbind_obj_id->ptr;
...
extern "C" JNIEXPORT jobjectid Java_com_examples_nested_1types_List_00024Item_00024Value_jConstructor(JNIEnv* env, jobject obj, jint _value, ...){
    ...
    try {
        cppbind::example::List::Item::Value* ptr = new cppbind::example::List::Item::Value(_value);
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_LIST_ITEM_VALUE), ptr});
    }
...
extern "C" JNIEXPORT jobjectid Java_com_examples_nested_1types_List_00024Item_jConstructor(JNIEnv* env, jobject obj, jobjectid v, ...){
    ...
    try {
        cppbind::example::List::Item* ptr = new cppbind::example::List::Item(jnitocxxv);
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_LIST_ITEM), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/cppbind/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jobjectid Java_com_examples_nested_1types_List_jConstructor(JNIEnv* env, jobject obj){
    try {
        cppbind::example::List* ptr = new cppbind::example::List();
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_LIST), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/cppbind/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
