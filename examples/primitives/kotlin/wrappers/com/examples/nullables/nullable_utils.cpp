...
extern "C" JNIEXPORT void Java_com_examples_nullables_NumberInt_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    std::shared_ptr<iegen::example::nullable::NumberInt> jni_to_cxx_id;
    jni_to_cxx_id = *reinterpret_cast<std::shared_ptr<iegen::example::nullable::NumberInt>*>(id);
    jni_to_cxx_id.reset();
}
...
extern "C" JNIEXPORT void Java_com_examples_nullables_Utils_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    std::shared_ptr<iegen::example::nullable::Utils> jni_to_cxx_id;
    jni_to_cxx_id = *reinterpret_cast<std::shared_ptr<iegen::example::nullable::Utils>*>(id);
    jni_to_cxx_id.reset();
}
