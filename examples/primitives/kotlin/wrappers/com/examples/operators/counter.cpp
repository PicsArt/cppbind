...
extern "C" JNIEXPORT jint Java_com_examples_operators_Counter_jCount(JNIEnv* env, jobject obj, jobjectid id, jobject err_obj){
    validateID(id);
    iegen::example::Counter* this_object = reinterpret_cast<iegen::example::Counter*>(id);
    int err_type_id = 0;
...
extern "C" JNIEXPORT jobjectid Java_com_examples_operators_Counter_jPlus(JNIEnv* env, jobject obj, jobjectid id, jobjectid counter, jobject err_obj){
...
extern "C" JNIEXPORT jint Java_com_examples_operators_Counter_jCompareto(JNIEnv* env, jobject obj, jobjectid id, jobjectid counter, jobject err_obj){
...
extern "C" JNIEXPORT jboolean Java_com_examples_operators_Counter_jGt(JNIEnv* env, jobject obj, jobjectid id, jobjectid counter, jobject err_obj){
...
extern "C" JNIEXPORT jobjectid Java_com_examples_operators_Counter_jAdd(JNIEnv* env, jobject obj, jobjectid id, jobjectid counter, jobject err_obj){
