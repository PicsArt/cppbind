 ...
 * 
 * This file is generated by cppbind on 06/15/2022-07:32.
...
extern "C" JNIEXPORT jlong Java_com_examples_optionals_Optionals_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
...
extern "C" JNIEXPORT jstring Java_com_examples_optionals_Optionals_jOptionalstringwithdefault(JNIEnv* env, jobject obj, jobjectid id, jstring optional_str, ...){
...
extern "C" JNIEXPORT jint Java_com_examples_optionals_Optionals_jOptionalunsignedcharwithdefault(JNIEnv* env, jobject obj, jobjectid id, jint num, ...){
...
extern "C" JNIEXPORT jstring Java_com_examples_optionals_Optionals_jOptionalcharpointerwithdefault(JNIEnv* env, jobject obj, jobjectid id, jstring optional_str, ...){
...
extern "C" JNIEXPORT jint Java_com_examples_optionals_Optionals_jOptionalenumwithdefaultandchangednames(JNIEnv* env, jobject obj, jobjectid id, jint level, ...){
...
extern "C" JNIEXPORT jstring Java_com_examples_optionals_Optionals_jOptionalstringviewwithdefault(JNIEnv* env, jobject obj, jobjectid id, jstring optional_str, ...){
