 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 07/20/2021-11:40.
...
extern "C" JNIEXPORT jstring Java_com_examples_optionals_Optionals_jOptionalcharpointerwithdefault(JNIEnv* env, jobject obj, jobjectid id, jstring optionalStr){
    ...
    const char * jni_to_cxx_optionalStr = env->GetStringUTFChars(optionalStr, NULL);
    // TODO release after using
    //env->ReleaseStringUTFChars(optionalStr, jni_to_cxx_optionalStr);
