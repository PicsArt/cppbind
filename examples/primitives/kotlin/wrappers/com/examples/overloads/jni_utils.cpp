...
extern "C" JNIEXPORT jintArray Java_com_examples_overloads_Utils_jSum_12([[maybe_unused]] JNIEnv* env, jobject, jobjectid id, jintArray first, jintArray second, ...){
...
extern "C" JNIEXPORT jfloatArray Java_com_examples_overloads_Utils_jSum_13([[maybe_unused]] JNIEnv* env, jobject, jobjectid id, jfloatArray first, jfloatArray second, ...){
