...
extern "C" JNIEXPORT void Java_com_examples_rv_1policies_Value_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    auto jnitocxxid = reinterpret_cast<iegen::example::Value*>(iegen_obj_id_ptr);
    delete jnitocxxid;
...
extern "C" JNIEXPORT jobjectid Java_com_examples_rv_1policies_Value_jConstructor(JNIEnv* env, jobject obj, jstring name){
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup("iegen::example::Value"), baseptr});
    }
...
extern "C" JNIEXPORT void Java_com_examples_rv_1policies_ValueSharedRef_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    std::shared_ptr<iegen::example::ValueSharedRef>& jnitocxxid = *reinterpret_cast<std::shared_ptr<iegen::example::ValueSharedRef>*>(iegen_obj_id->ptr);
    delete &jnitocxxid;
    free(iegen_obj_id->type);
    delete iegen_obj_id;
}
...
extern "C" JNIEXPORT void Java_com_examples_rv_1policies_ValuesHolder_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    auto iegen_obj_id_ptr = iegen_obj_id ? iegen_obj_id->ptr : nullptr;
    auto jnitocxxid = reinterpret_cast<iegen::example::ValuesHolder*>(iegen_obj_id_ptr);
    delete jnitocxxid;
    free(iegen_obj_id->type);
    delete iegen_obj_id;
}
...
extern "C" JNIEXPORT jobjectid Java_com_examples_rv_1policies_ValuesHolder_jConstructor(JNIEnv* env, jobject obj){
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup("iegen::example::ValuesHolder"), baseptr});
    }
    catch (const std::exception& e) {
          jclass handlerCls = env->FindClass("com/examples/iegen/exceptionUtils/ExceptionHandler");
          jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jobjectid Java_com_examples_rv_1policies_ValuesHolder_jConstructor_11(JNIEnv* env, jobject obj, jobjectid valuePtr, jobjectid valueRef){
    ...
    auto jnitocxxvaluePtr = reinterpret_cast<iegen::example::Value*>(iegen_obj_valuePtr_ptr);
    
    auto iegen_obj_valueRef = reinterpret_cast<IEGenCObject*>(valueRef);
    std::shared_ptr<iegen::example::ValueSharedRef>& jnitocxxvalueRef = *reinterpret_cast<std::shared_ptr<iegen::example::ValueSharedRef>*>(iegen_obj_valueRef->ptr);
    try {
...
extern "C" JNIEXPORT jobjectid Java_com_examples_rv_1policies_ValuesHolder_jGetsharedrefdefault(JNIEnv* env, jobject obj, jobjectid id){
    ...
    try {
        ...
        char* type_result = strdup("std::shared_ptr<iegen::example::ValueSharedRef>");
