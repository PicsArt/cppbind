...
const char* IEGEN_IEGEN_EXAMPLE_VALUE = "iegen::example::Value";
...
extern "C" JNIEXPORT void Java_com_examples_rv_1policies_Value_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    delete static_cast<iegen::example::Value*>(iegen_obj_id_ptr);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_rv_1policies_Value_jConstructor(JNIEnv* env, jobject obj, jstring name){
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_VALUE), ptr});
    }
...
extern "C" JNIEXPORT jobjectid Java_com_examples_rv_1policies_ValueSharedRef_jConstructor(JNIEnv* env, jobject obj, jstring name){
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_VALUESHAREDREF), new std::shared_ptr<iegen::example::ValueSharedRef>(this_object)});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/iegen/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT void Java_com_examples_rv_1policies_ValuesHolder_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    auto iegen_obj_id_ptr = iegen_obj_id ? iegen_obj_id->ptr : nullptr;
    delete static_cast<iegen::example::ValuesHolder*>(iegen_obj_id_ptr);
    free(iegen_obj_id->type);
    delete iegen_obj_id;
}
...
extern "C" JNIEXPORT jobjectid Java_com_examples_rv_1policies_ValuesHolder_jConstructor(JNIEnv* env, jobject obj){
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_VALUESHOLDER), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/iegen/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jobjectid Java_com_examples_rv_1policies_ValuesHolder_jConstructor_11(JNIEnv* env, jobject obj, jobjectid value_ptr, jobjectid value_ref){
    ...
    auto iegen_obj_value_ptr = reinterpret_cast<IEGenCObject*>(value_ptr);
    auto iegen_obj_value_ptr_ptr = iegen_obj_value_ptr ? iegen_obj_value_ptr->ptr : nullptr;
    auto jnitocxxvalue_ptr = static_cast<iegen::example::Value*>(iegen_obj_value_ptr_ptr);
    
    std::shared_ptr<iegen::example::ValueSharedRef> jnitocxxvalue_ref;
    auto iegen_obj_value_ref = reinterpret_cast<IEGenCObject*>(value_ref);
    auto iegen_obj_value_ref_ptr = iegen_obj_value_ref ? iegen_obj_value_ref->ptr : nullptr;
    jnitocxxvalue_ref = *static_cast<std::shared_ptr<iegen::example::ValueSharedRef>*>(iegen_obj_value_ref_ptr);
    try {
        iegen::example::ValuesHolder* ptr = new iegen::example::ValuesHolder(jnitocxxvalue_ptr, jnitocxxvalue_ref);
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_VALUESHOLDER), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/iegen/exceptionUtils/ExceptionHandler");
...
extern "C" JNIEXPORT jobjectid Java_com_examples_rv_1policies_ValuesHolder_jGetptrdefault(JNIEnv* env, jobject obj, jobjectid id){
    ...
    try {
        ...
        char* type_result = strdup(IEGEN_IEGEN_EXAMPLE_VALUE);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_rv_1policies_ValuesHolder_jGetsharedrefdefault(JNIEnv* env, jobject obj, jobjectid id){
    ...
    try {
        ...
        char* type_result = strdup(IEGEN_IEGEN_EXAMPLE_VALUESHAREDREF);
...
extern "C" JNIEXPORT void Java_com_examples_rv_1policies_AnotherValueHolder_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    auto iegen_obj_id_ptr = iegen_obj_id ? iegen_obj_id->ptr : nullptr;
    delete static_cast<iegen::example::AnotherValueHolder*>(iegen_obj_id_ptr);
    free(iegen_obj_id->type);
    delete iegen_obj_id;
}
...
extern "C" JNIEXPORT jobjectid Java_com_examples_rv_1policies_AnotherValueHolder_jConstructor(JNIEnv* env, jobject obj){
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_ANOTHERVALUEHOLDER), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/iegen/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
