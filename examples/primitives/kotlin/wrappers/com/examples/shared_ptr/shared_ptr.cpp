 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 10/28/2021-12:24.
...
extern "C" JNIEXPORT jobjectid Java_com_examples_shared_1ptr_CarUsage_jGetcar(JNIEnv* env, jobject obj, jobjectid id){
    ...
    try {
        auto result = jni_to_cxx_id->getCar();
...
//        Example::Car* _result = new Example::Car(result);
//        Example::Car* cxx_to_jni_result_baseptr = _result;
...
extern "C" JNIEXPORT jobjectid Java_com_examples_shared_1ptr_CarUsage_jGetcarptr(JNIEnv* env, jobject obj, jobjectid id){
    
    validateID(id);
    auto jni_to_cxx_id = reinterpret_cast<Example::CarUsage*>(id);
    
    try {
        auto result = jni_to_cxx_id->getCarPtr();

          jobjectid cxx_to_jni_result;
        std::shared_ptr<Example::Car> result_shared_ptr = std::make_shared<Example::Car>(*result);
        cxx_to_jni_result = reinterpret_cast<jlong>(new std::shared_ptr<Example::Car>(result_shared_ptr));
        return cxx_to_jni_result;
//        Example::Car* cxx_to_jni_result_baseptr = result;
//        jobjectid cxx_to_jni_result = reinterpret_cast<jlong>(cxx_to_jni_result_baseptr);
//        return cxx_to_jni_result;
    }
    catch (const std::exception& e) {
...
extern "C" JNIEXPORT jobjectid Java_com_examples_shared_1ptr_CarUsage_jGetcarref(JNIEnv* env, jobject obj, jobjectid id){
    
    validateID(id);
    auto jni_to_cxx_id = reinterpret_cast<Example::CarUsage*>(id);
    
    try {
        auto result = jni_to_cxx_id->getCarRef();
          jobjectid cxx_to_jni_result;
        std::shared_ptr<Example::Car> result_shared_ptr = std::make_shared<Example::Car>(result);
        cxx_to_jni_result = reinterpret_cast<jlong>(new std::shared_ptr<Example::Car>(result_shared_ptr));
        return cxx_to_jni_result;
