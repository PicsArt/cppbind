...
extern "C" JNIEXPORT jlong Java_com_examples_shared_1ptr_SignSharedImpl_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_shared_1ptr_SignSharedImpl_jConstructor(JNIEnv* env, jobject obj){
    try {
        cppbind::example::SignShared* obj_ptr = new cppbind::example::SignShared();
        auto this_object = std::shared_ptr<cppbind::example::SignShared>(obj_ptr);
...
extern "C" JNIEXPORT jlong Java_com_examples_shared_1ptr_TextShared_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
    auto cppbind_obj_id_ptr = cppbind_obj_id->ptr;
    if (strcmp(cppbind_obj_id->type, CPPBIND_CPPBIND_EXAMPLE_TEXTSHARED) == 0)
...
extern "C" JNIEXPORT jobjectid Java_com_examples_shared_1ptr_TextShared_jConstructor(JNIEnv* env, jobject obj){
    try {
        cppbind::example::TextShared* obj_ptr = new cppbind::example::TextShared();
        auto this_object = std::shared_ptr<cppbind::example::TextShared>(obj_ptr);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_shared_1ptr_DigitShared_jConstructor(JNIEnv* env, jobject obj){
    try {
        cppbind::example::DigitShared* obj_ptr = new cppbind::example::DigitShared();
        auto this_object = std::shared_ptr<cppbind::example::DigitShared>(obj_ptr);
...
extern "C" JNIEXPORT jlong Java_com_examples_shared_1ptr_SymbolUsageShared_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
    auto cppbind_obj_id_ptr = cppbind_obj_id->ptr;
...
extern "C" JNIEXPORT jobjectid Java_com_examples_shared_1ptr_SymbolUsageShared_jConstructor(JNIEnv* env, jobject obj){
    try {
        cppbind::example::SymbolUsageShared* ptr = new cppbind::example::SymbolUsageShared();
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_SYMBOLUSAGESHARED), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/cppbind/exceptionUtils/ExceptionHandler");
        jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jobjectid Java_com_examples_shared_1ptr_SymbolUsageShared_jConstructor_11(JNIEnv* env, jobject obj, jobjectid d, ...){
    ...
    try {
        cppbind::example::SymbolUsageShared* ptr = new cppbind::example::SymbolUsageShared(jnitocxxd);
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_SYMBOLUSAGESHARED), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/cppbind/exceptionUtils/ExceptionHandler");
