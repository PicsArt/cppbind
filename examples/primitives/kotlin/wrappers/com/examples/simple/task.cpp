...
extern "C" JNIEXPORT void Java_com_examples_simple_Task_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    delete static_cast<iegen::example::Task*>(iegen_obj_id_ptr);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_simple_Task_jConstructor(JNIEnv* env, jobject obj, jstring title){
    ...
    try {
        iegen::example::Task* ptr = new iegen::example::Task(jnitocxxtitle);
        return reinterpret_cast<jlong>(new IEGenCObject {strdup("iegen::example::Task"), ptr});
    }
...
extern "C" JNIEXPORT jstring Java_com_examples_simple_Task_jTitle(JNIEnv* env, jobject obj, jobjectid id){
    ...
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    auto iegen_obj_id_ptr = iegen_obj_id ? iegen_obj_id->ptr : nullptr;
    auto jnitocxxid = static_cast<iegen::example::Task*>(iegen_obj_id_ptr);
    try {
...
extern "C" JNIEXPORT jboolean Java_com_examples_simple_Task_jEquals(JNIEnv* env, jobject obj, jobjectid id, jobjectid t){
    ...
    auto jnitocxxt = static_cast<iegen::example::Task*>(iegen_obj_t_ptr);
