...
extern "C" JNIEXPORT void Java_com_examples_simple_task_Task_jFinalize(JNIEnv*, jobject, jobjectid id){
...
extern "C" JNIEXPORT jlong Java_com_examples_simple_task_Task_jGetcxxid(JNIEnv*, jobject, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
    auto cppbind_obj_id_ptr = cppbind_obj_id->ptr;
    return reinterpret_cast<jlong>(static_cast<cppbind::example::Task*>(cppbind_obj_id_ptr));
}

extern "C" JNIEXPORT jobjectid Java_com_examples_simple_task_Task_jConstructor([[maybe_unused]] JNIEnv* env, jobject, jstring title, ...){
    using namespace cppbind::example;
...
extern "C" JNIEXPORT jstring Java_com_examples_simple_task_Task_jTitle([[maybe_unused]] JNIEnv* env, jobject, jobjectid id){
    using namespace cppbind::example;
    validateID(id);
...
extern "C" JNIEXPORT void Java_com_examples_simple_task_Task_jSettitle([[maybe_unused]] JNIEnv* env, jobject, jobjectid id, jstring title, ...){
    using namespace cppbind::example;
...
extern "C" JNIEXPORT jboolean Java_com_examples_simple_task_Task_jEquals([[maybe_unused]] JNIEnv* env, jobject, jobjectid id, jobjectid t, ...){
    using namespace cppbind::example;
...
extern "C" JNIEXPORT jstring Java_com_examples_simple_task_TaskKt_jGettypebyid(JNIEnv* env, jclass, jobjectid id) {
    validateID(id);
