...
const char* IEGEN_IEGEN_EXAMPLE_IADDRESSABLEROOT = "iegen::example::Addressable<iegen::example::Root>";
...
extern "C" JNIEXPORT void Java_com_examples_templates_AddressableImplRoot_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_IADDRESSABLEROOT) == 0)
        delete static_cast<std::shared_ptr<iegen::example::Addressable<iegen::example::Root>>*>(iegen_obj_id_ptr);
    else if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_COMPONENT) == 0)
...
std::shared_ptr<iegen::example::Addressable<iegen::example::Root>> recover_obj_from_IegenExample_IAddressableRoot(jobjectid id) {
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    auto iegen_obj_id_ptr = iegen_obj_id ? iegen_obj_id->ptr : nullptr;
    if (iegen_obj_id_ptr) {
        if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_IADDRESSABLEROOT) == 0)
...
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_AddressableImplRoot_jConstructor(JNIEnv* env, jobject obj, jobjectid parent, jstring name){
    ...
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_IADDRESSABLEROOT), new std::shared_ptr<iegen::example::Addressable<iegen::example::Root>>(this_object)});
    }
...
extern "C" JNIEXPORT jstring Java_com_examples_templates_IAddressableRootHelper_jAbspath(JNIEnv* env, jobject obj, jobjectid id){
    ...
    jnitocxxid = recover_obj_from_IegenExample_IAddressableRoot(id);
