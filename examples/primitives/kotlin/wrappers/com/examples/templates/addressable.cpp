 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 09/07/2021-09:27.
...
extern "C" JNIEXPORT void Java_com_examples_templates_AddressableRoot_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    std::shared_ptr<iegen::example::Addressable<iegen::example::Root>> jni_to_cxx_id;
    jni_to_cxx_id = *reinterpret_cast<std::shared_ptr<iegen::example::Addressable<iegen::example::Root>>*>(id);
    jni_to_cxx_id.reset();
}
