...
extern "C" JNIEXPORT void Java_com_examples_templates_Component_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    std::shared_ptr<iegen::example::Component> jni_to_cxx_id;
    auto jni_to_cxx_id_baseptr = *reinterpret_cast<std::shared_ptr<iegen::example::Addressable<iegen::example::Root>>*>(id);
    jni_to_cxx_id = std::dynamic_pointer_cast<iegen::example::Component>(jni_to_cxx_id_baseptr);
    jni_to_cxx_id.reset();
}
