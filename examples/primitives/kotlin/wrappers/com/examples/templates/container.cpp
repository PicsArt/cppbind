...
extern const char* IEGEN_IEGEN_EXAMPLE_STACKPRJ;
extern const char* IEGEN_IEGEN_EXAMPLE_PROJECT;
extern const char* IEGEN_IEGEN_EXAMPLE_STACKTASK;
extern const char* IEGEN_IEGEN_EXAMPLE_TASK;
extern const char* IEGEN_IEGEN_EXAMPLE_STACKNUMINT;
extern const char* IEGEN_IEGEN_EXAMPLE_NUMBERINT;
extern const char* IEGEN_STD_STDEXCEPTION;

const char* IEGEN_IEGEN_EXAMPLE_ICONTAINER = "iegen::example::Container";
const char* IEGEN_IEGEN_EXAMPLE_CONTAINERHOLDER = "iegen::example::ContainerHolder";
...
extern "C" JNIEXPORT void Java_com_examples_templates_ContainerImpl_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_ICONTAINER) == 0)
        delete static_cast<iegen::example::Container*>(iegen_obj_id_ptr);
    else if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_STACKPRJ) == 0)
        delete static_cast<iegen::example::Stack<iegen::example::Project>*>(iegen_obj_id_ptr);
    else if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_STACKTASK) == 0)
        delete static_cast<iegen::example::Stack<iegen::example::Task>*>(iegen_obj_id_ptr);
    else if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_STACKNUMINT) == 0)
...
iegen::example::Container* recover_obj_from_IegenExample_IContainer(jobjectid id) {
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    auto iegen_obj_id_ptr = iegen_obj_id ? iegen_obj_id->ptr : nullptr;
    if (iegen_obj_id_ptr) {
        if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_ICONTAINER) == 0)
            return static_cast<iegen::example::Container*>(iegen_obj_id_ptr);
        else if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_STACKPRJ) == 0)
            return static_cast<iegen::example::Stack<iegen::example::Project>*>(iegen_obj_id_ptr);
        else if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_STACKTASK) == 0)
            return static_cast<iegen::example::Stack<iegen::example::Task>*>(iegen_obj_id_ptr);
        else if (strcmp(iegen_obj_id->type, IEGEN_IEGEN_EXAMPLE_STACKNUMINT) == 0)
            return static_cast<iegen::example::Stack<iegen::example::Number<int>>*>(iegen_obj_id_ptr);
        else {
            std::cerr << "Unexpected object type: " << iegen_obj_id->type << std::endl;
            exit(1);
        }
...
extern "C" JNIEXPORT void Java_com_examples_templates_ContainerHolder_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    auto iegen_obj_id_ptr = iegen_obj_id ? iegen_obj_id->ptr : nullptr;
    delete static_cast<iegen::example::ContainerHolder*>(iegen_obj_id_ptr);
    free(iegen_obj_id->type);
    delete iegen_obj_id;
}
...
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_ContainerHolder_jConstructor(JNIEnv* env, jobject obj, jobjectid container){
    ...
    iegen::example::Container* jnitocxxcontainer = recover_obj_from_IegenExample_IContainer(container);
    try {
        iegen::example::ContainerHolder* ptr = new iegen::example::ContainerHolder(jnitocxxcontainer);
        return reinterpret_cast<jlong>(new IEGenCObject {strdup(IEGEN_IEGEN_EXAMPLE_CONTAINERHOLDER), ptr});
    }
...
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_ContainerHolder_jContainer(JNIEnv* env, jobject obj, jobjectid id){
    ...
    try {
        ...
        if (status == 0) {
            ...
            type_result = strdup(IEGEN_IEGEN_EXAMPLE_ICONTAINER);
        }
