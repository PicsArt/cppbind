...
extern "C" JNIEXPORT void Java_com_examples_templates_ContainerImpl_jFinalize(JNIEnv*, jobject, jobjectid id){
    ...
    else if (strcmp(cppbind_obj_id->type, CPPBIND_CPPBIND_EXAMPLE_ROOTSSTACK) == 0)
...
cppbind::example::Container* recover_obj_from_CppbindExample_IContainer(jobjectid id) {
    ...
    if (cppbind_obj_id_ptr) {
        if (strcmp(cppbind_obj_id->type, CPPBIND_CPPBIND_EXAMPLE_ICONTAINER) == 0)
            ...
            return cppbind::safe_cast<cppbind::example::MyStack<cppbind::example::Project>, cppbind::example::Container>(cppbind_obj_id_ptr);
        else if (strcmp(cppbind_obj_id->type, CPPBIND_CPPBIND_EXAMPLE_MYSTACKTASK) == 0)
            return cppbind::safe_cast<cppbind::example::MyStack<cppbind::example::Task>, cppbind::example::Container>(cppbind_obj_id_ptr);
        else if (strcmp(cppbind_obj_id->type, CPPBIND_CPPBIND_EXAMPLE_MYSTACKROOT) == 0)
            return cppbind::safe_cast<cppbind::example::MyStackRoot, cppbind::example::Container>(cppbind_obj_id_ptr);
        else if (strcmp(cppbind_obj_id->type, CPPBIND_CPPBIND_EXAMPLE_STACKPRJ) == 0)
            return cppbind::safe_cast<cppbind::example::Stack<cppbind::example::Project>, cppbind::example::Container>(cppbind_obj_id_ptr);
        else if (strcmp(cppbind_obj_id->type, CPPBIND_CPPBIND_EXAMPLE_STACKTASK) == 0)
            return cppbind::safe_cast<cppbind::example::Stack<cppbind::example::Task>, cppbind::example::Container>(cppbind_obj_id_ptr);
        else if (strcmp(cppbind_obj_id->type, CPPBIND_CPPBIND_EXAMPLE_STACKNUMINT) == 0)
            return cppbind::safe_cast<cppbind::example::Stack<cppbind::example::Number<int>>, cppbind::example::Container>(cppbind_obj_id_ptr);
        else if (strcmp(cppbind_obj_id->type, CPPBIND_CPPBIND_EXAMPLE_ROOTSSTACK) == 0)
            return cppbind::safe_cast<cppbind::example::Stack<cppbind::example::Root>, cppbind::example::Container>(cppbind_obj_id_ptr);
        else {
            std::cerr << "Unexpected object type: " << cppbind_obj_id->type << std::endl;
            exit(1);
        }
