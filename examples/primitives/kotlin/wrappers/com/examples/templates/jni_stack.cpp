...
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_StackPrj_jConstructor_11([[maybe_unused]] JNIEnv* env, jobject, jobjectid stack, ...){
    ...
    try {
        cppbind::example::Stack<cppbind::example::Project>* ptr = new cppbind::example::Stack<cppbind::example::Project>(jnitocxxstack);
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_STACKPRJ), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/cppbind/ExceptionHandler");
...
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_StackTask_jConstructor_11([[maybe_unused]] JNIEnv* env, jobject, jobjectid stack, ...){
    ...
    try {
        cppbind::example::Stack<cppbind::example::Task>* ptr = new cppbind::example::Stack<cppbind::example::Task>(jnitocxxstack);
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_STACKTASK), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/cppbind/ExceptionHandler");
...
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_StackNumInt_jConstructor_11([[maybe_unused]] JNIEnv* env, jobject, jobjectid stack, ...){
    ...
    try {
        cppbind::example::Stack<cppbind::example::Number<int>>* ptr = new cppbind::example::Stack<cppbind::example::Number<int>>(jnitocxxstack);
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_STACKNUMINT), ptr});
    }
    catch (const std::exception& e) {
        jclass handlerCls = env->FindClass("com/examples/cppbind/ExceptionHandler");
