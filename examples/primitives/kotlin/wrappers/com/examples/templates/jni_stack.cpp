...
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_StackPrj_jConstructor_11([[maybe_unused]] JNIEnv* env, jobject, jobjectid st, ...){
...
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_StackTask_jConstructor_11([[maybe_unused]] JNIEnv* env, jobject, jobjectid st, ...){
...
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_StackNumInt_jConstructor_11([[maybe_unused]] JNIEnv* env, jobject, jobjectid st, ...){
