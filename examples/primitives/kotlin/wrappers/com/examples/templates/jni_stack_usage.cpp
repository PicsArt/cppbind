...
cppbind::example::Stack<cppbind::example::Project>* recover_obj_from_CppbindExample_StackPrj(jobjectid);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_StackUsage_jConstructor([[maybe_unused]] JNIEnv* env, jobject){
    using namespace cppbind::example;
    try {
        cppbind::example::StackUsage* this_object = new cppbind::example::StackUsage();
        return reinterpret_cast<jlong>(new CppBindCObject {strdup(CPPBIND_CPPBIND_EXAMPLE_STACKUSAGE), this_object});
    }
...
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_StackUsage_jFirstitemofspecializedstack([[maybe_unused]] JNIEnv* env, jobject, jobjectid id, jobjectid p, ...){
    ...
    Stack<cppbind::example::Project>* jnitocxxp = recover_obj_from_CppbindExample_StackPrj(p);
    ...
    try {
        decltype(auto) result = jnitocxxid->firstItemOfSpecializedStack(jnitocxxp);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_StackUsage_jFirstitemoftypedefofspecializedstack([[maybe_unused]] JNIEnv* env, jobject, jobjectid id, jobjectid p, ...){
    ...
    cppbind::example::StackUsage::StackProject* jnitocxxp = recover_obj_from_CppbindExample_StackPrj(p);
    ...
    try {
        decltype(auto) result = jnitocxxid->firstItemOfTypedefOfSpecializedStack(jnitocxxp);
        cppbind::example::Project* cxxtojniresult_ptr = result;
        char* type_result = strdup(CPPBIND_CPPBIND_EXAMPLE_PROJECT);
        CppBindCObject* cppbind_obj_cxxtojniresult = new CppBindCObject {type_result, cxxtojniresult_ptr};
        jobjectid cxxtojniresult = reinterpret_cast<jlong>(cppbind_obj_cxxtojniresult);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_StackUsage_jFirstitemoftemplatestackProject([[maybe_unused]] JNIEnv* env, jobject, jobjectid id, jobjectid p, ...){
    ...
    cppbind::example::Stack<cppbind::example::Project>* jnitocxxp = recover_obj_from_CppbindExample_StackPrj(p);
    ...
    try {
        decltype(auto) result = jnitocxxid->firstItemOfTemplateStack<cppbind::example::Project>(jnitocxxp);
        cppbind::example::Project* cxxtojniresult_ptr = result;
        char* type_result = strdup(CPPBIND_CPPBIND_EXAMPLE_PROJECT);
        CppBindCObject* cppbind_obj_cxxtojniresult = new CppBindCObject {type_result, cxxtojniresult_ptr};
        jobjectid cxxtojniresult = reinterpret_cast<jlong>(cppbind_obj_cxxtojniresult);
...
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_StackUsage_jFirstitemofspecializedstackwithtypedefarg([[maybe_unused]] JNIEnv* env, jobject, jobjectid id, jobjectid p, ...){
    ...
    StackProjectType* jnitocxxp = recover_obj_from_CppbindExample_StackPrj(p);
    ...
    try {
        decltype(auto) result = jnitocxxid->firstItemOfSpecializedStackWithTypedefArg(jnitocxxp);
        cppbind::example::Project* cxxtojniresult_ptr = result;
        char* type_result = strdup(CPPBIND_CPPBIND_EXAMPLE_PROJECT);
        CppBindCObject* cppbind_obj_cxxtojniresult = new CppBindCObject {type_result, cxxtojniresult_ptr};
        jobjectid cxxtojniresult = reinterpret_cast<jlong>(cppbind_obj_cxxtojniresult);
