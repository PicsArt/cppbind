 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 09/06/2021-07:25.
...
extern "C" JNIEXPORT jboolean Java_com_examples_templates_StackProject_jEmpty(JNIEnv* env, jobject obj, jobjectid id){
    ...
    try {
        auto result = jni_to_cxx_id->empty();
...
extern "C" JNIEXPORT void Java_com_examples_templates_StackNumberInt_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    
    auto jni_to_cxx_id = reinterpret_cast<iegen::example::Stack<iegen::example::Number<int>>*>(id);
    delete jni_to_cxx_id;
}
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_StackNumberInt_jConstructor(JNIEnv* env, jobject obj){
    iegen::example::Stack<iegen::example::Number<int>>* baseptr = new iegen::example::Stack<iegen::example::Number<int>>();
    return reinterpret_cast<jlong>(baseptr);
}
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_StackNumberInt_jConstructor_11(JNIEnv* env, jobject obj, jobjectid st){
...
extern "C" JNIEXPORT void Java_com_examples_templates_StackNumberInt_jPush(JNIEnv* env, jobject obj, jobjectid id, jobjectid item){
...
extern "C" JNIEXPORT void Java_com_examples_templates_StackNumberInt_jPop(JNIEnv* env, jobject obj, jobjectid id){
...
extern "C" JNIEXPORT jobjectid Java_com_examples_templates_StackNumberInt_jTop(JNIEnv* env, jobject obj, jobjectid id){
    ...
    try {
        ...
        iegen::example::Number<int>* cxx_to_jni_result_baseptr = result;
        jobjectid cxx_to_jni_result = reinterpret_cast<jlong>(cxx_to_jni_result_baseptr);
        return cxx_to_jni_result;
    }
    catch (const std::exception& e) {
...
extern "C" JNIEXPORT jboolean Java_com_examples_templates_StackNumberInt_jEmpty(JNIEnv* env, jobject obj, jobjectid id){
