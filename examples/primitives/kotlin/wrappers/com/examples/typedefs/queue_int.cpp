...
extern "C" JNIEXPORT jobjectid Java_com_examples_typedefs_QueueIntUsage_jGetinvqueue(JNIEnv* env, jobject obj, jintArray v){
    ...
    try {
        ...
        iegen::example::QueueInt* _result = new iegen::example::QueueInt(result);
        iegen::example::QueueInt* cxxtojniresult_baseptr = const_cast<iegen::example::QueueInt*>(_result);
