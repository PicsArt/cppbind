...
extern "C" JNIEXPORT void Java_com_examples_typedefs_QueueInt_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    auto jnitocxxid = reinterpret_cast<iegen::example::QueueInt*>(iegen_obj_id_ptr);
    delete jnitocxxid;
...
extern "C" JNIEXPORT jobjectid Java_com_examples_typedefs_QueueInt_jConstructor(JNIEnv* env, jobject obj){
    try {
        ...
        return reinterpret_cast<jlong>(new IEGenCObject {strdup("iegen::example::QueueInt"), baseptr});
    }
...
extern "C" JNIEXPORT void Java_com_examples_typedefs_QueueIntUsage_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
    ...
    auto iegen_obj_id = reinterpret_cast<IEGenCObject*>(id);
    auto iegen_obj_id_ptr = iegen_obj_id ? iegen_obj_id->ptr : nullptr;
    auto jnitocxxid = reinterpret_cast<iegen::example::QueueIntUsage*>(iegen_obj_id_ptr);
    delete jnitocxxid;
    free(iegen_obj_id->type);
    delete iegen_obj_id;
}
...
extern "C" JNIEXPORT jobjectid Java_com_examples_typedefs_QueueIntUsage_jConstructor(JNIEnv* env, jobject obj, jobjectid q){
    ...
    auto jnitocxxq = reinterpret_cast<iegen::example::QueueInt*>(iegen_obj_q_ptr);
    try {
        iegen::example::QueueIntUsage* baseptr = new iegen::example::QueueIntUsage(jnitocxxq);
        return reinterpret_cast<jlong>(new IEGenCObject {strdup("iegen::example::QueueIntUsage"), baseptr});
    }
    catch (const std::exception& e) {
          jclass handlerCls = env->FindClass("com/examples/iegen/exceptionUtils/ExceptionHandler");
          jmethodID handlerMethod = env->GetStaticMethodID(handlerCls, "handleUncaughtException", "(Ljava/lang/String;)V");
...
extern "C" JNIEXPORT jint Java_com_examples_typedefs_QueueIntUsage_jGetsize(JNIEnv* env, jobject obj, jobjectid q){
    ...
    auto iegen_obj_q = reinterpret_cast<IEGenCObject*>(q);
    auto iegen_obj_q_ptr = iegen_obj_q ? iegen_obj_q->ptr : nullptr;
    auto& jnitocxxq = *reinterpret_cast<iegen::example::ConstQueueIntType*>(iegen_obj_q_ptr);
...
extern "C" JNIEXPORT jint Java_com_examples_typedefs_QueueIntUsage_jGetlastelement(JNIEnv* env, jobject obj, jobjectid q){
    ...
    auto iegen_obj_q = reinterpret_cast<IEGenCObject*>(q);
    auto iegen_obj_q_ptr = iegen_obj_q ? iegen_obj_q->ptr : nullptr;
    auto jnitocxxq = reinterpret_cast<iegen::example::QueueIntType*>(iegen_obj_q_ptr);
