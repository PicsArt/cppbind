...
class Color(pybind_color_pygen.Color):
    """
    Color Enum.
    Documentation generated from: `examples/primitives/cxx/enums/color.hpp#L13 <https://github.com/PicsArt/iegen/tree/master/examples/primitives/cxx/enums/color.hpp#L13>`_
    """
    # Red = 1
