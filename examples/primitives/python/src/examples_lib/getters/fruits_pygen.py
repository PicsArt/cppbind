...
class FruitType(metaclass=IEGenEnumMetaclass):
    """
...
class Fruit(metaclass=IEGenMetaclass):
    """
...
class Apple(Fruit, metaclass=IEGenMetaclass):
    """
...
class Pineapple(Fruit, metaclass=IEGenMetaclass):
    """
...
class Fruits(metaclass=IEGenMetaclass):
    """
