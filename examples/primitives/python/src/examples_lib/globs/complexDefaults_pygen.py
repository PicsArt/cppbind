...
def single_complex_default_value(task: simple_task_task_pygen.PyTask = None) -> simple_task_task_pygen.PyTask:
    """
    Documentation generated from: `cxx/globs/utils.h#L141
    <https://github.com/PicsArt/cppbind/tree/master/examples/primitives/cxx/globs/utils.h#L141>`_
    """
    pass
...
def multiple_mixed_default_values(task: simple_task_task_pygen.PyTask = None, i: int = 1, r: simple_root_pygen.Root = None) -> str:
    ...
    Documentation generated from: `cxx/globs/utils.h#L152
    <https://github.com/PicsArt/cppbind/tree/master/examples/primitives/cxx/globs/utils.h#L152>`_
    """
    pass
