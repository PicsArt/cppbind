...
This file is generated by iegen on 12/16/2021-07:40.
...
from .exceptions import IEGENError
...
class Function:
    ...
    def pybind_module(self):
        ...
        if module is None:
            raise IEGENError(f'Could not load corresponding pybind module for: {self.original_function.__module__}')
        return module
    ...
    def classname(self):
        ...
        if '.' not in self.original_function.__qualname__:
            return None
        # for methods __qualname__ is <ClassName>.<FunctionName>
