...
class WithExternalAPIComments(metaclass=IEGenMetaclass):
    """
...
class AdderInt(metaclass=IEGenMetaclass):
    """
...
class AdderFloat(metaclass=IEGenMetaclass):
    """
    Documentation generated from: `cxx/misc/yaml_example.hpp#L38
    <https://github.com/PicsArt/iegen/tree/master/examples/primitives/cxx/misc/yaml_example.hpp#L38>`_
    """
...
class color(metaclass=IEGenEnumMetaclass):
    """
