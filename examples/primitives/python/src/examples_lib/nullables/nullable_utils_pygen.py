...
class Utils(metaclass=CppBindMetaclass):
    ...
    def nullable(self) -> Optional[NumberDouble]:
        """
        Documentation generated from: `cxx/nullables/nullable_utils.hpp#L146
        <https://github.com/PicsArt/cppbind/tree/master/examples/primitives/cxx/nullables/nullable_utils.hpp#L146>`_
        """
        pass
    ...
    def non_null(self) -> NumberDouble:
        """
        Documentation generated from: `cxx/nullables/nullable_utils.hpp#L166
        <https://github.com/PicsArt/cppbind/tree/master/examples/primitives/cxx/nullables/nullable_utils.hpp#L166>`_
        """
        pass
    ...
    def num_double(self) -> Optional[NumberDouble]:
        """
        Documentation generated from: `cxx/nullables/nullable_utils.hpp#L185
        <https://github.com/PicsArt/cppbind/tree/master/examples/primitives/cxx/nullables/nullable_utils.hpp#L185>`_
        """
        pass
    ...
    def num_int(self) -> NumberInt:
        """
        Documentation generated from: `cxx/nullables/nullable_utils.hpp#L192
        <https://github.com/PicsArt/cppbind/tree/master/examples/primitives/cxx/nullables/nullable_utils.hpp#L192>`_
        """
        pass
    ...
    def check_nonnull_return(cls) -> NumberDouble:
        ...
        <https://github.com/PicsArt/cppbind/tree/master/examples/primitives/cxx/nullables/nullable_utils.hpp#L135>`_
        """
        pass
...
def reverse_string(s: Optional[str]) -> Optional[str]:
    """
    Documentation generated from: `cxx/nullables/nullable_utils.hpp#L205
    <https://github.com/PicsArt/cppbind/tree/master/examples/primitives/cxx/nullables/nullable_utils.hpp#L205>`_
    """
    pass
