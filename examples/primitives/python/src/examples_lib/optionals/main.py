...
from examples_lib.enums.logging_pygen import LogLevel
...
assert op.optional_enum_with_default_and_changed_names() == LogLevel.WARNING
...
assert op.optional_enum_with_default_and_changed_names(LogLevel.LOG_CRITICAL) == LogLevel.LOG_CRITICAL
