...
This file is generated by iegen on 12/24/2021-10:35.
...
class Utils(metaclass=OriginalMethodsMetaclass):
    ...
    def minus(cls, first: int, second: int) -> int:
        """
        Sub two ints.
        Documentation generated from: `cxx/overloads/utils.hpp#L70
        <https://github.com/PicsArt/iegen/tree/master/examples/primitives/cxx/overloads/utils.hpp#L70>`_
        """
        pass
    ...
    def minus(cls, first: float, second: float) -> float:
        """
        Sub two floats.
        Documentation generated from: `cxx/overloads/utils.hpp#L81
        <https://github.com/PicsArt/iegen/tree/master/examples/primitives/cxx/overloads/utils.hpp#L81>`_
        """
        pass
