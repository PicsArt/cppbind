...
This file is generated by iegen on 05/10/2022-10:20.
...
class Utils(metaclass=IEGenMetaclass):
    ...
    <https://github.com/PicsArt/iegen/tree/master/examples/primitives/cxx/overloads/utils.hpp#L14>`_
    """
    ...
    def minus(cls, first: int, second: int) -> int:
        ...
        <https://github.com/PicsArt/iegen/tree/master/examples/primitives/cxx/overloads/utils.hpp#L72>`_
        """
        pass
    ...
    def minus(cls, first: float, second: float) -> float:
        ...
        <https://github.com/PicsArt/iegen/tree/master/examples/primitives/cxx/overloads/utils.hpp#L83>`_
        """
        pass
