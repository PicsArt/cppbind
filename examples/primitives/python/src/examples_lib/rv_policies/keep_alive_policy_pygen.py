...
This file is generated by iegen on 02/23/2022-09:00.
...
class Child1(metaclass=OriginalMethodsMetaclass):
    """
...
class Child3(metaclass=OriginalMethodsMetaclass):
    """
...
class Child2(metaclass=OriginalMethodsMetaclass):
    """
...
class Parent1(metaclass=OriginalMethodsMetaclass):
    """
...
class Parent2(metaclass=OriginalMethodsMetaclass):
    """
    A test example for keep_alive policy. Container holding shared_ref and non shared_ref class and interface types.
