...
class SignShared(metaclass=IEGenMetaclass):
    """
...
class TextShared(metaclass=IEGenMetaclass):
    """
...
class DigitShared(SignShared, TextShared, metaclass=IEGenMetaclass):
    """
...
class SymbolUsageShared(metaclass=IEGenMetaclass):
    """
