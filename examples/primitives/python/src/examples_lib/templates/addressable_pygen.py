...
class AddressableRoot(metaclass=CppBindMetaclass):
    ...
    <https://github.com/PicsArt/cppbind/tree/master/examples/primitives/cxx/templates/addressable.hpp#L25>`_
    """
    ...
    def __init__(self, parent: simple_root_pygen.Root, name: str):
        ...
        <https://github.com/PicsArt/cppbind/tree/master/examples/primitives/cxx/templates/addressable.hpp#L33>`_
        """
        pass
    ...
    def abs_path(self) -> str:
        ...
        <https://github.com/PicsArt/cppbind/tree/master/examples/primitives/cxx/templates/addressable.hpp#L43>`_
        """
        pass
