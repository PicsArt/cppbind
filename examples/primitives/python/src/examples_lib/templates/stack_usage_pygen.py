...
class StackUsage(metaclass=CppBindMetaclass):
    ...
    def first_item_of_template_stack(self, p: stack_pygen.StackPrj) -> simple_project_pygen.Project:
        ...
        <https://github.com/PicsArt/cppbind/tree/master/examples/primitives/cxx/templates/stack_usage.hpp#L49>`_
        """
        pass
    ...
    def first_item_of_specialized_stack_with_typedef_arg(self, p: stack_pygen.StackPrj) -> simple_project_pygen.Project:
        ...
        Documentation generated from: `cxx/templates/stack_usage.hpp#L61
        <https://github.com/PicsArt/cppbind/tree/master/examples/primitives/cxx/templates/stack_usage.hpp#L61>`_
        """
        pass
