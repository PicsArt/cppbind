...
class FruitType(pybind_fruits_pygen.FruitType):
    """
...
class Fruits(metaclass=OriginalMethodsMetaclass):
    ...
    def apples(self) -> List[Apple]:
        """
        Documentation generated from: `cxx/getters/fruits.hpp#L116
        <https://github.com/PicsArt/iegen/tree/master/examples/primitives/cxx/getters/fruits.hpp#L116>`_
        """
        pass
    ...
    def apples_with_pineapples(self) -> List[Fruit]:
        """
        Documentation generated from: `cxx/getters/fruits.hpp#L139
        <https://github.com/PicsArt/iegen/tree/master/examples/primitives/cxx/getters/fruits.hpp#L139>`_
        """
        pass
