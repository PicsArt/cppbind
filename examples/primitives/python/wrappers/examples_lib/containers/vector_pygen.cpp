...
void bindIegenExampleVectorExamples(py::module& m) {
    ...
    vectorExamples.def("add_int_vector", &iegen::example::VectorExamples::addIntVector, py::arg("v"), py::return_value_policy::automatic);
    vectorExamples.def("add_obj_vector", &iegen::example::VectorExamples::addObjVector, py::arg("v"), py::return_value_policy::automatic);
    vectorExamples.def("add_string_vector", &iegen::example::VectorExamples::addStringVector, py::arg("v"), py::return_value_policy::automatic);
