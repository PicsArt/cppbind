...
void bindExamples(py::module& m) {
    ...
    bindIegenExampleValue(rv_policies_return_value_policies);
    bindIegenExampleValueSharedRef(rv_policies_return_value_policies);
    bindIegenExampleValuesHolder(rv_policies_return_value_policies);
    py::module_ rv_policies_singleton = rv_policies.def_submodule("singleton", "singleton");

    bindIegenExampleSingleton(rv_policies_singleton);
