...
void bindExamples(py::module& m) {
    ...
    bindExamplesLibGlobsPrimitivedefaults(globs_primitiveDefaults);
    py::module_ globs_complexDefaults = globs.def_submodule("complexDefaults", "complexDefaults");

    bindExamplesLibGlobsComplexdefaults(globs_complexDefaults);
    py::module_ globs_customArgUtils = globs.def_submodule("customArgUtils", "customArgUtils");

    bindExamplesLibGlobsCustomargutils(globs_customArgUtils);
    ...
    bindExamplesLibInheritanceMammalsAnimal(inheritance_mammals_animal);
    ...
    bindExamplesLibInheritanceDoctor(inheritance_doctor);
    ...
    bindExamplesLibRvPoliciesKeepAlivePolicy(rv_policies_keep_alive_policy);
    ...
    bindExamplesLibTypedefsQueueInt(typedefs_queue_int);
    py::module_ typedefs_queue_int_shared = typedefs.def_submodule("queue_int_shared", "queue_int_shared");

    bindExamplesLibTypedefsQueueIntShared(typedefs_queue_int_shared);
}
