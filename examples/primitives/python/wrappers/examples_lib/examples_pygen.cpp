...
void bindExamples(py::module& m) {
    ...
    bindIegenExampleQueueInt(typedefs_queue_int);
    bindIegenExampleQueueIntUsage(typedefs_queue_int);
    py::module_ typedefs_queue_int_shared = typedefs.def_submodule("queue_int_shared", "queue_int_shared");

    bindIegenExampleQueueIntShared(typedefs_queue_int_shared);
    bindIegenExampleQueueIntSharedUsage(typedefs_queue_int_shared);
    py::module_ typedefs_queue_template = typedefs.def_submodule("queue_template", "queue_template");

    bindIegenExampleQueueString(typedefs_queue_template);
    bindIegenExampleQueueUsage(typedefs_queue_template);
}
