 ...
 * 
 * This file is generated by cppbind on 11/22/2022-08:54.
...
void bindExamples(py::module& m) {
    ...
    py::module_ basic_types = m.def_submodule("basic_types", "basic_types");

    py::module_ basic_types_short = basic_types.def_submodule("short", "short");

    bindExamplesLibBasicTypesShortPygen(basic_types_short);
    ...
    py::module_ factories = m.def_submodule("factories", "factories");

    py::module_ factories_school = factories.def_submodule("school", "school");

    bindExamplesLibFactoriesSchoolPygen(factories_school);
    ...
    py::module_ globs_max = globs.def_submodule("max", "max");

    bindExamplesLibGlobsMaxPygen(globs_max);
    py::module_ globs_min = globs.def_submodule("min", "min");

    bindExamplesLibGlobsMinPygen(globs_min);
    ...
    py::module_ inheritance_shapes = inheritance.def_submodule("shapes", "shapes");

    bindExamplesLibInheritanceShapesPygen(inheritance_shapes);
    ...
    py::module_ macros = m.def_submodule("macros", "macros");

    py::module_ macros_macro_usage = macros.def_submodule("macro_usage", "macro_usage");

    bindExamplesLibMacrosMacroUsagePygen(macros_macro_usage);
    ...
    py::module_ stl_types = m.def_submodule("stl_types", "stl_types");

    py::module_ stl_types_std_optional = stl_types.def_submodule("std_optional", "std_optional");

    bindExamplesLibStlTypesStdOptionalPygen(stl_types_std_optional);
    ...
    py::module_ templates_elements = templates.def_submodule("elements", "elements");

    bindExamplesLibTemplatesElementsPygen(templates_elements);
    ...
    py::module_ templates_vector = templates.def_submodule("vector", "vector");

    bindExamplesLibTemplatesVectorPygen(templates_vector);
