...
void bindExamplesLibGlobsUtilsPygen(py::module& m) {
    ...
    {
        m.def("max_str", &::max<std::string>, py::arg("a"), py::arg("b"), py::return_value_policy::automatic);
    }
    {
        using namespace iegen::example;
        m.def("make_pair_project_project", &iegen::example::makePair<iegen::example::Project, iegen::example::Project>, py::arg("a"), py::arg("b"), py::return_value_policy::reference);
    }
    {
        using namespace iegen::example;
        m.def("make_pair_root_project", &iegen::example::makePair<iegen::example::Root, iegen::example::Project>, py::arg("a"), py::arg("b"), py::return_value_policy::reference);
    }
    {
