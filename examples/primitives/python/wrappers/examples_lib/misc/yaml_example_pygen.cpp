...
void bindExamplesLibMiscYamlExample(py::module& m) {
    {
        ...
        withExternalAPIComments.def_static("max", &iegen::example::WithExternalAPIComments::max<int>, py::arg("arg0"), py::arg("arg1"), py::return_value_policy::automatic);
        withExternalAPIComments.def_static("max", &iegen::example::WithExternalAPIComments::max<std::string>, py::arg("arg0"), py::arg("arg1"), py::return_value_policy::automatic);
    }
    {
        using namespace iegen::example;
