...
void bindExamplesLibNullablesNullableUtils(py::module& m) {
    {
    ...
    }
    {
        ...
        utils.def_static("check_nonnull_arg", &iegen::example::nullable::Utils::checkNonnullArg, py::arg("number"), py::return_value_policy::automatic);
...
} /* bindExamplesLibNullablesNullableUtils */
