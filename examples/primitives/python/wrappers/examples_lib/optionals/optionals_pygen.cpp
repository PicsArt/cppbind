...
void bindExamplesLibOptionalsOptionals(py::module& m) {
    {
        ...
        optionals.def("optional_ref_with_default_complex_value", &iegen::example::Optionals::optionalRefWithDefaultComplexValue, py::arg("task") = Task("MyTask"), py::return_value_policy::automatic);
        optionals.def("optional_by_val_with_default_complex_value", &iegen::example::Optionals::optionalByValWithDefaultComplexValue, py::arg("task") = Task("MyTask"), py::return_value_policy::automatic);
    }
