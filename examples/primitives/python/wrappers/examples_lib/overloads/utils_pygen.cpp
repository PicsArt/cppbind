...
void bindIegenExampleUtils(py::module& m) {
    ...
    utils.def_static("minus", py::overload_cast<int, int>(&iegen::example::Utils::sub), py::arg("first"), py::arg("second"));
    utils.def_static("minus", py::overload_cast<float, float>(&iegen::example::Utils::sub), py::arg("first"), py::arg("second"));
}
