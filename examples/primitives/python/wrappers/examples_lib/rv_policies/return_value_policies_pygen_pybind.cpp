...
void bindExamplesLibRvPoliciesReturnValuePoliciesPygen(py::module& m) {
    {
        ...
        value.def("__repr__", [](const cppbind::example::Value& self) -> std::string {
            int status;
            ...
            const char * classname = "cppbind::example::Value";
            if (status == 0) {
    ...
    {
        using namespace cppbind::example;
        py::class_<cppbind::example::MovableValue> movableValue(m, "MovableValue");
        
        movableValue.def(py::init<std::string>(), py::arg("name"));

        movableValue.def_property("name", py::cpp_function(&cppbind::example::MovableValue::name, py::return_value_policy::reference_internal), &cppbind::example::MovableValue::setName);
        movableValue.def("__repr__", [](const cppbind::example::MovableValue& self) -> std::string {
            int status;
            const char* name = typeid(self).name();
            std::unique_ptr<char[], std::function<void(char*)>> demangledSymbol(
                __cxxabiv1::__cxa_demangle(name, nullptr, nullptr, &status), free);
            const char * classname = "cppbind::example::MovableValue";
            if (status == 0) {
                classname = demangledSymbol.get();
            }
            char res[96];
    ...
    }
    {
        ...
        valueSharedRef.def("__repr__", [](const cppbind::example::ValueSharedRef& self) -> std::string {
            int status;
            const char* name = typeid(self).name();
            std::unique_ptr<char[], std::function<void(char*)>> demangledSymbol(
                __cxxabiv1::__cxa_demangle(name, nullptr, nullptr, &status), free);
            const char * classname = "cppbind::example::ValueSharedRef";
            if (status == 0) {
                classname = demangledSymbol.get();
            }
            char res[96];
    ...
    }
    {
        ...
        valuesHolder.def("get_movable_value", &cppbind::example::ValuesHolder::getMovableValue, py::return_value_policy::move);
        ...
        valuesHolder.def("__repr__", [](const cppbind::example::ValuesHolder& self) -> std::string {
            int status;
            const char* name = typeid(self).name();
            std::unique_ptr<char[], std::function<void(char*)>> demangledSymbol(
                __cxxabiv1::__cxa_demangle(name, nullptr, nullptr, &status), free);
            const char * classname = "cppbind::example::ValuesHolder";
            if (status == 0) {
                classname = demangledSymbol.get();
            }
            char res[96];
    ...
    }
    {
        ...
        anotherValueHolder.def("__repr__", [](const cppbind::example::AnotherValueHolder& self) -> std::string {
            int status;
            const char* name = typeid(self).name();
            std::unique_ptr<char[], std::function<void(char*)>> demangledSymbol(
                __cxxabiv1::__cxa_demangle(name, nullptr, nullptr, &status), free);
            const char * classname = "cppbind::example::AnotherValueHolder";
            if (status == 0) {
                classname = demangledSymbol.get();
            }
            char res[96];
