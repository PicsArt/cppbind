...
void bindIegenExampleSignShared(py::module& m) {
    ...
    signShared.def("type_name", &iegen::example::SignShared::typeName);
}
void bindIegenExampleTextShared(py::module& m) {
    ...
    textShared.def("type_name", &iegen::example::TextShared::typeName);
}
void bindIegenExampleDigitShared(py::module& m) {
    ...
    digitShared.def("type_name", &iegen::example::DigitShared::typeName);
}
void bindIegenExampleSymbolUsageShared(py::module& m) {
    ...
    symbolUsageShared.def("get_text_type", &iegen::example::SymbolUsageShared::getTextType, py::arg("t"));
    symbolUsageShared.def("get_sign_type", &iegen::example::SymbolUsageShared::getSignType, py::arg("s"));
    symbolUsageShared.def("get_text_id", &iegen::example::SymbolUsageShared::getTextId, py::arg("t"));
    symbolUsageShared.def("get_sign_id", &iegen::example::SymbolUsageShared::getSignId, py::arg("s"));
    symbolUsageShared.def("get_text_ptr", &iegen::example::SymbolUsageShared::getTextPtr);
    symbolUsageShared.def("get_sign_ptr", &iegen::example::SymbolUsageShared::getSignPtr);
}
