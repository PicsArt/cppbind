...
void bindExamplesLibTemplatesArrayPygen(py::module& m) {
    ...
    {
        using namespace cppbind::example;
        m.def("get_last_element_int2", &cppbind::example::getLastElement<int, 2>, py::arg("a"), py::return_value_policy::automatic);
    }
    {
        using namespace cppbind::example;
    ...
    {
        using namespace cppbind::example;
        py::class_<cppbind::example::Array<float, 4>, std::shared_ptr<cppbind::example::Array<float, 4>>> array4Float(m, "Array4Float");
        
        array4Float.def(py::init<const std::array<float, 4>>(), py::arg("array"));
        array4Float.def("__getitem__", &cppbind::example::Array<float, 4>::operator[], py::arg("idx"), py::return_value_policy::automatic);
        array4Float.def("__setitem__", [](cppbind::example::Array<float, 4>& self, int idx, float value){ self[idx] = value; });
        array4Float.def("__repr__", [](const cppbind::example::Array<float, 4>& self) -> std::string {
            int status;
            const char* name = typeid(self).name();
            std::unique_ptr<char[], std::function<void(char*)>> demangledSymbol(
                __cxxabiv1::__cxa_demangle(name, nullptr, nullptr, &status), free);
            const char * classname = "cppbind::example::Array<float, 4>";
            if (status == 0) {
                classname = demangledSymbol.get();
            }
            char res[96];
    ...
    {
        using namespace cppbind::example;
        py::class_<cppbind::example::Array<int, 4>, std::shared_ptr<cppbind::example::Array<int, 4>>> array4Int(m, "Array4Int");
        
        array4Int.def(py::init<const std::array<int, 4>>(), py::arg("array"));
        array4Int.def("__getitem__", &cppbind::example::Array<int, 4>::operator[], py::arg("idx"), py::return_value_policy::automatic);
        array4Int.def("__setitem__", [](cppbind::example::Array<int, 4>& self, int idx, int value){ self[idx] = value; });
        array4Int.def("__repr__", [](const cppbind::example::Array<int, 4>& self) -> std::string {
            int status;
            const char* name = typeid(self).name();
            std::unique_ptr<char[], std::function<void(char*)>> demangledSymbol(
                __cxxabiv1::__cxa_demangle(name, nullptr, nullptr, &status), free);
            const char * classname = "cppbind::example::Array<int, 4>";
            if (status == 0) {
                classname = demangledSymbol.get();
            }
            char res[96];
