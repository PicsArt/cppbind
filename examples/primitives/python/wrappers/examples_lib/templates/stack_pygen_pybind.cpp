...
void bindExamplesLibTemplatesStackPygen(py::module& m) {
    {
        ...
        stackPrj.def(py::init<cppbind::example::Stack<cppbind::example::Project> &>(), py::arg("stack"));
    ...
    }
    {
        ...
        stackPyTask.def(py::init<cppbind::example::Stack<cppbind::example::Task> &>(), py::arg("stack"));
    ...
    }
    {
        ...
        stackNumInt.def(py::init<cppbind::example::Stack<cppbind::example::Number<int>> &>(), py::arg("stack"));
