...
void bindExamplesLibTemplatesStackUsage(py::module& m) {
    {
        ...
        stackUsage.def("first_item_of_template_stack", &iegen::example::StackUsage::firstItemOfTemplateStack<iegen::example::Project>, py::arg("p"), py::return_value_policy::reference);
