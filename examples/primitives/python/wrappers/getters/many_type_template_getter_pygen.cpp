 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 07/22/2021-16:18.
...
void bindIegenExampleManyTypeTemplateGetter(py::module& m) {
    ...
    manytypetemplategetter.def(py::init<int>(), py::arg("v") = 0);
    ...
    manytypetemplategetter.def_readwrite("value", &iegen::example::ManyTypeTemplateGetter::value);
}