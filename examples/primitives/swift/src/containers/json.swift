...
public class JsonExamples {
  ...
  public convenience init() {
    ...
    self.init(create_IegenExample_JsonExamples(&err), true)
    if err.type != nil {
  ...
  public func setJson(j: String) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_JsonExamples_setJson(cself, swifttoscj, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func getJson() -> String {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_JsonExamples_getJson(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func getSimpleJsonExample() -> String {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_JsonExamples_getSimpleJsonExample(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
