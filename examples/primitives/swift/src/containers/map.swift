...
public class MapItem {
  ...
  public convenience init(value: Int) {
    ...
    self.init(create_IegenExample_MapItem(swifttoscvalue, &err), true)
    if err.type != nil {
...
public class MapExamples {
  ...
  public convenience init() {
    var err = IEGenCObject()
    self.init(create_IegenExample_MapExamples(&err), true)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func addStringPair(info: (String, String)) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_MapExamples_addStringPair(cself, swifttoscinfo, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func addIntMap(info: Dictionary<Int, Int>) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_MapExamples_addIntMap(cself, swifttoscinfo, &err)
  ...
  public func addStringMap(info: Dictionary<String, String>) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_MapExamples_addStringMap(cself, swifttoscinfo, &err)
  ...
  public func getStringMap() -> Dictionary<String, String> {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_MapExamples_getStringMap(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func getIntMap() -> Dictionary<Int, Int> {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_MapExamples_getIntMap(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func addMixedMap(info: Dictionary<String, MapItem>) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_MapExamples_addMixedMap(cself, swifttoscinfo, &err)
  ...
  public func getMixedMap() -> Dictionary<String, MapItem> {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_MapExamples_getMixedMap(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
