...
public class NestedExamples {
  ...
  public convenience init() {
    ...
    self.init(create_IegenExample_NestedExamples(&err), true)
    if err.type != nil {
  ...
  public func setNestedIntVector(v: Array<Array<Int>>) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_NestedExamples_setNestedIntVector(cself, swifttoscv, &err)
  ...
  public func getNestedIntVector() -> Array<Array<Int>> {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_NestedExamples_getNestedIntVector(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func setNestedIntMap(m: Dictionary<Int, Dictionary<Int, Int>>) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_NestedExamples_setNestedIntMap(cself, swifttoscm, &err)
  ...
  public func getNestedIntMap() -> Dictionary<Int, Dictionary<Int, Int>> {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_NestedExamples_getNestedIntMap(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func mixedExampleWithManyArgs(v1: Array<Array<Int>>, v2: Array<Array<Int>>, m1: Dictionary<Int, Dictionary<Int, Int>>, m2: Dictionary<Int, Dictionary<Int, Int>>) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_NestedExamples_mixedExampleWithManyArgs(cself, swifttoscv1, swifttoscv2, swifttoscm1, swifttoscm2, &err)
  ...
  public func setVectorOfIntMaps(v: Array<Dictionary<Int, Int>>) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_NestedExamples_setVectorOfIntMaps(cself, swifttoscv, &err)
  ...
  public func getVectorOfIntMaps() -> Array<Dictionary<Int, Int>> {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_NestedExamples_getVectorOfIntMaps(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func setMapOfIntVectors(m: Dictionary<Int, Array<Int>>) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_NestedExamples_setMapOfIntVectors(cself, swifttoscm, &err)
  ...
  public func getMapOfIntVectors() -> Dictionary<Int, Array<Int>> {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_NestedExamples_getMapOfIntVectors(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func setComplexStringVector(v: Array<Array<Array<String>>>) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_NestedExamples_setComplexStringVector(cself, swifttoscv, &err)
  ...
  public func getComplexStringVector() -> Array<Array<Array<String>>> {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_NestedExamples_getComplexStringVector(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func setComplexStringMap(m: Dictionary<String, Dictionary<String, Dictionary<String, String>>>) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_NestedExamples_setComplexStringMap(cself, swifttoscm, &err)
  ...
  public func getComplexStringMap() -> Dictionary<String, Dictionary<String, Dictionary<String, String>>> {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_NestedExamples_getComplexStringMap(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
