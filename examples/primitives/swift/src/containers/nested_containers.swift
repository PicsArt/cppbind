 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 09/08/2021-07:16.
...
//             }
    ...
    public func setComplexNestedIntVector(v: Array<Array<Array<Int>>>) -> Void {

        let _data_swift_to_sc_v = UnsafeMutablePointer<CDataArray>.allocate(capacity: v.count)
        defer {
          for _i in 0..<v.count {
            for _j in 0..<v[_i].count {
                _data_swift_to_sc_v[_i].data.assumingMemoryBound(to: CDataArray.self)[_j].data.deallocate()
            }
            _data_swift_to_sc_v[_i].data.deallocate()
          }
...
//             }
            ...
            for _i in 0..<value_v.count {
              let value_value_v = value_v[_i]
              let _data_swift_to_sc_value_value_v = UnsafeMutablePointer<CInt>.allocate(capacity: value_value_v.count)
//                 defer {
//                   _data_swift_to_sc_value_value_v.deallocate()
//                 }
                ...
                for _i in 0..<value_value_v.count {
                  ...
                  let swift_to_sc_value_value_value_v = CInt(value_value_value_v)
        ...
        var err = ErrorObj()
        _func_NestedExamples_setComplexNestedIntVector(cself, swift_to_sc_v, &err)
        let err_type = Int(err.err_type)
        if (err_type != 0) {
            switch(err_type) {
                case(1):
    ...
    public func getComplexNestedIntVector() -> Array<Array<Array<Int>>> {

        var err = ErrorObj()
        let result = _func_NestedExamples_getComplexNestedIntVector(cself, &err)
        let _tmp_result_data = UnsafeBufferPointer<CDataArray>(start: result.data.assumingMemoryBound(to: CDataArray.self), count: Int(result.size))
        var sc_to_swift_result: [Array<Array<Int>>] = [] 
        defer {
          _tmp_result_data.deallocate()
        }
        for _i in 0..<Int(result.size) {
          ...
          let _tmp_value_result_data = UnsafeBufferPointer<CDataArray>(start: value_result.data.assumingMemoryBound(to: CDataArray.self), count: Int(value_result.size))
            var sc_to_swift_value_result: [Array<Int>] = [] 
            defer {
              _tmp_value_result_data.deallocate()
            }
            for _i in 0..<Int(value_result.size) {
              let value_value_result = _tmp_value_result_data[_i]
              let _tmp_value_value_result_data = UnsafeBufferPointer<CInt>(start: value_value_result.data.assumingMemoryBound(to: CInt.self), count: Int(value_value_result.size))
                var sc_to_swift_value_value_result: [Int] = [] 
                defer {
                ...
                for _i in 0..<Int(value_value_result.size) {
                  ...
                  let sc_to_swift_value_value_value_result = Int(value_value_value_result)
