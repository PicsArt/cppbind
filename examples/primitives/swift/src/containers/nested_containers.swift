...
//                 }
    ...
    public func setComplexStringMap(m: Dictionary<String, Dictionary<String, Dictionary<String, String>>>) -> Void {
        ...
        defer {
          for _i in 0..<m.count {
            for _j in 0..<Int(_val_swift_to_sc_m[_i].size) {
                _val_swift_to_sc_m[_i].values.assumingMemoryBound(to: CDataMap.self)[_j].keys.deallocate()
                _val_swift_to_sc_m[_i].values.assumingMemoryBound(to: CDataMap.self)[_j].values.deallocate()
            }
...
//                 defer {
//                   _key_swift_to_sc_val_val_m.deallocate()
//                   _val_swift_to_sc_val_val_m.deallocate()
//                 }
