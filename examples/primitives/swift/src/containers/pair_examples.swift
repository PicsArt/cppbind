...
public class PairExamples {
  ...
  public convenience init() {
    ...
    self.init(create_IegenExample_PairExamples(&err), true)
    if err.type != nil {
  ...
  public func sumIntPairs(p1: (Int, Int), p2: (Int, Int)) -> (Int, Int) {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_PairExamples_sumIntPairs(cself, swifttoscp1, swifttoscp2, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func setNestedPair(p: ((String, String), (String, String))) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_PairExamples_setNestedPair(cself, swifttoscp, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func getNestedPair() -> ((String, String), (String, String)) {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_PairExamples_getNestedPair(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func getStringPair() -> (String, String) {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_PairExamples_getStringPair(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
