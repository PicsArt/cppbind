...
public class VectorItem {
  ...
  public convenience init(value: Int) {
    ...
    self.init(create_IegenExample_VectorItem(swifttoscvalue, &err), true)
    if err.type != nil {
...
public class VectorExamples {
  ...
  public convenience init() {
    var err = IEGenCObject()
    self.init(create_IegenExample_VectorExamples(&err), true)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func addIntVector(v: Array<Int>) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_VectorExamples_addIntVector(cself, swifttoscv, &err)
  ...
  public func addObjVector(v: Array<VectorItem>) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_VectorExamples_addObjVector(cself, swifttoscv, &err)
  ...
  public func addStringVector(v: Array<String>) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_VectorExamples_addStringVector(cself, swifttoscv, &err)
  ...
  public func getStringVector() -> Array<String> {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_VectorExamples_getStringVector(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func getObjVector() -> Array<VectorItem> {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_VectorExamples_getObjVector(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func getIntVector() -> Array<Int> {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_VectorExamples_getIntVector(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
