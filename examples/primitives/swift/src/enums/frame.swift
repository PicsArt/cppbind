 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 10/22/2021-14:00.
...
public class Frame  {
    ...
    public var backgroundColor: Color {
        get {
            ...
            if (sc_to_swift_result_optional == nil) {
                fatalError("Internal error: unresolved reference to non existing field of Color enum.")
            }
    ...
    public var backgroundColorShade: ColorShade {
        get {
            ...
            if (sc_to_swift_result_optional == nil) {
                fatalError("Internal error: unresolved reference to non existing field of ColorShade enum.")
            }
            let sc_to_swift_result = sc_to_swift_result_optional!
            return sc_to_swift_result
        }
