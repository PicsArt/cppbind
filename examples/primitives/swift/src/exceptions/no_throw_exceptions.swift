...
public class NoThrowExc {
  ...
  public convenience init(doThrow: Bool = false) {
    ...
    self.init(create_IegenExceptions_NoThrowExc(doThrow, &err), true)
    if err.type != nil {
  ...
  public var prop: String {
    get {
      var err = IEGenCObject()
      let result = _prop_get_IegenExceptions_NoThrowExc_prop(cself, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
    ...
    set(value) {
      ...
      var err = IEGenCObject()
      _prop_set_IegenExceptions_NoThrowExc_prop(cself, swifttoscvalue, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
  ...
  public static func noop() -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExceptions_NoThrowExc_noop(&err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
