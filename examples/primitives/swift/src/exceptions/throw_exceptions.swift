...
public class ThrowExc {
  ...
  public convenience init(doThrow: Bool = false) throws {
    var err = IEGenCObject()
    self.init(create_IegenExceptions_ThrowExc(doThrow, &err), true)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::invalid_argument"):
  ...
  public var prop1: String {
    get {
      var err = IEGenCObject()
      let result = _prop_get_IegenExceptions_ThrowExc_prop1(cself, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
    ...
    set(value) {
      ...
      var err = IEGenCObject()
      _prop_set_IegenExceptions_ThrowExc_prop1(cself, swifttoscvalue, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
  ...
  public static func getByKey(m: Dictionary<Int, Int>, key: Int) throws -> Int {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExceptions_ThrowExc_getByKey(swifttoscm, swifttosckey, &err)
  ...
  public static func throwsWithReturnValueString() throws -> String {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExceptions_ThrowExc_throwsWithReturnValueString(&err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::invalid_argument"):
  ...
  public static func throwsWithReturnValuePtr() throws -> Task {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExceptions_ThrowExc_throwsWithReturnValuePtr(&err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::invalid_argument"):
