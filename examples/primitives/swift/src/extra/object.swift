...
public class Object {
  ...
  internal init(_cself: IEGenCObject, _self: Object) {
  ...
  public func toString() -> String {
    ...
    let result = _func_Iegen_Object_toString(cself, &iegenErr)
  ...
  public func className() -> String {
    ...
    var iegenErr = IEGenCObject()
    let result = _func_Iegen_Object_className(cself, &iegenErr)
    if iegenErr.type != nil {
      let errorType = String(cString: iegenErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func equals(other: Object) -> Bool {
    ...
    var iegenErr = IEGenCObject()
    let result = _func_Iegen_Object_equals(cself, swifttoscother, &iegenErr)
    if iegenErr.type != nil {
      let errorType = String(cString: iegenErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func hash() -> CUnsignedLong {
    ...
    var iegenErr = IEGenCObject()
    let result = _func_Iegen_Object_hash(cself, &iegenErr)
    if iegenErr.type != nil {
      let errorType = String(cString: iegenErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func debugInfo() -> String {
    ...
    var iegenErr = IEGenCObject()
    let result = _func_Iegen_Object_debugInfo(cself, &iegenErr)
    if iegenErr.type != nil {
      let errorType = String(cString: iegenErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func bytesCount() -> CUnsignedLong {
    ...
    var iegenErr = IEGenCObject()
    let result = _func_Iegen_Object_bytesCount(cself, &iegenErr)
    if iegenErr.type != nil {
      let errorType = String(cString: iegenErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  class var iegenCxxTypeName : String { return "iegen::Object" }

  class func iegenConstructObject(_ iegenObj: IEGenCObject, _ owner: Bool = false) -> Object {
    let typeName = String(cString: iegenObj.type)
    switch(typeName) {
    case(ObjectUsage.iegenCxxTypeName):
