...
public class Student {
  ...
  public convenience init(stName: String) {
    ...
    self.init(create_IegenExample_Student(swifttoscstName, &err), true)
    if err.type != nil {
  ...
  public convenience init(teachers: Array<Teacher>) {
    ...
    var err = IEGenCObject()
    self.init(create_IegenExample_Student_1(swifttoscteachers, &err), true)
  ...
  public func addTeacher(t: Teacher) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_Student_addTeacher(cself, swifttosct, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func teachers() -> Array<Teacher> {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_Student_teachers(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
