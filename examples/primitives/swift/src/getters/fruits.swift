...
public class Fruit {
  ...
  public var type: FruitType {
    get {
      ...
      let result = _prop_get_Fruit_type(cself, &err)
...
public class Apple: Fruit {
  ...
  public override var type: FruitType {
    get {
      var err = IEGenCObject()
      let result = _prop_get_Apple_type(cself, &err)
...
public class Pineapple: Fruit {
  ...
  public override var type: FruitType {
    get {
      var err = IEGenCObject()
      let result = _prop_get_Pineapple_type(cself, &err)
...
public class Fruits {
  ...
  public var apples: Array<Apple> {
    get {
      var err = IEGenCObject()
      let result = _prop_get_Fruits_fruitsApple(cself, &err)
  ...
  public var pineapple: Array<Pineapple> {
    get {
      var err = IEGenCObject()
      let result = _prop_get_Fruits_fruitsPineapple(cself, &err)
  ...
  public var applesWithPineapples: Array<Fruit> {
    get {
      var err = IEGenCObject()
      let result = _prop_get_Fruits_allFruitsApplePineapple(cself, &err)
    ...
    set(value) {
      ...
      var err = IEGenCObject()
      _prop_set_Fruits_allFruitsApplePineapple(cself, swifttoscvalue, &err)
