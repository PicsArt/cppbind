...
public class Person {
  ...
  public convenience init(name: String, email: String, age: Int) {
    ...
    self.init(create_IegenExample_Person(swifttoscname, swifttoscemail, swifttoscage, &err), true)
    if err.type != nil {
  ...
  public var name: String {
    get {
      var err = IEGenCObject()
      let result = _prop_get_IegenExample_Person_name(cself, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
    ...
    set(value) {
      ...
      var err = IEGenCObject()
      _prop_set_IegenExample_Person_name(cself, swifttoscvalue, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
