...
public class MyDate: Base {
  ...
  internal init(_cself: IEGenCObject, _self: MyDate) {
  ...
  class var iegenCxxTypeName : String { return "iegen::example::Date" }

  class func iegenConstructObject(_ iegenObj: IEGenCObject, _ owner: Bool = false) -> MyDate {
