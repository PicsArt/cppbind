...
public class GoodVirtualDoctorImpl: GoodVirtualDoctor {
  ...
  class func iegenConstructObject(_ iegenObj: IEGenCObject, _ owner: Bool = false) -> GoodVirtualDoctor {
...
public class DoctorInfo {
  ...
  public func getGoodVirtualDoctor() -> GoodVirtualDoctor {
    ...
    sctoswiftresult = GoodVirtualDoctorImpl.iegenConstructObject(result)
    return sctoswiftresult
  }
