...
public class GeometricFigure {
  ...
  public var parallelogram: Parallelogram {
    get {
      ...
      sctoswiftresult = ParallelogramImpl.iegenConstructObject(result)
  ...
  class var iegenCxxTypeName : String { return "iegen::example::GeometricFigure" }
}
...
public class MyVehicle {
  ...
  public var vehicle: Vehicle? {
    get {
      ...
      if (result.ptr != nil) {
        sctoswiftresult = Vehicle.iegenConstructObject(result, true)
      }
      return sctoswiftresult
    }
  ...
  class var iegenCxxTypeName : String { return "iegen::example::MyVehicle" }
}
...
public class MyBicycle {
  ...
  class var iegenCxxTypeName : String { return "iegen::example::MyBicycle" }
}
...
public class MyCalendar {
  ...
  public var events: Array<MyDate> {
    ...
    for i in 0..<Int(result.size) {
      ...
      sctoswiftresultValue = MyDate.iegenConstructObject(resultValue, true)
  ...
  class var iegenCxxTypeName : String { return "iegen::example::MyCalendar" }
}
