...
public class GeometricFigure {
  ...
  public var parallelogram: Parallelogram {
    get {
      var err = IEGenCObject()
      let result = _prop_get_GeometricFigure_parallelogram(cself, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
    ...
    set(value) {
      ...
      var err = IEGenCObject()
      _prop_set_GeometricFigure_parallelogram(cself, swifttoscvalue, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
  ...
  public var nullableParallelogram: Parallelogram? {
    get {
      var err = IEGenCObject()
      let result = _prop_get_GeometricFigure_nullableParallelogram(cself, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
    ...
    set(value) {
      ...
      var err = IEGenCObject()
      _prop_set_GeometricFigure_nullableParallelogram(cself, swifttoscvalue, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
...
public class MyVehicle {
  ...
  public var vehicle: Vehicle? {
    get {
      var err = IEGenCObject()
      let result = _prop_get_MyVehicle_vehicle(cself, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
    ...
    set(value) {
      let swifttoscvalue = value?.cself ?? IEGenCObject(type: nil, ptr: nil)
      var err = IEGenCObject()
      _prop_set_MyVehicle_vehicle(cself, swifttoscvalue, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
...
public class MyBicycle {
  ...
  public var bicycle: Bicycle {
    get {
      var err = IEGenCObject()
      let result = _prop_get_MyBicycle_bicycle(cself, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
    ...
    set(value) {
      let swifttoscvalue = value.cself
      var err = IEGenCObject()
      _prop_set_MyBicycle_bicycle(cself, swifttoscvalue, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
...
public class MyCalendar {
  ...
  public var events: Array<MyDate> {
    var err = IEGenCObject()
    let result = _prop_get_MyCalendar_events(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
