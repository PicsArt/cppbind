...
public class MyVehicle {
  ...
  public convenience init(v: Vehicle, cv: Vehicle) {
    ...
    var err = IEGenCObject()
    self.init(create_IegenExample_MyVehicle(swifttoscv, swifttosccv, &err), true)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public var constVehicle: Vehicle? {
    get {
      var err = IEGenCObject()
      let result = _prop_get_IegenExample_MyVehicle_constVehicle(cself, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
    ...
    set(value) {
      let swifttoscvalue = value?.cself ?? IEGenCObject(type: nil, ptr: nil)
      var err = IEGenCObject()
      _prop_set_IegenExample_MyVehicle_constVehicle(cself, swifttoscvalue, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
