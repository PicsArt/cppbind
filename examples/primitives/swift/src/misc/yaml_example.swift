...
public class WithExternalAPIComments {
  ...
  public static func max(a: Int, b: Int) -> Int {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_WithExternalAPIComments_maxInt(swifttosca, swifttoscb, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func max(a: String, b: String) -> String {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_WithExternalAPIComments_maxString(swifttosca, swifttoscb, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
