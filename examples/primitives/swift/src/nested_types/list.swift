...
public class List {
  ...
  public convenience init() {
    ...
    self.init(create_IegenExample_List(&err), true)
    if err.type != nil {
  ...
  public var back: List.Item {
    var err = IEGenCObject()
    let result = _prop_get_IegenExample_List_back(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func push_back(item: List.Item) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_List_push_back(cself, swifttoscitem, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func pop_back() -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_List_pop_back(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
