...
public class List {
  ...
  public class Item {
    ...
    public class Value {
      ...
      class var iegenCxxTypeName : String { return "iegen::example::List::Item::Value" }
    }

    class var iegenCxxTypeName : String { return "iegen::example::List::Item" }
  }
  ...
  class var iegenCxxTypeName : String { return "iegen::example::List" }
}
