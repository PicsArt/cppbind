...
public class TemplateListInt {
  ...
  public convenience init() {
    ...
    self.init(create_IegenExample_TemplateListInt(&err), true)
    if err.type != nil {
  ...
  public class Item {
    ...
    public convenience init(v: Int) {
      ...
      var err = IEGenCObject()
      self.init(create_TemplateListInt_Item(swifttoscv, &err), true)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
...
public class TemplateListDouble {
  ...
  public convenience init() {
    var err = IEGenCObject()
    self.init(create_IegenExample_TemplateListDouble(&err), true)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public class Item {
    ...
    public convenience init(v: Double) {
      var err = IEGenCObject()
      self.init(create_TemplateListDouble_Item(v, &err), true)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
