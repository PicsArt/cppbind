...
public class TemplateListInt {
  ...
  public class Item {
    ...
    class var iegenCxxTypeName : String { return "iegen::example::TemplateList<int>::Item" }
  }

  class var iegenCxxTypeName : String { return "iegen::example::TemplateList<int>" }
}
...
public class TemplateListDouble {
  ...
  public class Item {
    ...
    class var iegenCxxTypeName : String { return "iegen::example::TemplateList<double>::Item" }
  }

  class var iegenCxxTypeName : String { return "iegen::example::TemplateList<double>" }
}
