...
public class NullableUtils {
  ...
  public var nullable: NumDouble? {
    get {
      var err = IEGenCObject()
      let result = _prop_get_NullableUtils_nullable(cself, &err)
    ...
    set(value) {
      ...
      var err = IEGenCObject()
      _prop_set_NullableUtils_nullable(cself, swifttoscvalue, &err)
  ...
  public var nonNull: NumDouble {
    get {
      var err = IEGenCObject()
      let result = _prop_get_NullableUtils_nonNull(cself, &err)
    ...
    set(value) {
      ...
      var err = IEGenCObject()
      _prop_set_NullableUtils_nonNull(cself, swifttoscvalue, &err)
