...
public class NullableUtils  {
    ...
    public convenience init(num: NumDouble?) {
        ...
        let swift_to_sc_num = CDataObj(index: 0, ptr: num?.cself.ptr)
    ...
    public static func max(first: NumDouble?, second: NumDouble) -> NumDouble? {
        ...
        let swift_to_sc_first = CDataObj(index: 0, ptr: first?.cself.ptr)
    ...
    public static func max(first: NumInt?, second: NumInt?) -> NumInt? {
        ...
        let swift_to_sc_first = CDataObj(index: 0, ptr: first?.cself.ptr)
        let swift_to_sc_second = CDataObj(index: 0, ptr: second?.cself.ptr)
        var err = ErrorObj()
