...
public class Counter {
  ...
  public convenience init(count: Int) {
    ...
    self.init(create_IegenExample_Counter(swifttosccount, &err), true)
    if err.type != nil {
  ...
  public var count: Int {
    var err = IEGenCObject()
    let result = _prop_get_IegenExample_Counter_count(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func +(cself: Counter, counter: Counter) -> Counter {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_Counter__add_(cself.cself, swifttosccounter, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func >(cself: Counter, counter: Counter) -> Bool {
    let swifttosccounter = counter.cself
    var err = IEGenCObject()
    let result = _func_IegenExample_Counter__gt_(cself.cself, swifttosccounter, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func +=(cself: Counter, counter: Counter) -> Counter {
    let swifttosccounter = counter.cself
    var err = IEGenCObject()
    let result = _func_IegenExample_Counter__iadd_(cself.cself, swifttosccounter, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
