 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 03/06/2022-18:55.
...
public class Optionals {
  ...
  public convenience init() {
    ...
    self.init(create_Optionals_1(&err), true)
    if err.type != nil {
  ...
  public convenience init(task: Task, i: Int = 1) {
    ...
    var err = IEGenCObject()
    self.init(create_Optionals_2(swifttosctask, swifttosci, &err), true)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public convenience init(task: Task, i: Int = 1, r: Root) {
    ...
    var err = IEGenCObject()
    self.init(create_Optionals(swifttosctask, swifttosci, swifttoscr, &err), true)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func singleComplexDefaultValue() -> Task {
    ...
    var err = IEGenCObject()
    let result = _func_Optionals_singleComplexDefaultValue_1(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func singleComplexDefaultValue(task: Task) -> Task {
    ...
    let swifttosctask = task.cself
    var err = IEGenCObject()
    let result = _func_Optionals_singleComplexDefaultValue(cself, swifttosctask, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func multipleMixedDefaultValues() -> String {
    ...
    var err = IEGenCObject()
    let result = _func_Optionals_multipleMixedDefaultValues_1(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func multipleMixedDefaultValues(task: Task, i: Int = 1) -> String {
    ...
    let swifttosci = CInt(i)
    var err = IEGenCObject()
    let result = _func_Optionals_multipleMixedDefaultValues_2(cself, swifttosctask, swifttosci, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func multipleMixedDefaultValues(task: Task, i: Int = 1, r: Root) -> String {
    ...
    let swifttoscr = r.cself
    var err = IEGenCObject()
    let result = _func_Optionals_multipleMixedDefaultValues(cself, swifttosctask, swifttosci, swifttoscr, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
