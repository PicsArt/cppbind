...
public class Optionals  {
    ...
    public func optionalPtrWithNullptrDefault(task: Task? = nil) -> Task? {
        ...
        let swift_to_sc_task = CDataObj(index: 0, ptr: task?.cself.ptr)
        var err = ErrorObj()
    ...
    public func optionalFDPtrWithNullptrDefault(project: Project? = nil) -> Project? {
        ...
        let swift_to_sc_project = CDataObj(index: 0, ptr: project?.cself.ptr)
        var err = ErrorObj()
    ...
    public func optionalSharedPtrWithNullptrDefault(person: Person? = nil) -> Person? {
        ...
        let swift_to_sc_person = CDataObj(index: 0, ptr: person?.cself.ptr)
        var err = ErrorObj()
