 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 04/28/2022-13:05.
...
public class Optionals {
  ...
  public func optionalCharWithDefault(symbol: Character = ",") -> Character {
    ...
    var iegenErr = IEGenCObject()
    let result = _func_IegenExample_Optionals_optionalCharWithDefault(cself, swifttoscsymbol, &iegenErr)
    if iegenErr.type != nil {
      let errorType = String(cString: iegenErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func optionalUnsignedCharWithDefault(num: CUnsignedChar = 100) -> CUnsignedChar {
    ...
    var iegenErr = IEGenCObject()
    let result = _func_IegenExample_Optionals_optionalUnsignedCharWithDefault(cself, num, &iegenErr)
    if iegenErr.type != nil {
      let errorType = String(cString: iegenErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  class var iegenCxxTypeName : String { return "iegen::example::Optionals" }
}
