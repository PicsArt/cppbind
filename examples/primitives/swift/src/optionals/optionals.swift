 ...
 * 
 * This file is generated by cppbind on 07/19/2022-12:44.
...
public class Optionals {
  ...
  public func optionalShortWithDefault(value: CShort = 10) -> CShort {

    var cppbindErr = CppBindCObject()
    let result = _func_CppbindExample_Optionals_optionalShortWithDefault(cself, value, &cppbindErr)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func optionalEnumWithDefaultAndChangedNames(level: LogLevel = LogLevel.WARNING) -> LogLevel {

    let swifttosclevel = level.rawValue
    var cppbindErr = CppBindCObject()
    let result = _func_CppbindExample_Optionals_optionalEnumWithDefaultAndChangedNames(cself, swifttosclevel, &cppbindErr)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
