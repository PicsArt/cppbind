 ...
 * 
 * This file is generated by cppbind on 07/06/2022-10:39.
...
public class Utils {
  ...
  public func sum(first: Array<Int>, second: Array<Int>) -> Array<Int> {
    ...
    var cppbindErr = CppBindCObject()
    let result = _func_CppbindExample_Utils_sum_2(cself, swifttoscfirst, swifttoscsecond, &cppbindErr)
  ...
  public func sum(first: Array<Float>, second: Array<Float>) -> Array<Float> {
    ...
    var cppbindErr = CppBindCObject()
    let result = _func_CppbindExample_Utils_sum_3(cself, swifttoscfirst, swifttoscsecond, &cppbindErr)
