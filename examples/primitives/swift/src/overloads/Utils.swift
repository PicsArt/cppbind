...
public class Utils {
  ...
  public convenience init() {
    ...
    self.init(create_IegenExample_Utils(&err), true)
    if err.type != nil {
  ...
  public static func sum(first: Int, second: Int) -> Int {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_Utils_sum(swifttoscfirst, swifttoscsecond, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func sum(first: Float, second: Float) -> Float {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_Utils_sum_1(first, second, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func concatenate(first: String, second: String) -> String {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_Utils_concatenate(cself, swifttoscfirst, swifttoscsecond, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func concatenate(first: String, second: String, third: String) -> String {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_Utils_concatenate_1(cself, swifttoscfirst, swifttoscsecond, swifttoscthird, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func minus(first: Int, second: Int) -> Int {
    ...
    let swifttoscsecond = CInt(second)
    var err = IEGenCObject()
    let result = _func_IegenExample_Utils_minus(swifttoscfirst, swifttoscsecond, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func minus(first: Float, second: Float) -> Float {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_Utils_minus_1(first, second, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
