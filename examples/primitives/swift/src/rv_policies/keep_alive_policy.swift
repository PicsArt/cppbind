...
public class Child1 {
  ...
  public convenience init(name: String) {
    ...
    self.init(create_IegenExample_Child1(swifttoscname, &err), true)
    if err.type != nil {
  ...
  public var name: String {
    var err = IEGenCObject()
    let result = _prop_get_IegenExample_Child1_name(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
...
extension Child3 {
  public var name: String {
    var err = IEGenCObject()
    let result = _prop_get_IegenExample_Child3_name(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
...
public class Child3Impl: Child3 {
  ...
  public convenience init(name: String) {
    let swifttoscname = strdup(name)!
    var err = IEGenCObject()
    self.init(create_IegenExample_Child3(swifttoscname, &err), true)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
...
public class Child2 {
  ...
  public convenience init(name: String) {
    let swifttoscname = strdup(name)!
    var err = IEGenCObject()
    self.init(create_IegenExample_Child2(swifttoscname, &err), true)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public var name: String {
    var err = IEGenCObject()
    let result = _prop_get_IegenExample_Child2_name(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
...
public class Parent1 {
  ...
  public convenience init(name: String, child1: Child1, child2: Child2, child3: Child3) {
    ...
    var err = IEGenCObject()
    self.init(create_IegenExample_Parent1(swifttoscname, swifttoscchild1, swifttoscchild2, swifttoscchild3, &err), true)
  ...
  public var name: String {
    var err = IEGenCObject()
    let result = _prop_get_IegenExample_Parent1_name(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public var child1: Child1 {
    get {
      var err = IEGenCObject()
      let result = _prop_get_IegenExample_Parent1_child1(cself, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
    ...
    set(value) {
      ...
      var err = IEGenCObject()
      _prop_set_IegenExample_Parent1_child1(cself, swifttoscvalue, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
  ...
  public var child2: Child2 {
    var err = IEGenCObject()
    let result = _prop_get_IegenExample_Parent1_child2(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
...
public class Parent2 {
  ...
  public convenience init(name: String) {
    let swifttoscname = strdup(name)!
    var err = IEGenCObject()
    self.init(create_IegenExample_Parent2(swifttoscname, &err), true)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public var name: String {
    var err = IEGenCObject()
    let result = _prop_get_IegenExample_Parent2_name(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public var children1: Array<Child1> {
    var err = IEGenCObject()
    let result = _prop_get_IegenExample_Parent2_children1(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public var children2: Array<Child2> {
    var err = IEGenCObject()
    let result = _prop_get_IegenExample_Parent2_children2(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func addChild1(c: Child1) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_Parent2_addChild1(cself, swifttoscc, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func addChildren1(c: Array<Child1>) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_Parent2_addChildren1(cself, swifttoscc, &err)
  ...
  public func addChild2(c: Child2) -> Void {
    ...
    let swifttoscc = c.cself
    var err = IEGenCObject()
    _func_IegenExample_Parent2_addChild2(cself, swifttoscc, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func addChildren2(c: Array<Child2>) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_Parent2_addChildren2(cself, swifttoscc, &err)
