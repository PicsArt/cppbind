 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 02/22/2022-08:24.
...
public class Child1 {
  ...
  public var name: String {
    get {
      let result = _prop_get_Child1_name(cself)
...
extension Child3 {
  public var name: String {
    get {
      let result = _prop_get_Child3_name(cself)
      let sctoswiftresult = String(cString: result)
      defer {
        result.deallocate()
      }
...
public class Child2 {
  ...
  public var name: String {
    get {
      let result = _prop_get_Child2_name(cself)
      let sctoswiftresult = String(cString: result)
      defer {
        result.deallocate()
      }
...
public class Parent1 {
  ...
  public var name: String {
    get {
      let result = _prop_get_Parent1_name(cself)
      let sctoswiftresult = String(cString: result)
      defer {
        result.deallocate()
      }
  ...
  public var child1: Child1 {
    get {
      let result = _prop_get_Parent1_child1(cself)
    ...
    set(value) {
      ...
      _prop_set_Parent1_child1(cself, swifttoscvalue)
    }
  }

  public var child2: Child2 {
    get {
      let result = _prop_get_Parent1_child2(cself)
...
public class Parent2 {
  ...
  public var name: String {
    get {
      let result = _prop_get_Parent2_name(cself)
      let sctoswiftresult = String(cString: result)
      defer {
        result.deallocate()
      }
  ...
  public var children1: Array<Child1> {
    get {
      let result = _prop_get_Parent2_children1(cself)
  ...
  public var children2: Array<Child2> {
    get {
      let result = _prop_get_Parent2_children2(cself)
      let _resultBuffer = UnsafeBufferPointer<IEGenCObject>(
        start: result.data.assumingMemoryBound(to: IEGenCObject.self),
        count: Int(result.size))
      var sctoswiftresult: [Child2] = []
