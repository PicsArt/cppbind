 ...
 * 
 * This file is generated by cppbind on 09/06/2022-09:43.
...
public class SwMovableValue {
  ...
  deinit {
    release_CppbindExample_SwMovableValue(cself, owner)
  }
  ...
  public convenience init(name: String) {
    let swifttoscname = strdup(name)!
    var cppbindErr = CppBindCObject()
    self.init(create_CppbindExample_SwMovableValue(swifttoscname, &cppbindErr), true)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public var name: String {
    get {
      var cppbindErr = CppBindCObject()
      let result = _prop_get_CppbindExample_SwMovableValue_name(cself, &cppbindErr)
      if cppbindErr.type != nil {
        let errorType = String(cString: cppbindErr.type!)
        switch errorType {
        case ("std::exception"):
    ...
    set(value) {
      let swifttoscvalue = strdup(value)!
      var cppbindErr = CppBindCObject()
      _prop_set_CppbindExample_SwMovableValue_name(cself, swifttoscvalue, &cppbindErr)
      if cppbindErr.type != nil {
        let errorType = String(cString: cppbindErr.type!)
        switch errorType {
        case ("std::exception"):
  ...
  /// An internal property to keep an information about the underlying C++ object type.
  /// It is intended to be used by the generated code.
  class var cppbindCxxTypeName : String { return "cppbind::example::MovableValue" }
}
...
public class ValuesHolder {
  ...
  public func getMovableValue() -> SwMovableValue {

    var cppbindErr = CppBindCObject()
    let result = _func_CppbindExample_ValuesHolder_getMovableValue(cself, &cppbindErr)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
    ...
    var sctoswiftresult: SwMovableValue
    sctoswiftresult = SwMovableValue(result, true)
    return sctoswiftresult
  }
