...
public class Project {
  ...
  public convenience init(title: String) {
    ...
    self.init(create_IegenExample_Project(swifttosctitle, &err), true)
    if err.type != nil {
  ...
  public var title: String {
    var err = IEGenCObject()
    let result = _prop_get_IegenExample_Project_title(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func addTask(task: Task) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_Project_addTask(cself, swifttosctask, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func tasks() -> Array<Task> {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_Project_tasks(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func equals(p: Project) -> Bool {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_Project_equals(cself, swifttoscp, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
