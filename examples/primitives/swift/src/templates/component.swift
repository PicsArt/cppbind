...
public class Component: AddressableRoot {
  ...
  deinit {
    release_CppbindExample_Component(cself, owner)
  }
  ...
  public convenience init(parent: Root, name: String) {
    ...
    self.init(create_CppbindExample_Component(swifttoscparent, swifttoscname, &cppbindErr), true)
  ...
  /// It is intended to be used by the generated code.
  class var cppbindCxxTypeName : String { return "cppbind::example::Component" }
}
