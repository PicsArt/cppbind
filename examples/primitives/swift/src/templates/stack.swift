...
public class StackNumberInt  {
    ...
    public convenience init() {
        ...
        self.init(create_StackNumberInt(), true)
    }

    public convenience init(st: NumberInt) {

        let swift_to_sc_st = st.cself
        self.init(create_StackNumberInt_1(swift_to_sc_st), true)
    }
    ...
    public func push(item: NumberInt) -> Void {
        ...
        let swift_to_sc_item = item.cself
        var err = ErrorObj()
        _func_StackNumberInt_push(cself, swift_to_sc_item, &err);
        let err_type = Int(err.err_type)
        if (err_type != 0) {
            switch(err_type) {
                case(1):
    ...
    public func pop() -> Void {
        ...
        var err = ErrorObj()
        _func_StackNumberInt_pop(cself, &err);
        let err_type = Int(err.err_type)
        if (err_type != 0) {
            switch(err_type) {
                case(1):
    ...
    public func top() -> NumberInt {
        ...
        var err = ErrorObj()
        let result = _func_StackNumberInt_top(cself, &err);
    ...
    public func empty() -> Bool {
        ...
        var err = ErrorObj()
        let result = _func_StackNumberInt_empty(cself, &err);
