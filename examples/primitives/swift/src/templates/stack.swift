...
public class StackPrj: Container {
  ...
  public convenience init(stack: StackPrj) {
    ...
    var cppbindErr = CppBindCObject()
    self.init(create_CppbindExample_StackPrj_1(swifttoscstack, &cppbindErr), true)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public convenience init(st: Project) {
    ...
    var cppbindErr = CppBindCObject()
    self.init(create_CppbindExample_StackPrj_2(swifttoscst, &cppbindErr), true)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
...
public class StackTask: Container {
  ...
  public convenience init(stack: StackTask) {
    let swifttoscstack = stack.cself
    var cppbindErr = CppBindCObject()
    self.init(create_CppbindExample_StackTask_1(swifttoscstack, &cppbindErr), true)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public convenience init(st: Task) {
    let swifttoscst = st.cself
    var cppbindErr = CppBindCObject()
    self.init(create_CppbindExample_StackTask_2(swifttoscst, &cppbindErr), true)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
...
public class StackNumInt: Container {
  ...
  public convenience init(stack: StackNumInt) {
    let swifttoscstack = stack.cself
    var cppbindErr = CppBindCObject()
    self.init(create_CppbindExample_StackNumInt_1(swifttoscstack, &cppbindErr), true)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public convenience init(st: NumberInt) {
    let swifttoscst = st.cself
    var cppbindErr = CppBindCObject()
    self.init(create_CppbindExample_StackNumInt_2(swifttoscst, &cppbindErr), true)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
