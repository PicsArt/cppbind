...
public class TemplateMethods {
  ...
  public convenience init() {
    ...
    self.init(create_IegenExample_TemplateMethods(&err), true)
    if err.type != nil {
  ...
  public func max(arg0: Int, arg1: Int) -> Int {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_TemplateMethods_maxInt(cself, swifttoscarg0, swifttoscarg1, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func max(arg0: String, arg1: String) -> String {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_TemplateMethods_maxString(cself, swifttoscarg0, swifttoscarg1, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func makePair(arg0: Project, arg1: Project) -> (Project, Project) {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_TemplateMethods_makePairProjectProject(cself, swifttoscarg0, swifttoscarg1, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func makePair(arg0: Root, arg1: Project) -> (Root, Project) {
    ...
    let swifttoscarg1 = arg1.cself
    var err = IEGenCObject()
    let result = _func_IegenExample_TemplateMethods_makePairRootProject(cself, swifttoscarg0, swifttoscarg1, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
