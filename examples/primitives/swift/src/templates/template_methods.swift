...
public class TemplateMethods {
  ...
  public func max(a: Int, b: Int) -> Int {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_TemplateMethods_maxInt(cself, swifttosca, swifttoscb, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func max(a: String, b: String) -> String {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_TemplateMethods_maxString(cself, swifttosca, swifttoscb, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func makePair(a: Project, b: Project) -> (Project, Project) {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_TemplateMethods_makePairProjectProject(cself, swifttosca, swifttoscb, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func makePair(a: Root, b: Project) -> (Root, Project) {
    ...
    let swifttoscb = b.cself
    var err = IEGenCObject()
    let result = _func_IegenExample_TemplateMethods_makePairRootProject(cself, swifttosca, swifttoscb, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
