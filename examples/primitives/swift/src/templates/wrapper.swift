...
public class WrapperPairStrings {
  ...
  public convenience init(value: (String, String)) {
    ...
    self.init(create_IegenExample_WrapperPairStrings(swifttoscvalue, &err), true)
    if err.type != nil {
  ...
  public var value: (String, String) {
    get {
      var err = IEGenCObject()
      let result = _prop_get_IegenExample_WrapperPairStrings_value(cself, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
    ...
    set(value) {
      ...
      _swifttoscvalueSecond[0] = swifttoscvalueSecond
      var err = IEGenCObject()
      _prop_set_IegenExample_WrapperPairStrings_value(cself, swifttoscvalue, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
...
public class WrapperPairIntInt {
  ...
  public convenience init(value: (Int, Int)) {
    ...
    _swifttoscvalueSecond[0] = swifttoscvalueSecond
    var err = IEGenCObject()
    self.init(create_IegenExample_WrapperPairIntInt(swifttoscvalue, &err), true)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public var value: (Int, Int) {
    get {
      var err = IEGenCObject()
      let result = _prop_get_IegenExample_WrapperPairIntInt_value(cself, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
    ...
    set(value) {
      ...
      _swifttoscvalueSecond[0] = swifttoscvalueSecond
      var err = IEGenCObject()
      _prop_set_IegenExample_WrapperPairIntInt_value(cself, swifttoscvalue, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
...
public class WrapperString {
  ...
  public convenience init(value: String) {
    ...
    var err = IEGenCObject()
    self.init(create_IegenExample_WrapperString(swifttoscvalue, &err), true)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public var value: String {
    get {
      var err = IEGenCObject()
      let result = _prop_get_IegenExample_WrapperString_value(cself, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
    ...
    set(value) {
      let swifttoscvalue = strdup(value)!
      var err = IEGenCObject()
      _prop_set_IegenExample_WrapperString_value(cself, swifttoscvalue, &err)
      if err.type != nil {
        let errorType = String(cString: err.type!)
        switch errorType {
        case ("std::exception"):
