...
public class QueueInt {
  ...
  public convenience init() {
    ...
    self.init(create_IegenExample_QueueInt(&err), true)
    if err.type != nil {
  ...
  public func push_back(element: Int) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_QueueInt_push_back(cself, swifttoscelement, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func get_size() -> Int {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_QueueInt_get_size(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
...
public class QueueIntUsage {
  ...
  public convenience init(q: QueueInt) {
    ...
    var err = IEGenCObject()
    self.init(create_IegenExample_QueueIntUsage(swifttoscq, &err), true)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func getSize(q: QueueInt) -> Int {
    ...
    let swifttoscq = q.cself
    var err = IEGenCObject()
    let result = _func_IegenExample_QueueIntUsage_getSize(swifttoscq, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func getLastElement(q: QueueInt) -> Int {
    ...
    let swifttoscq = q.cself
    var err = IEGenCObject()
    let result = _func_IegenExample_QueueIntUsage_getLastElement(swifttoscq, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func getFirstElement(q: QueueInt) -> Int {
    ...
    let swifttoscq = q.cself
    var err = IEGenCObject()
    let result = _func_IegenExample_QueueIntUsage_getFirstElement(swifttoscq, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func getInvQueue(v: Array<Int>) -> QueueInt {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_QueueIntUsage_getInvQueue(swifttoscv, &err)
  ...
  public func getSavedQueue() -> QueueInt {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_QueueIntUsage_getSavedQueue(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
