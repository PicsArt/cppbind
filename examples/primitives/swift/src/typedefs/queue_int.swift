...
public class QueueInt {
  ...
  public func push_back_from_str(element: String) -> Void {
    ...
    var iegenErr = IEGenCObject()
    _func_IegenExample_QueueInt_push_back_from_str(cself, swifttoscelement, &iegenErr)
    if iegenErr.type != nil {
      let errorType = String(cString: iegenErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  class var iegenCxxTypeName : String { return "iegen::example::QueueInt" }
}
...
public class QueueIntUsage {
  ...
  class var iegenCxxTypeName : String { return "iegen::example::QueueIntUsage" }
}
