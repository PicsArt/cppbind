...
public class QueueIntShared {
  ...
  deinit {
    release_CppbindExample_QueueIntShared(cself, owner)
  }
  ...
  public convenience init() {
    ...
    self.init(create_CppbindExample_QueueIntShared(&cppbindErr), true)
  ...
  public func push_back(element: Int) -> Void {
    ...
    var cppbindErr = CppBindCObject()
    _func_CppbindExample_QueueIntShared_push_back(cself, swifttoscelement, &cppbindErr)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func get_size() -> Int {
    ...
    var cppbindErr = CppBindCObject()
    let result = _func_CppbindExample_QueueIntShared_get_size(cself, &cppbindErr)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  /// It is intended to be used by the generated code.
  class var cppbindCxxTypeName : String { return "cppbind::example::QueueIntShared" }
}
...
public class QueueIntSharedUsage {
  ...
  deinit {
    release_CppbindExample_QueueIntSharedUsage(cself, owner)
  }
  ...
  public convenience init(q: QueueIntShared) {
    ...
    var cppbindErr = CppBindCObject()
    self.init(create_CppbindExample_QueueIntSharedUsage(swifttoscq, &cppbindErr), true)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public var saved_queue: QueueIntShared {
    let result = _prop_get_CppbindExample_QueueIntSharedUsage_saved_queue(cself)
  ...
  public static func getSize(q: QueueIntShared) -> Int {
    ...
    let swifttoscq = q.cself
    var cppbindErr = CppBindCObject()
    let result = _func_CppbindExample_QueueIntSharedUsage_getSize(swifttoscq, &cppbindErr)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func getLastElement(q: QueueIntShared) -> Int {
    ...
    let swifttoscq = q.cself
    var cppbindErr = CppBindCObject()
    let result = _func_CppbindExample_QueueIntSharedUsage_getLastElement(swifttoscq, &cppbindErr)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func getFirstElement(q: QueueIntShared) -> Int {
    ...
    let swifttoscq = q.cself
    var cppbindErr = CppBindCObject()
    let result = _func_CppbindExample_QueueIntSharedUsage_getFirstElement(swifttoscq, &cppbindErr)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func getInvQueue(v: Array<Int>) -> QueueIntShared {
    ...
    var cppbindErr = CppBindCObject()
    let result = _func_CppbindExample_QueueIntSharedUsage_getInvQueue(swifttoscv, &cppbindErr)
  ...
  public func getSavedQueue() -> QueueIntShared {
    ...
    var cppbindErr = CppBindCObject()
    let result = _func_CppbindExample_QueueIntSharedUsage_getSavedQueue(cself, &cppbindErr)
    if cppbindErr.type != nil {
      let errorType = String(cString: cppbindErr.type!)
      switch errorType {
      case ("std::exception"):
  ...
  /// An internal property to keep an information about the underlying C++ object type.
  /// It is intended to be used by the generated code.
  class var cppbindCxxTypeName : String { return "cppbind::example::QueueIntSharedUsage" }
}
