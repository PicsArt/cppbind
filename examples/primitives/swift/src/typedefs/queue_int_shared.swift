...
public class QueueIntShared {
  ...
  public convenience init() {
    ...
    self.init(create_IegenExample_QueueIntShared(&err), true)
    if err.type != nil {
  ...
  public func push_back(element: Int) -> Void {
    ...
    var err = IEGenCObject()
    _func_IegenExample_QueueIntShared_push_back(cself, swifttoscelement, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public func get_size() -> Int {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_QueueIntShared_get_size(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
...
public class QueueIntSharedUsage {
  ...
  public convenience init(q: QueueIntShared) {
    ...
    var err = IEGenCObject()
    self.init(create_IegenExample_QueueIntSharedUsage(swifttoscq, &err), true)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func getSize(q: QueueIntShared) -> Int {
    ...
    let swifttoscq = q.cself
    var err = IEGenCObject()
    let result = _func_IegenExample_QueueIntSharedUsage_getSize(swifttoscq, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func getLastElement(q: QueueIntShared) -> Int {
    ...
    let swifttoscq = q.cself
    var err = IEGenCObject()
    let result = _func_IegenExample_QueueIntSharedUsage_getLastElement(swifttoscq, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func getFirstElement(q: QueueIntShared) -> Int {
    ...
    let swifttoscq = q.cself
    var err = IEGenCObject()
    let result = _func_IegenExample_QueueIntSharedUsage_getFirstElement(swifttoscq, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
  ...
  public static func getInvQueue(v: Array<Int>) -> QueueIntShared {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_QueueIntSharedUsage_getInvQueue(swifttoscv, &err)
  ...
  public func getSavedQueue() -> QueueIntShared {
    ...
    var err = IEGenCObject()
    let result = _func_IegenExample_QueueIntSharedUsage_getSavedQueue(cself, &err)
    if err.type != nil {
      let errorType = String(cString: err.type!)
      switch errorType {
      case ("std::exception"):
