...
int _prop_get_MapItem_value(void* _Nonnull cself){
    auto c_to_cxx_cself = static_cast<iegen::example::MapItem*>(cself);
...
void _func_MapExamples_addStringPair(void* _Nonnull cself, CDataPair info, ErrorObj* _Nonnull err){
    ...
    auto c_to_cxx_cself = static_cast<iegen::example::MapExamples*>(cself);
    try {
...
void _func_MapExamples_addMixedMap(void* _Nonnull cself, CDataMap info, ErrorObj* _Nonnull err){
    ...
    for (size_t _i_info = 0; _i_info < info.size; ++_i_info) {
        ...
        auto& c_to_cxx_vtmp_info = *static_cast<iegen::example::MapItem*>(vtmp_info);
        c_to_cxx_info.insert({ c_to_cxx_ktmp_info, c_to_cxx_vtmp_info });
    }
    ...
    try {
        ...
        for (auto& value_result : result) {
            ...
            const auto& val_result = value_result.second;
            {
                ...
                auto cxx_to_c_val_result = const_cast<iegen::example::MapItem*>( new iegen::example::MapItem(val_result) );
                _k_data_cxx_to_c_result[_i_result] = cxx_to_c_key_result;
                _v_data_cxx_to_c_result[_i_result] = cxx_to_c_val_result;
                _i_result += 1;
            }
