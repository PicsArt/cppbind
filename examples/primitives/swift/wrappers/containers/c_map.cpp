 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 07/22/2021-12:30.
...
CDataMap _func_MapExamples_getStringMap(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    for (auto& value_result : result) {
        ...
        const auto& val_result = value_result.second;
        {
          ...
          auto cxx_to_c_val_result = strdup(val_result.c_str()); 
...
CDataMap _func_MapExamples_getMixedMap(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    for (auto& value_result : result) {
        ...
        auto cxx_to_c_val_result = static_cast<iegen::example::MapItem*>(value_ptr_val_result);
          _k_data_cxx_to_c_result[_i_result] = cxx_to_c_key_result;
          _v_data_cxx_to_c_result[_i_result] = cxx_to_c_val_result;
          _i_result += 1;
        }
