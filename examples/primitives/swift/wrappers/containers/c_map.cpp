...
const char* IEGEN_IEGEN_EXAMPLE_MAPITEM = "iegen::example::MapItem";
const char* IEGEN_IEGEN_EXAMPLE_MAPEXAMPLES = "iegen::example::MapExamples";
...
IEGenCObject create_IegenExample_MapItem(int _value, IEGenCObject* _Nonnull iegen_err) {
    try {
        auto this_object = new iegen::example::MapItem(_value);
        return {strdup(IEGEN_IEGEN_EXAMPLE_MAPITEM), this_object};
...
IEGenCObject create_IegenExample_MapExamples(IEGenCObject* _Nonnull iegen_err) {
    try {
        auto this_object = new iegen::example::MapExamples();
        return {strdup(IEGEN_IEGEN_EXAMPLE_MAPEXAMPLES), this_object};
    } catch (const std::exception& e) {
        iegen_err->type = strdup(IEGEN_STD_STDEXCEPTION);
        iegen_err->ptr = new std::exception(e);
    } catch (...) {
...
void _func_IegenExample_MapExamples_addStringPair(IEGenCObject cself, IEGenCDataPair info, IEGenCObject* _Nonnull iegen_err) {
...
void _func_IegenExample_MapExamples_addIntMap(IEGenCObject cself, IEGenCDataMap info, IEGenCObject* _Nonnull iegen_err) {
...
void _func_IegenExample_MapExamples_addStringMap(IEGenCObject cself, IEGenCDataMap info, IEGenCObject* _Nonnull iegen_err) {
...
IEGenCDataMap _func_IegenExample_MapExamples_getStringMap(IEGenCObject cself, IEGenCObject* _Nonnull iegen_err) {
    auto ctocxxcself = static_cast<iegen::example::MapExamples*>(cself.ptr);
    try {
...
IEGenCDataMap _func_IegenExample_MapExamples_getIntMap(IEGenCObject cself, IEGenCObject* _Nonnull iegen_err) {
    auto ctocxxcself = static_cast<iegen::example::MapExamples*>(cself.ptr);
    try {
...
void _func_IegenExample_MapExamples_addMixedMap(IEGenCObject cself, IEGenCDataMap info, IEGenCObject* _Nonnull iegen_err) {
...
IEGenCDataMap _func_IegenExample_MapExamples_getMixedMap(IEGenCObject cself, IEGenCObject* _Nonnull iegen_err) {
    auto ctocxxcself = static_cast<iegen::example::MapExamples*>(cself.ptr);
    try {
        ...
        for (auto& value_result : result) {
            ...
            const auto& val_result = value_result.second;
            {
                ...
                char* type_val_result = strdup(IEGEN_IEGEN_EXAMPLE_MAPITEM);
