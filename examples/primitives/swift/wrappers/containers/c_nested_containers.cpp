...
void _func_NestedExamples_setNestedIntVector(void* _Nonnull cself, CDataArray v, ErrorObj* _Nonnull err){
    ...
    auto ctocxxcself = static_cast<iegen::example::NestedExamples*>(cself);
    try {
...
CDataArray _func_NestedExamples_getNestedIntVector(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    try {
        ...
        auto _data_cxxtocresult = new CDataArray [result.size()];
        ...
        for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
            ...
            CDataArray cxxtocvalue_result = { _data_cxxtocvalue_result, (long long)value_result.size() };
...
CDataMap _func_NestedExamples_getNestedIntMap(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    try {
        ...
        auto _v_data_cxxtocresult = new CDataMap [result.size()];
        ...
        for (auto& value_result : result) {
            ...
            const auto& val_result = value_result.second;
            {
                ...
                CDataMap cxxtocval_result = { _k_data_cxxtocval_result, _v_data_cxxtocval_result, (long long)val_result.size() };
...
CDataArray _func_NestedExamples_getVectorOfIntMaps(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    try {
        ...
        auto _data_cxxtocresult = new CDataMap [result.size()];
        CDataArray cxxtocresult = { _data_cxxtocresult, (long long)result.size() };
        for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
            auto& value_result = result[_i_result];
            auto _k_data_cxxtocvalue_result = new int [value_result.size()];
            auto _v_data_cxxtocvalue_result = new int [value_result.size()];
            CDataMap cxxtocvalue_result = { _k_data_cxxtocvalue_result, _v_data_cxxtocvalue_result, (long long)value_result.size() };
...
CDataMap _func_NestedExamples_getMapOfIntVectors(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    try {
        ...
        auto _k_data_cxxtocresult = new int [result.size()];
        auto _v_data_cxxtocresult = new CDataArray [result.size()];
        CDataMap cxxtocresult = { _k_data_cxxtocresult, _v_data_cxxtocresult, (long long)result.size() };
        size_t _i_result = 0;
        for (auto& value_result : result) {
            const auto& key_result = value_result.first;
            const auto& val_result = value_result.second;
            {
                ...
                CDataArray cxxtocval_result = { _data_cxxtocval_result, (long long)val_result.size() };
...
CDataArray _func_NestedExamples_getComplexStringVector(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    try {
        ...
        for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
            auto& value_result = result[_i_result];
            auto _data_cxxtocvalue_result = new CDataArray [value_result.size()];
            CDataArray cxxtocvalue_result = { _data_cxxtocvalue_result, (long long)value_result.size() };
            for (int _i_value_result = 0; _i_value_result < value_result.size(); ++_i_value_result) {
                auto& value_value_result = value_result[_i_value_result];
                auto _data_cxxtocvalue_value_result = new char* [value_value_result.size()];
                CDataArray cxxtocvalue_value_result = { _data_cxxtocvalue_value_result, (long long)value_value_result.size() };
    ...
    try {
        ...
        for (auto& value_result : result) {
            ...
            const auto& val_result = value_result.second;
            {
                ...
                auto _v_data_cxxtocval_result = new CDataMap [val_result.size()];
                CDataMap cxxtocval_result = { _k_data_cxxtocval_result, _v_data_cxxtocval_result, (long long)val_result.size() };
                size_t _i_val_result = 0;
                for (auto& value_val_result : val_result) {
                    const auto& key_val_result = value_val_result.first;
                    const auto& val_val_result = value_val_result.second;
                    {
                        ...
                        CDataMap cxxtocval_val_result = { _k_data_cxxtocval_val_result, _v_data_cxxtocval_val_result, (long long)val_val_result.size() };
