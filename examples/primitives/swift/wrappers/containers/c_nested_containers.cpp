...
void _func_NestedExamples_setNestedIntVector(CObject cself, CDataArray v, ErrorObj* _Nonnull err){
    ...
    iegen::example::NestedExamples* ctocxxcself_ptr = nullptr;
    if (cself.ptr) {
        if (strcmp(cself.type, "iegen::example::NestedExamples") == 0)
            ctocxxcself_ptr = static_cast<iegen::example::NestedExamples*>(cself.ptr);
        else {
