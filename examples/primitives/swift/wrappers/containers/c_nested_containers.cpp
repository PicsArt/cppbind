        ...
        for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
            ...
            for (int _i_value_result = 0; _i_value_result < value_result.size(); ++_i_value_result) {
                ...
                for (int _i_value_value_result = 0; _i_value_value_result < value_value_result.size(); ++_i_value_value_result) {
                    ...
                    auto cxx_to_c_value_value_value_result = strdup(value_value_value_result.c_str());
...
CDataMap _func_NestedExamples_getComplexStringMap(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    try {
        ...
        for (auto& value_result : result) {
            ...
            const auto& val_result = value_result.second;
            {
                auto cxx_to_c_key_result = strdup(key_result.c_str());
            ...
            for (auto& value_val_result : val_result) {
                ...
                const auto& val_val_result = value_val_result.second;
                {
                    auto cxx_to_c_key_val_result = strdup(key_val_result.c_str());
                ...
                for (auto& value_val_val_result : val_val_result) {
                    ...
                    {
                        auto cxx_to_c_key_val_val_result = strdup(key_val_val_result.c_str());
                        auto cxx_to_c_val_val_val_result = strdup(val_val_val_result.c_str());
