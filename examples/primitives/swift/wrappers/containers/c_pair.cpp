...
void _func_PairExamples_setNestedPair(void* _Nonnull cself , CDataPair p, ErrorObj* _Nonnull err){
    ...
    auto first_tmp_first_tmp_p = *reinterpret_cast<char* _Nonnull*>(first_tmp_p.first);
        auto second_tmp_first_tmp_p = *reinterpret_cast<char* _Nonnull*>(first_tmp_p.second);
    ...
    auto first_tmp_second_tmp_p = *reinterpret_cast<char* _Nonnull*>(second_tmp_p.first);
        auto second_tmp_second_tmp_p = *reinterpret_cast<char* _Nonnull*>(second_tmp_p.second);
...
CDataPair _func_PairExamples_getNestedPair(void* _Nonnull cself , ErrorObj* _Nonnull err){
    ...
    const auto& first_result = result.first;
    const auto& second_result = result.second;
    auto _first_data_cxx_to_c_first_result = new char* _Nonnull;
        auto _second_data_cxx_to_c_first_result = new char* _Nonnull;
    ...
    auto _first_data_cxx_to_c_second_result = new char* _Nonnull;
        auto _second_data_cxx_to_c_second_result = new char* _Nonnull;
