...
CDataPair _func_PairExamples_sumIntPairs(CObject cself, CDataPair p1, CDataPair p2, ErrorObj* _Nonnull err){
    ...
    iegen::example::PairExamples* ctocxxcself_ptr = nullptr;
    if (cself.ptr) {
        if (strcmp(cself.type, "iegen::example::PairExamples") == 0)
            ctocxxcself_ptr = static_cast<iegen::example::PairExamples*>(cself.ptr);
        else {
