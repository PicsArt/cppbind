...
#include <memory>
#include <type_traits>
#include "swift/wrappers/containers/c_swift_nested_containers.h"
...
void release_CppbindExample_NestedExamples(CppBindCObject cself, bool owner) {
    if (owner) {
        delete static_cast<cppbind::example::NestedExamples*>(cself.ptr);
    }
    free(cself.type);
}
...
CppBindCObject create_CppbindExample_NestedExamples(CppBindCObject* _Nonnull cppbind_err) {
    try {
        auto this_object = new cppbind::example::NestedExamples();
        return {strdup(CPPBIND_CPPBIND_EXAMPLE_NESTEDEXAMPLES), this_object};
...
void _func_CppbindExample_NestedExamples_setNestedIntVector(CppBindCObject cself, CppBindCDataArray v, CppBindCObject* _Nonnull cppbind_err) {
    ...
    auto ctocxxcself = static_cast<cppbind::example::NestedExamples*>(cself.ptr);
    try {
...
CppBindCDataArray _func_CppbindExample_NestedExamples_getNestedIntVector(CppBindCObject cself, CppBindCObject* _Nonnull cppbind_err) {
    auto ctocxxcself = static_cast<cppbind::example::NestedExamples*>(cself.ptr);
    try {
        decltype(auto) result = ctocxxcself->getNestedIntVector();
...
void _func_CppbindExample_NestedExamples_setNestedIntMap(CppBindCObject cself, CppBindCDataMap m, CppBindCObject* _Nonnull cppbind_err) {
    ...
    for (size_t _i_m = 0; _i_m < m.size; ++_i_m) {
        ...
        auto vtmp_m = reinterpret_cast<CppBindCDataMap*>(m.values)[_i_m];
...
CppBindCDataMap _func_CppbindExample_NestedExamples_getNestedIntMap(CppBindCObject cself, CppBindCObject* _Nonnull cppbind_err) {
    auto ctocxxcself = static_cast<cppbind::example::NestedExamples*>(cself.ptr);
    try {
        decltype(auto) result = ctocxxcself->getNestedIntMap();
        auto _k_data_cxxtocresult = new int [result.size()];
        auto _v_data_cxxtocresult = new CppBindCDataMap [result.size()];
        ...
        for (auto& value_result : result) {
            ...
            const auto& val_result = value_result.second;
            {
                ...
                CppBindCDataMap cxxtocval_result = { _k_data_cxxtocval_result, _v_data_cxxtocval_result, static_cast<long long>(val_result.size()) };
...
void _func_CppbindExample_NestedExamples_mixedExampleWithManyArgs(CppBindCObject cself, CppBindCDataArray v1, CppBindCDataArray v2, CppBindCDataMap m1, CppBindCDataMap m2, CppBindCObject* _Nonnull cppbind_err) {
    ...
    auto data_v1 = reinterpret_cast<CppBindCDataArray*>(v1.data);
    ...
    auto data_v2 = reinterpret_cast<CppBindCDataArray*>(v2.data);
    ...
    for (size_t _i_m1 = 0; _i_m1 < m1.size; ++_i_m1) {
        ...
        auto vtmp_m1 = reinterpret_cast<CppBindCDataMap*>(m1.values)[_i_m1];
    ...
    for (size_t _i_m2 = 0; _i_m2 < m2.size; ++_i_m2) {
        ...
        auto vtmp_m2 = reinterpret_cast<CppBindCDataMap*>(m2.values)[_i_m2];
...
void _func_CppbindExample_NestedExamples_setVectorOfIntMaps(CppBindCObject cself, CppBindCDataArray v, CppBindCObject* _Nonnull cppbind_err) {
    ...
    auto data_v = reinterpret_cast<CppBindCDataMap*>(v.data);
...
CppBindCDataArray _func_CppbindExample_NestedExamples_getVectorOfIntMaps(CppBindCObject cself, CppBindCObject* _Nonnull cppbind_err) {
    auto ctocxxcself = static_cast<cppbind::example::NestedExamples*>(cself.ptr);
    try {
        decltype(auto) result = ctocxxcself->getVectorOfIntMaps();
        auto _data_cxxtocresult = new CppBindCDataMap [result.size()];
        CppBindCDataArray cxxtocresult = { _data_cxxtocresult, static_cast<long long>(result.size()) };
        for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
            auto& value_result = result[_i_result];
            auto _k_data_cxxtocvalue_result = new int [value_result.size()];
            auto _v_data_cxxtocvalue_result = new int [value_result.size()];
            CppBindCDataMap cxxtocvalue_result = { _k_data_cxxtocvalue_result, _v_data_cxxtocvalue_result, static_cast<long long>(value_result.size()) };
...
void _func_CppbindExample_NestedExamples_setMapOfIntVectors(CppBindCObject cself, CppBindCDataMap m, CppBindCObject* _Nonnull cppbind_err) {
    ...
    for (size_t _i_m = 0; _i_m < m.size; ++_i_m) {
        auto ktmp_m = reinterpret_cast<int*>(m.keys)[_i_m];
        auto vtmp_m = reinterpret_cast<CppBindCDataArray*>(m.values)[_i_m];
...
CppBindCDataMap _func_CppbindExample_NestedExamples_getMapOfIntVectors(CppBindCObject cself, CppBindCObject* _Nonnull cppbind_err) {
    auto ctocxxcself = static_cast<cppbind::example::NestedExamples*>(cself.ptr);
    try {
        decltype(auto) result = ctocxxcself->getMapOfIntVectors();
        auto _k_data_cxxtocresult = new int [result.size()];
        auto _v_data_cxxtocresult = new CppBindCDataArray [result.size()];
        CppBindCDataMap cxxtocresult = { _k_data_cxxtocresult, _v_data_cxxtocresult, static_cast<long long>(result.size()) };
        size_t _i_result = 0;
        for (auto& value_result : result) {
            const auto& key_result = value_result.first;
            const auto& val_result = value_result.second;
            {
                ...
                CppBindCDataArray cxxtocval_result = { _data_cxxtocval_result, static_cast<long long>(val_result.size()) };
...
void _func_CppbindExample_NestedExamples_setComplexStringVector(CppBindCObject cself, CppBindCDataArray v, CppBindCObject* _Nonnull cppbind_err) {
    ...
    for (size_t _i_v = 0; _i_v < v.size; ++_i_v) {
        ...
        auto data_value_v = reinterpret_cast<CppBindCDataArray*>(value_v.data);
...
CppBindCDataArray _func_CppbindExample_NestedExamples_getComplexStringVector(CppBindCObject cself, CppBindCObject* _Nonnull cppbind_err) {
    auto ctocxxcself = static_cast<cppbind::example::NestedExamples*>(cself.ptr);
    try {
        decltype(auto) result = ctocxxcself->getComplexStringVector();
        auto _data_cxxtocresult = new CppBindCDataArray [result.size()];
        CppBindCDataArray cxxtocresult = { _data_cxxtocresult, static_cast<long long>(result.size()) };
        for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
            auto& value_result = result[_i_result];
            auto _data_cxxtocvalue_result = new CppBindCDataArray [value_result.size()];
            CppBindCDataArray cxxtocvalue_result = { _data_cxxtocvalue_result, static_cast<long long>(value_result.size()) };
            for (int _i_value_result = 0; _i_value_result < value_result.size(); ++_i_value_result) {
                auto& value_value_result = value_result[_i_value_result];
                auto _data_cxxtocvalue_value_result = new char* [value_value_result.size()];
                CppBindCDataArray cxxtocvalue_value_result = { _data_cxxtocvalue_value_result, static_cast<long long>(value_value_result.size()) };
...
void _func_CppbindExample_NestedExamples_setComplexStringMap(CppBindCObject cself, CppBindCDataMap m, CppBindCObject* _Nonnull cppbind_err) {
    ...
    for (size_t _i_m = 0; _i_m < m.size; ++_i_m) {
        ...
        for (size_t _i_vtmp_m = 0; _i_vtmp_m < vtmp_m.size; ++_i_vtmp_m) {
            ...
            auto vtmp_vtmp_m = reinterpret_cast<CppBindCDataMap*>(vtmp_m.values)[_i_vtmp_m];
...
CppBindCDataMap _func_CppbindExample_NestedExamples_getComplexStringMap(CppBindCObject cself, CppBindCObject* _Nonnull cppbind_err) {
    auto ctocxxcself = static_cast<cppbind::example::NestedExamples*>(cself.ptr);
    try {
        decltype(auto) result = ctocxxcself->getComplexStringMap();
        ...
        for (auto& value_result : result) {
            ...
            const auto& val_result = value_result.second;
            {
                ...
                auto _v_data_cxxtocval_result = new CppBindCDataMap [val_result.size()];
                CppBindCDataMap cxxtocval_result = { _k_data_cxxtocval_result, _v_data_cxxtocval_result, static_cast<long long>(val_result.size()) };
                size_t _i_val_result = 0;
                for (auto& value_val_result : val_result) {
                    const auto& key_val_result = value_val_result.first;
                    const auto& val_val_result = value_val_result.second;
                    {
                        ...
                        CppBindCDataMap cxxtocval_val_result = { _k_data_cxxtocval_val_result, _v_data_cxxtocval_val_result, static_cast<long long>(val_val_result.size()) };
