 ...
 * 
 * This file is generated by cppbind on 08/12/2022-14:03.
...
void release_Std_StdException(CppBindCObject cself, bool owner) {
    ...
    if (owner) {
        ...
        else if (strcmp(cself.type, CPPBIND_CPPBIND_EXAMPLE_FILEERROR) == 0)
            delete static_cast<cppbind::example::FileError*>(cself.ptr);
        ...
        else if (strcmp(cself.type, CPPBIND_CPPBIND_EXAMPLE_SYSTEMERROR) == 0)
            delete static_cast<cppbind::example::SystemError*>(cself.ptr);
...
std::exception* recover_obj_from_Std_StdException(CppBindCObject cppbindObj) {
    if (cppbindObj.ptr) {
        ...
        else if (strcmp(cppbindObj.type, CPPBIND_CPPBIND_EXAMPLE_SYSTEMERROR) == 0)
