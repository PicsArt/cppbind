...
iegen::example::SimpleBaseException* recover_obj_from_IegenExample_SimpleBaseException(IEGenCObject iegenObj) {
    if (iegenObj.ptr) {
...
int _func_IegenExample_SimpleBaseException_errNum(IEGenCObject cself, IEGenCObject* _Nonnull iegen_err) {
    iegen::example::SimpleBaseException* ctocxxcself = recover_obj_from_IegenExample_SimpleBaseException(cself);
    try {
