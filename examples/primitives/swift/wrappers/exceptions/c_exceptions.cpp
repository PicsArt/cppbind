 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 07/21/2021-10:12.
...
int _func_Exc_getByKey(CDataMap m, int k, ErrorObj* _Nonnull err){
    ...
    try {
      const auto& result = iegen::exceptions::Exc::getByKey(c_to_cxx_m, k);
