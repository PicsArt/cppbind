...
char* _Nonnull _func_Object_toString(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    c_to_cxx_cself = std::dynamic_pointer_cast<iegen::Object>(*static_cast<std::shared_ptr<iegen::Object>*>(cself));
    try {
...
bool _func_Object_equals(void* _Nonnull cself, void* _Nonnull other, ErrorObj* _Nonnull err){
    ...
    c_to_cxx_other = std::dynamic_pointer_cast<iegen::Object>(*static_cast<std::shared_ptr<iegen::Object>*>(other));
