...
extern const char* IEGEN_IEGEN_EXAMPLE_TEACHER;

const char* IEGEN_IEGEN_EXAMPLE_STUDENT = "iegen::example::Student";
...
IEGenCObject create_IegenExample_Student(char* _Nonnull st_name, IEGenCObject* _Nonnull iegen_err) {
    auto ctocxxst_name = std::string(st_name);
    free(st_name);
    try {
        auto this_object = new iegen::example::Student(ctocxxst_name);
        return {strdup(IEGEN_IEGEN_EXAMPLE_STUDENT), new std::shared_ptr<iegen::example::Student>(this_object)};
...
IEGenCObject create_IegenExample_Student_1(IEGenCDataArray teachers, IEGenCObject* _Nonnull iegen_err) {
...
void _func_IegenExample_Student_addTeacher(IEGenCObject cself, IEGenCObject t, IEGenCObject* _Nonnull iegen_err) {
...
IEGenCDataArray _func_IegenExample_Student_teachers(IEGenCObject cself, IEGenCObject* _Nonnull iegen_err) {
    std::shared_ptr<iegen::example::Student> ctocxxcself;
    ctocxxcself = *static_cast<std::shared_ptr<iegen::example::Student>*>(cself.ptr);
    try {
        ...
        for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
            ...
            char* type_value_result = strdup(IEGEN_IEGEN_EXAMPLE_TEACHER);
