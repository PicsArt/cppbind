...
CDataObj create_Student(char* _Nonnull st_name){
    ...
    return {0, new std::shared_ptr<iegen::example::Student>(this_object)};
}

CDataObj create_Student_1(CDataArray teachers){
    std::vector<Teacher *> c_to_cxx_teachers;

    auto data_teachers = reinterpret_cast<CDataObj*>(teachers.data);
...
CDataArray _func_Student_teachers(CDataObj cself, ErrorObj* _Nonnull err){
    ...
    try {
        ...
        for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
            ...
            CDataObj cxx_to_c_value_result = {code_value_result, const_cast<iegen::example::Teacher*>(value_result)};
