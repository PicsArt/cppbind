...
void _func_Teacher_addStudent(void* _Nonnull cself, void* _Nonnull s, ErrorObj* _Nonnull err){
    ...
    c_to_cxx_s = *static_cast<std::shared_ptr<iegen::example::Student>*>(s);
  
    
    auto c_to_cxx_cself = static_cast<iegen::example::Teacher*>(cself);
    try {
...
CDataArray _func_Teacher_students(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    try {
        ...
        for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
            ...
            cxx_to_c_value_result = reinterpret_cast<void*>(new std::shared_ptr<iegen::example::Student>(value_result));
