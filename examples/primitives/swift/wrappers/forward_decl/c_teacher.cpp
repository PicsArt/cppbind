...
void _func_Teacher_addStudent(void* _Nonnull cself, void* _Nonnull s, ErrorObj* _Nonnull err){
    ...
    c_to_cxx_s = std::dynamic_pointer_cast<iegen::example::Student>(*static_cast<std::shared_ptr<iegen::example::Student>*>(s));
...
CDataArray _func_Teacher_students(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    try {
        ...
        for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
            ...
            cxx_to_c_value_result = reinterpret_cast<void*>(new std::shared_ptr<iegen::example::Student>(std::static_pointer_cast<iegen::example::Student>(value_result)));
