...
iegen::example::Fruit* recover_obj_from_IegenExample_Fruit(IEGenCObject iegenObj) {
    if (iegenObj.ptr) {
...
int _prop_get_IegenExample_Fruit_type(IEGenCObject cself, IEGenCObject* _Nonnull iegen_err) {
    iegen::example::Fruit* ctocxxcself = recover_obj_from_IegenExample_Fruit(cself);
    try {
...
IEGenCObject create_IegenExample_Fruits(IEGenCDataArray fruits, IEGenCObject* _Nonnull iegen_err) {
    ...
    for (size_t _i_fruits = 0; _i_fruits < fruits.size; ++_i_fruits) {
        ...
        iegen::example::Fruit* ctocxxvalue_fruits = recover_obj_from_IegenExample_Fruit(value_fruits);
