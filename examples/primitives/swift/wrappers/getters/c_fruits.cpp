...
unsigned int _prop_get_Fruit_type(void* _Nonnull cself){
    auto c_to_cxx_cself = static_cast<iegen::example::Fruit*>(cself);
...
void* _Nonnull create_Fruits(CDataArray fruits){
    ...
    for (size_t _i_fruits = 0; _i_fruits < fruits.size; ++_i_fruits) {
        ...
        auto c_to_cxx_value_fruits = static_cast<iegen::example::Fruit*>(value_fruits);
...
CDataArray _prop_get_Fruits_fruitsApple(void* _Nonnull cself){
    auto c_to_cxx_cself = static_cast<iegen::example::Fruits*>(cself);
...
CDataArray _prop_get_Fruits_allFruitsApplePineapple(void* _Nonnull cself){
    ...
    for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
        ...
        auto cxx_to_c_value_result = const_cast<iegen::example::Fruit*>(value_result);
        _data_cxx_to_c_result[_i_result] = cxx_to_c_value_result;
    }
    return cxx_to_c_result;
}
...
void _prop_set_Fruits_allFruitsApplePineapple(void* _Nonnull cself, CDataArray arg0){
    ...
    for (size_t _i_arg0 = 0; _i_arg0 < arg0.size; ++_i_arg0) {
        ...
        auto c_to_cxx_value_arg0 = static_cast<iegen::example::Fruit*>(value_arg0);
