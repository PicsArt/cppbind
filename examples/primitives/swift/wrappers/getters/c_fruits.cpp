...
unsigned int _prop_get_Fruit_type(CObject cself){
    iegen::example::Fruit* ctocxxcself_ptr = nullptr;
    if (cself.ptr) {
...
unsigned int _prop_get_Apple_type(CObject cself){
    iegen::example::Apple* ctocxxcself_ptr = nullptr;
    if (cself.ptr) {
        if (strcmp(cself.type, "iegen::example::Apple") == 0)
            ctocxxcself_ptr = static_cast<iegen::example::Apple*>(cself.ptr);
        else {
            std::cerr << "Unexpected object type: " << cself.type << std::endl;
            exit(1);
...
unsigned int _prop_get_Pineapple_type(CObject cself){
    iegen::example::Pineapple* ctocxxcself_ptr = nullptr;
    if (cself.ptr) {
        if (strcmp(cself.type, "iegen::example::Pineapple") == 0)
            ctocxxcself_ptr = static_cast<iegen::example::Pineapple*>(cself.ptr);
        else {
            std::cerr << "Unexpected object type: " << cself.type << std::endl;
            exit(1);
...
CDataArray _prop_get_Fruits_fruitsApple(CObject cself){
    iegen::example::Fruits* ctocxxcself_ptr = nullptr;
    if (cself.ptr) {
        if (strcmp(cself.type, "iegen::example::Fruits") == 0)
            ctocxxcself_ptr = static_cast<iegen::example::Fruits*>(cself.ptr);
        else {
            std::cerr << "Unexpected object type: " << cself.type << std::endl;
            exit(1);
        }
...
CDataArray _prop_get_Fruits_allFruitsApplePineapple(CObject cself){
    ...
    for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
        ...
        CObject cxxtocvalue_result = {type_value_result, dynamic_cast<void*>(value_ptr_value_result)};
        _data_cxxtocresult[_i_result] = cxxtocvalue_result;
    }
    return cxxtocresult;
}
