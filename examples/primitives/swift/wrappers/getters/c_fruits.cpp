...
CDataArray _prop_get_Fruits_fruitsApple(CObject cself){
    ...
    for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
        ...
        CObject cxx_to_c_value_result = {type_value_result, static_cast<iegen::example::Fruit*>(value_ptr_value_result)};
...
CDataArray _prop_get_Fruits_allFruitsApplePineapple(CObject cself){
    ...
    for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
        ...
        char* type_value_result = strdup("iegen::example::Fruit");
        CObject cxx_to_c_value_result = {type_value_result, const_cast<iegen::example::Fruit*>(value_result)};
        _data_cxx_to_c_result[_i_result] = cxx_to_c_value_result;
    }
    return cxx_to_c_result;
}
