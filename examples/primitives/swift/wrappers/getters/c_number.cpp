...
int _func_NumberInt_toInt(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    auto c_to_cxx_cself = std::dynamic_pointer_cast<iegen::example::Number<int>>(*static_cast<std::shared_ptr<iegen::example::Number<int>>*>(cself));
    try {
...
int _func_NumberDouble_toInt(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    auto c_to_cxx_cself = std::dynamic_pointer_cast<iegen::example::Number<double>>(*static_cast<std::shared_ptr<iegen::example::Number<double>>*>(cself));
    try {
        const auto& result = c_to_cxx_cself->toInt();
