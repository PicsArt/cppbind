...
const char* IEGEN_IEGEN_EXAMPLE_PERSON = "iegen::example::Person";
...
IEGenCObject create_IegenExample_Person(char* _Nonnull name, char* _Nonnull email, int age, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_PERSON), new std::shared_ptr<iegen::example::Person>(this_object)};
...
char* _Nonnull _prop_get_IegenExample_Person_name(IEGenCObject cself, IEGenCObject* _Nonnull iegen_err) {
...
void _prop_set_IegenExample_Person_name(IEGenCObject cself, char* _Nonnull val, IEGenCObject* _Nonnull iegen_err) {
