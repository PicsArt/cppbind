...
extern const char* IEGEN_IEGEN_EXAMPLE_ROOT;
...
IEGenCDataPair _func_IegenExample_makePairProjectProject(IEGenCObject a, IEGenCObject b, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        char* type_first_result = strdup(IEGEN_IEGEN_EXAMPLE_PROJECT);
        ...
        char* type_second_result = strdup(IEGEN_IEGEN_EXAMPLE_PROJECT);
...
IEGenCDataPair _func_IegenExample_makePairRootProject(IEGenCObject a, IEGenCObject b, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        char* type_first_result = strdup(IEGEN_IEGEN_EXAMPLE_ROOT);
