...
void release_Std_StdException(IEGenCObject cself, bool owner) {
    ...
    if (owner) {
        ...
        else if (strcmp(cself.type, IEGEN_IEGEN_EXAMPLE_FILEERROR) == 0)
        ...
        else if (strcmp(cself.type, IEGEN_IEGEN_EXAMPLE_SYSTEMERROR) == 0)
...
std::exception* recover_obj_from_Std_StdException(IEGenCObject iegenObj) {
    if (iegenObj.ptr) {
        ...
        else if (strcmp(iegenObj.type, IEGEN_IEGEN_EXAMPLE_SYSTEMERROR) == 0)
...
std::logic_error* recover_obj_from_Std_StdLogicError(IEGenCObject iegenObj) {
    if (iegenObj.ptr) {
...
std::runtime_error* recover_obj_from_Std_StdRuntimeError(IEGenCObject iegenObj) {
    if (iegenObj.ptr) {
