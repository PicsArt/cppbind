...
char* _Nonnull _func_Animal_typeName(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    auto ctocxxcself = static_cast<iegen::example::Animal*>(cself);
    try {
...
char* _Nonnull _func_TerrestrialAnimal_typeName(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    auto ctocxxcself = dynamic_cast<iegen::example::TerrestrialAnimal*>(static_cast<iegen::example::Animal*>(cself));
    try {
        const auto& result = ctocxxcself->typeName();
        auto cxxtocresult = strdup(result.data());
        return cxxtocresult;
...
char* _Nonnull _func_AquaticAnimal_typeName(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    // we might need to avoid dynamic_cast if there is no multiple inheritance
    auto ctocxxcself = dynamic_cast<iegen::example::AquaticAnimal*>(static_cast<iegen::example::Animal*>(cself));
    try {
        const auto& result = ctocxxcself->typeName();
        auto cxxtocresult = strdup(result.data());
        return cxxtocresult;
...
char* _Nonnull _func_Frog_typeName(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    // we might need to avoid dynamic_cast if there is no multiple inheritance
    auto ctocxxcself = dynamic_cast<iegen::example::Frog*>(static_cast<iegen::example::Animal*>(cself));
    try {
        const auto& result = ctocxxcself->typeName();
        auto cxxtocresult = strdup(result.data());
        return cxxtocresult;
...
char* _Nonnull _func_AnimalUsage_getAnimalTypeName(void* _Nonnull animal, ErrorObj* _Nonnull err){
    ...
    auto& ctocxxanimal = *static_cast<iegen::example::Animal*>(animal);
...
char* _Nonnull _func_AnimalUsage_getAquaticAnimalTypeName(void* _Nonnull animal, ErrorObj* _Nonnull err){
    ...
    // we might need to avoid dynamic_cast if there is no multiple inheritance
    auto& ctocxxanimal = *dynamic_cast<iegen::example::AquaticAnimal*>(static_cast<iegen::example::Animal*>(animal));
...
void* _Nonnull _func_AnimalUsage_getAnimal(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    auto ctocxxcself = static_cast<iegen::example::AnimalUsage*>(cself);
    try {
        const auto& result = ctocxxcself->getAnimal();
        
        auto cxxtocresult = const_cast<iegen::example::Animal*>( &result );
        return cxxtocresult;
    }
    catch (const std::exception& e) {
        err->err_type = 1;
...
void* _Nonnull _func_AnimalUsage_getAquaticAnimal(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    try {
        ...
        auto cxxtocresult = static_cast<iegen::example::Animal*>(value_ptr_result);
        return cxxtocresult;
    }
    catch (const std::exception& e) {
        err->err_type = 1;
