...
std::shared_ptr<iegen::example::Date> downcast_IegenExample_MyDate(IEGenCObject iegenObj) {
    if (iegenObj.ptr) {
        if (strcmp(iegenObj.type, "iegen::example::Date") == 0)
...
char* _Nonnull _func_IegenExample_MyDate_value(IEGenCObject cself, IEGenCObject* _Nonnull err) {
    ...
    ctocxxcself = downcast_IegenExample_MyDate(cself);
    try {
