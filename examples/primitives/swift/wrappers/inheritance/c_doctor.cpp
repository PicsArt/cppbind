...
char* _Nonnull _func_IegenExample_DoctorInfo_getDoctorName(IEGenCObject cself, IEGenCObject d, IEGenCObject* _Nonnull err) {
    iegen::example::Doctor* ctocxxd = nullptr;
    if (d.ptr) {
        if (strcmp(d.type, "iegen::example::Doctor") == 0)
            ctocxxd = static_cast<iegen::example::Doctor*>(d.ptr);
        else if (strcmp(d.type, "iegen::example::Surgeon") == 0)
            ctocxxd = static_cast<iegen::example::Surgeon*>(d.ptr);
        else {
...
char* _Nonnull _func_IegenExample_DoctorInfo_getGoodDoctorName(IEGenCObject cself, IEGenCObject d, IEGenCObject* _Nonnull err) {
    iegen::example::GoodDoctor* ctocxxd = nullptr;
    if (d.ptr) {
        if (strcmp(d.type, "iegen::example::GoodDoctor") == 0)
            ctocxxd = static_cast<iegen::example::GoodDoctor*>(d.ptr);
        else if (strcmp(d.type, "iegen::example::GoodOldDoctor") == 0)
            ctocxxd = static_cast<iegen::example::GoodOldDoctor*>(d.ptr);
        else if (strcmp(d.type, "iegen::example::GoodYoungDoctor") == 0)
            ctocxxd = static_cast<iegen::example::GoodYoungDoctor*>(d.ptr);
        else {
            std::cerr << "Unexpected object type: " << d.type << std::endl;
            exit(1);
        }
