...
iegen::example::Doctor* recover_obj_from_IegenExample_Doctor(IEGenCObject iegenObj) {
    if (iegenObj.ptr) {
...
iegen::example::GoodVirtualDoctor* recover_obj_from_IegenExample_GoodVirtualDoctor(IEGenCObject iegenObj) {
    if (iegenObj.ptr) {
...
iegen::example::GoodDoctor* recover_obj_from_IegenExample_GoodDoctor(IEGenCObject iegenObj) {
    if (iegenObj.ptr) {
...
char* _Nonnull _func_IegenExample_DoctorInfo_getDoctorName(IEGenCObject cself, IEGenCObject d, IEGenCObject* _Nonnull iegen_err) {
    ...
    iegen::example::Doctor* ctocxxd = recover_obj_from_IegenExample_Doctor(d);
...
char* _Nonnull _func_IegenExample_DoctorInfo_getGoodDoctorName(IEGenCObject cself, IEGenCObject d, IEGenCObject* _Nonnull iegen_err) {
    ...
    iegen::example::GoodDoctor* ctocxxd = recover_obj_from_IegenExample_GoodDoctor(d);
