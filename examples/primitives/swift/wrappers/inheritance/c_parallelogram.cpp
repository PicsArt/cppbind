...
iegen::example::Parallelogram* recover_obj_from_IegenExample_Parallelogram(IEGenCObject iegenObj) {
    if (iegenObj.ptr) {
...
double _prop_get_IegenExample_Parallelogram_area(IEGenCObject cself, IEGenCObject* _Nonnull iegen_err) {
    iegen::example::Parallelogram* ctocxxcself = recover_obj_from_IegenExample_Parallelogram(cself);
    try {
