...
double _prop_get_Rectangle_area(IEGenCObject cself, IEGenCObject* _Nonnull err) {iegen::example::Rectangle* ctocxxcself = nullptr;
    if (cself.ptr) {
...
double _prop_get_Rectangle_length(IEGenCObject cself, IEGenCObject* _Nonnull err) {iegen::example::Rectangle* ctocxxcself = nullptr;
    if (cself.ptr) {
        if (strcmp(cself.type, "iegen::example::Rectangle") == 0)
            ctocxxcself = static_cast<iegen::example::Rectangle*>(cself.ptr);
        else if (strcmp(cself.type, "iegen::example::Square") == 0)
...
double _prop_get_Rectangle_width(IEGenCObject cself, IEGenCObject* _Nonnull err) {iegen::example::Rectangle* ctocxxcself = nullptr;
    if (cself.ptr) {
        if (strcmp(cself.type, "iegen::example::Rectangle") == 0)
            ctocxxcself = static_cast<iegen::example::Rectangle*>(cself.ptr);
        else if (strcmp(cself.type, "iegen::example::Square") == 0)
