...
void release_NumberImpl(CObject cself, bool owner){
    delete cself.type;
    if (owner) {
        delete dynamic_cast<iegen::example::Number*>(static_cast<iegen::example::Symbol*>(cself.ptr));
    }
}
...
CObject create_Number(ErrorObj* _Nonnull err){
    try {
        ...
        return {strdup("iegen::example::Number"), static_cast<iegen::example::Symbol*>(this_object)};
    }
    catch (const std::exception& e) {
        err->err_type = 1;
        err->err_ptr = new std::exception(e);
...
char* _Nonnull _func_Number_typeName(CObject cself, ErrorObj* _Nonnull err){
    ...
    auto ctocxxcself = dynamic_cast<iegen::example::Number*>(static_cast<iegen::example::Symbol*>(cself.ptr));
    try {
        const auto& result = ctocxxcself->typeName();
        auto cxxtocresult = strdup(result.data());
        return cxxtocresult;
...
CObject create_Text(ErrorObj* _Nonnull err){
    try {
        ...
        return {strdup("iegen::example::Text"), static_cast<iegen::example::Symbol*>(this_object)};
    }
    catch (const std::exception& e) {
        err->err_type = 1;
        err->err_ptr = new std::exception(e);
...
char* _Nonnull _func_Text_typeName(CObject cself, ErrorObj* _Nonnull err){
    ...
    // we might need to avoid dynamic_cast if there is no multiple inheritance
    auto ctocxxcself = dynamic_cast<iegen::example::Text*>(static_cast<iegen::example::Symbol*>(cself.ptr));
    try {
        const auto& result = ctocxxcself->typeName();
        auto cxxtocresult = strdup(result.data());
        return cxxtocresult;
...
CObject create_Digit(ErrorObj* _Nonnull err){
    try {
        ...
        return {strdup("iegen::example::Digit"), static_cast<iegen::example::Symbol*>(this_object)};
    }
    catch (const std::exception& e) {
        err->err_type = 1;
        err->err_ptr = new std::exception(e);
...
char* _Nonnull _func_Digit_typeName(CObject cself, ErrorObj* _Nonnull err){
    ...
    // we might need to avoid dynamic_cast if there is no multiple inheritance
    auto ctocxxcself = dynamic_cast<iegen::example::Digit*>(static_cast<iegen::example::Symbol*>(cself.ptr));
    try {
        const auto& result = ctocxxcself->typeName();
        auto cxxtocresult = strdup(result.data());
        return cxxtocresult;
...
char* _Nonnull _func_SymbolUsage_getTextType(CObject cself, CObject t, ErrorObj* _Nonnull err){
    ...
    // we might need to avoid dynamic_cast if there is no multiple inheritance
    auto ctocxxt = dynamic_cast<iegen::example::Text*>(static_cast<iegen::example::Symbol*>(t.ptr));
