...
extern const char* IEGEN_IEGEN_EXAMPLE_PARALLELOGRAM;
extern const char* IEGEN_IEGEN_EXAMPLE_VEHICLE;
extern const char* IEGEN_IEGEN_EXAMPLE_BICYCLE;
extern const char* IEGEN_IEGEN_EXAMPLE_MYDATE;

const char* IEGEN_IEGEN_EXAMPLE_GEOMETRICFIGURE = "iegen::example::GeometricFigure";
const char* IEGEN_IEGEN_EXAMPLE_MYVEHICLE = "iegen::example::MyVehicle";
const char* IEGEN_IEGEN_EXAMPLE_MYBICYCLE = "iegen::example::MyBicycle";
const char* IEGEN_IEGEN_EXAMPLE_MYCALENDAR = "iegen::example::MyCalendar";

iegen::example::Parallelogram* recover_obj_from_IegenExample_Parallelogram(IEGenCObject);
std::shared_ptr<iegen::example::Vehicle> recover_obj_from_IegenExample_Vehicle(IEGenCObject);
std::shared_ptr<iegen::example::Date> recover_obj_from_IegenExample_MyDate(IEGenCObject);
...
IEGenCObject create_IegenExample_GeometricFigure(IEGenCObject p, IEGenCObject* _Nonnull iegen_err) {
    ...
    iegen::example::Parallelogram* ctocxxp = recover_obj_from_IegenExample_Parallelogram(p);
    try {
        auto this_object = new iegen::example::GeometricFigure(ctocxxp);
        return {strdup(IEGEN_IEGEN_EXAMPLE_GEOMETRICFIGURE), this_object};
...
IEGenCObject _prop_get_IegenExample_GeometricFigure_parallelogram(IEGenCObject cself, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        if (status == 0) {
            ...
            type_result = strdup(IEGEN_IEGEN_EXAMPLE_PARALLELOGRAM);
        }
...
IEGenCObject create_IegenExample_MyVehicle(IEGenCObject v, IEGenCObject cv, IEGenCObject* _Nonnull iegen_err) {
    ...
    ctocxxv = recover_obj_from_IegenExample_Vehicle(v);
    
    std::shared_ptr<const iegen::example::Vehicle> ctocxxcv;
    ctocxxcv = recover_obj_from_IegenExample_Vehicle(cv);
    try {
        auto this_object = new iegen::example::MyVehicle(ctocxxv, ctocxxcv);
        return {strdup(IEGEN_IEGEN_EXAMPLE_MYVEHICLE), new std::shared_ptr<iegen::example::MyVehicle>(this_object)};
    } catch (const std::exception& e) {
        iegen_err->type = strdup(IEGEN_STD_STDEXCEPTION);
        iegen_err->ptr = new std::exception(e);
    } catch (...) {
    ...
    try {
        ...
        if (result) {
            ...
            if (status == 0) {
                ...
                type_result = strdup(IEGEN_IEGEN_EXAMPLE_VEHICLE);
            }
...
IEGenCObject create_IegenExample_MyBicycle(IEGenCObject b, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_MYBICYCLE), new std::shared_ptr<iegen::example::MyBicycle>(this_object)};
    } catch (const std::exception& e) {
        iegen_err->type = strdup(IEGEN_STD_STDEXCEPTION);
        iegen_err->ptr = new std::exception(e);
    } catch (...) {
...
IEGenCObject _prop_get_IegenExample_MyBicycle_bicycle(IEGenCObject cself, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        char* type_result = strdup(IEGEN_IEGEN_EXAMPLE_BICYCLE);
        void* cxxtocresult_ptr = nullptr;
...
IEGenCObject create_IegenExample_MyCalendar(IEGenCDataArray events, IEGenCObject* _Nonnull iegen_err) {
    ...
    for (size_t _i_events = 0; _i_events < events.size; ++_i_events) {
        ...
        ctocxxvalue_events = recover_obj_from_IegenExample_MyDate(value_events);
        ctocxxevents.emplace_back(ctocxxvalue_events);
    }
    try {
        auto this_object = new iegen::example::MyCalendar(ctocxxevents);
        return {strdup(IEGEN_IEGEN_EXAMPLE_MYCALENDAR), new std::shared_ptr<iegen::example::MyCalendar>(this_object)};
    } catch (const std::exception& e) {
        iegen_err->type = strdup(IEGEN_STD_STDEXCEPTION);
        iegen_err->ptr = new std::exception(e);
    } catch (...) {
...
void _func_IegenExample_MyCalendar_addEvent(IEGenCObject cself, IEGenCObject e, IEGenCObject* _Nonnull iegen_err) {
    ...
    ctocxxe = recover_obj_from_IegenExample_MyDate(e);
    ...
    try {
        ...
        for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
            ...
            if (status == 0) {
                ...
                type_value_result = strdup(IEGEN_IEGEN_EXAMPLE_MYDATE);
            }
