...
void* _Nonnull create_MyVehicle(void* _Nonnull v){
    ...
    auto c_to_cxx_v_baseptr = *reinterpret_cast<std::shared_ptr<iegen::example::Vehicle>*>(v);
    c_to_cxx_v = std::dynamic_pointer_cast<iegen::example::Vehicle>(c_to_cxx_v_baseptr);
...
void* _Nonnull _prop_get_MyVehicle_vehicle(void* _Nonnull cself){
    ...
    std::shared_ptr<iegen::example::Vehicle> cxx_to_c_result_baseptr = std::static_pointer_cast<iegen::example::Vehicle>(result);
    cxx_to_c_result = reinterpret_cast<void*>(new std::shared_ptr<iegen::example::Vehicle>(cxx_to_c_result_baseptr));
    return cxx_to_c_result;
}
