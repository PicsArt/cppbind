...
CObject _prop_get_MyVehicle_vehicle(CObject cself){
    ...
    if (result) {
        ...
        cxx_to_c_result_ptr = new std::shared_ptr<iegen::example::Vehicle>(result);
    } else {
        type_result = strdup("iegen::example::Vehicle");
    }
...
CObject _prop_get_MyBicycle_bicycle(CObject cself){
    ...
    cxx_to_c_result_ptr = new std::shared_ptr<const iegen::example::Vehicle>(std::static_pointer_cast<const iegen::example::Vehicle>(result));
    CObject cxx_to_c_result = {type_result, cxx_to_c_result_ptr};
    return cxx_to_c_result;
}
...
CDataArray _prop_get_MyCalendar_events(CObject cself){
    ...
    for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
        ...
        cxx_to_c_value_result_ptr = new std::shared_ptr<iegen::example::Base>(std::static_pointer_cast<iegen::example::Base>(value_result));
