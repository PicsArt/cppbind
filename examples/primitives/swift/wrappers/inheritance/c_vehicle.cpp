...
std::shared_ptr<iegen::example::Vehicle> recover_obj_from_IegenExample_Vehicle(IEGenCObject iegenObj) {
    if (iegenObj.ptr) {
...
int _prop_get_IegenExample_Vehicle_numberOfSeats(IEGenCObject cself, IEGenCObject* _Nonnull iegen_err) {
    ...
    ctocxxcself = recover_obj_from_IegenExample_Vehicle(cself);
    try {
