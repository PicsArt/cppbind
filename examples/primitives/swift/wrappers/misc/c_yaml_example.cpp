...
IEGenCObject create_IegenExample_WithExternalAPIComments(char* _Nonnull s, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_WITHEXTERNALAPICOMMENTS), this_object};
...
char* _Nonnull _func_IegenExample_WithExternalAPIComments_maxString(char* _Nonnull a, char* _Nonnull b, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        const auto& result = iegen::example::WithExternalAPIComments::max<std::string>(ctocxxa, ctocxxb);
        auto cxxtocresult = strdup(result.data());
        return cxxtocresult;
    } catch (const std::exception& e) {
        iegen_err->type = strdup(IEGEN_STD_STDEXCEPTION);
