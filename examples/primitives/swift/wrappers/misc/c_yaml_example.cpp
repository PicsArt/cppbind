 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 01/21/2022-14:56.
...
char* _Nonnull _prop_get_WithExternalAPIComments_str(CObject cself){
    iegen::example::WithExternalAPIComments* ctocxxcself_ptr = nullptr;
    if (cself.ptr) {
        if (strcmp(cself.type, "iegen::example::WithExternalAPIComments") == 0)
            ctocxxcself_ptr = static_cast<iegen::example::WithExternalAPIComments*>(cself.ptr);
        else {
