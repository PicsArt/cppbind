 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 03/04/2022-15:38.
...
IEGenCObject _prop_get_NullableUtils_nullable(IEGenCObject cself, IEGenCObject* _Nonnull err) {
...
void _prop_set_NullableUtils_nullable(IEGenCObject cself, IEGenCObject num, IEGenCObject* _Nonnull err) {
...
IEGenCObject _prop_get_NullableUtils_nonNull(IEGenCObject cself, IEGenCObject* _Nonnull err) {
    std::shared_ptr<iegen::example::nullable::Utils> ctocxxcself;
    ctocxxcself = *static_cast<std::shared_ptr<iegen::example::nullable::Utils>*>(cself.ptr);
    try {
...
void _prop_set_NullableUtils_nonNull(IEGenCObject cself, IEGenCObject num, IEGenCObject* _Nonnull err) {
