...
const char* IEGEN_IEGEN_EXAMPLE_NULLABLE_NUMINT = "iegen::example::nullable::NumberInt";
const char* IEGEN_IEGEN_EXAMPLE_NULLABLE_NUMDOUBLE = "iegen::example::nullable::NumberDouble";
const char* IEGEN_IEGEN_EXAMPLE_NULLABLE_NULLABLEUTILS = "iegen::example::nullable::Utils";
...
IEGenCObject create_IegenExampleNullable_NumInt(int val_, IEGenCObject* _Nonnull iegen_err) {
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_NULLABLE_NUMINT), new std::shared_ptr<iegen::example::nullable::NumberInt>(this_object)};
...
IEGenCObject create_IegenExampleNullable_NumDouble(double val_, IEGenCObject* _Nonnull iegen_err) {
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_NULLABLE_NUMDOUBLE), this_object};
    } catch (const std::exception& e) {
        iegen_err->type = strdup(IEGEN_STD_STDEXCEPTION);
        iegen_err->ptr = new std::exception(e);
    } catch (...) {
...
IEGenCObject create_IegenExampleNullable_NullableUtils(IEGenCObject num, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_NULLABLE_NULLABLEUTILS), new std::shared_ptr<iegen::example::nullable::Utils>(this_object)};
    } catch (const std::exception& e) {
        iegen_err->type = strdup(IEGEN_STD_STDEXCEPTION);
        iegen_err->ptr = new std::exception(e);
    } catch (...) {
...
IEGenCObject _func_IegenExampleNullable_NullableUtils_max(IEGenCObject first, IEGenCObject second, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        char* type_result = strdup(IEGEN_IEGEN_EXAMPLE_NULLABLE_NUMDOUBLE);
...
IEGenCObject _func_IegenExampleNullable_NullableUtils_max_1(IEGenCObject first, IEGenCObject second, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        if (result) {
            cxxtocresult_ptr = new std::shared_ptr<iegen::example::nullable::NumberInt>(std::const_pointer_cast<iegen::example::nullable::NumberInt>(result));
        } else {
...
const char * _Nullable _func_IegenExampleNullable_reverseString(const char * _Nullable s, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        const auto& result = iegen::example::nullable::reverseString(s);
