...
int _prop_get_NumInt_value(void* _Nonnull cself){
    ...
    c_to_cxx_cself = std::dynamic_pointer_cast<iegen::example::nullable::NumberInt>(*static_cast<std::shared_ptr<iegen::example::nullable::NumberInt>*>(cself));
...
void* _Nullable _prop_get_NullableUtils_nullable(void* _Nonnull cself){
    ...
    c_to_cxx_cself = std::dynamic_pointer_cast<iegen::example::nullable::Utils>(*static_cast<std::shared_ptr<iegen::example::nullable::Utils>*>(cself));
