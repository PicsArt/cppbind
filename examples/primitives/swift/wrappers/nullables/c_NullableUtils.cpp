...
int _prop_get_NumInt_value(void* _Nonnull cself){
    auto c_to_cxx_cself = std::dynamic_pointer_cast<iegen::example::nullable::NumberInt>(*static_cast<std::shared_ptr<iegen::example::nullable::NumberInt>*>(cself));
...
void* _Nullable _func_NullableUtils_max_1(void* _Nullable first, void* _Nullable second, ErrorObj* _Nonnull err){
    ...
    if (first) {
        c_to_cxx_first = std::dynamic_pointer_cast<iegen::example::nullable::NumberInt>(*static_cast<std::shared_ptr<iegen::example::nullable::NumberInt>*>(first));
    }
  
    
    std::shared_ptr<iegen::example::nullable::NumberInt> c_to_cxx_second = nullptr;
    if (second) {
        c_to_cxx_second = std::dynamic_pointer_cast<iegen::example::nullable::NumberInt>(*static_cast<std::shared_ptr<iegen::example::nullable::NumberInt>*>(second));
    }
    ...
    try {
        ...
        if (result) {
            cxx_to_c_result = reinterpret_cast<void*>(new std::shared_ptr<iegen::example::nullable::NumberInt>(std::static_pointer_cast<iegen::example::nullable::NumberInt>(result)));
        }
        return cxx_to_c_result;
    }
    catch (const std::exception& e) {
...
void* _Nullable _prop_get_NullableUtils_nullable(void* _Nonnull cself){
    auto c_to_cxx_cself = std::dynamic_pointer_cast<iegen::example::nullable::Utils>(*static_cast<std::shared_ptr<iegen::example::nullable::Utils>*>(cself));
...
void _prop_set_NullableUtils_numInt(void* _Nonnull cself, void* _Nonnull numInt){
    ...
    c_to_cxx_numInt = std::dynamic_pointer_cast<iegen::example::nullable::NumberInt>(*static_cast<std::shared_ptr<iegen::example::nullable::NumberInt>*>(numInt));
