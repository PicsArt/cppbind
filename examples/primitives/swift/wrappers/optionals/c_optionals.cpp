...
char* _Nonnull _func_IegenExample_Optionals_optionalStringWithDefault(IEGenCObject cself, char* _Nonnull optionalStr, IEGenCObject* _Nonnull iegen_err) {
...
const char * _Nonnull _func_IegenExample_Optionals_optionalCharPointerWithDefault(IEGenCObject cself, const char * _Nonnull optionalStr, IEGenCObject* _Nonnull iegen_err) {
...
unsigned int _func_IegenExample_Optionals_optionalEnumWithDefault(IEGenCObject cself, unsigned int c, IEGenCObject* _Nonnull iegen_err) {
...
unsigned int _func_IegenExample_Optionals_optionalEnumWithDefaultAndFieldPrefix(IEGenCObject cself, unsigned int c, IEGenCObject* _Nonnull iegen_err) {
...
unsigned int _func_IegenExample_Optionals_optionalEnumWithInternalDefault(IEGenCObject cself, unsigned int c, IEGenCObject* _Nonnull iegen_err) {
    auto ctocxxc = static_cast<iegen::example::ColorShade>(c);
...
char* _Nonnull _func_IegenExample_Optionals_optionalStringViewWithDefault(IEGenCObject cself, char* _Nonnull optionalStr, IEGenCObject* _Nonnull iegen_err) {
    auto ctocxxoptionalStr = std::string(optionalStr);
    free(optionalStr);
