 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 10/22/2021-07:33.
...
void* _Nullable _func_Optionals_optionalSharedPtrWithNullptrDefault(void* _Nonnull cself, void* _Nullable person, ErrorObj* _Nonnull err){
    ...
    if (person) {
        c_to_cxx_person = std::dynamic_pointer_cast<iegen::example::Person>(*static_cast<std::shared_ptr<iegen::example::Person>*>(person));
    }
    ...
    try {
        ...
        if (result) {
            cxx_to_c_result = reinterpret_cast<void*>(new std::shared_ptr<iegen::example::Person>(std::static_pointer_cast<iegen::example::Person>(result)));
        }
        return cxx_to_c_result;
    }
    catch (const std::exception& e) {
