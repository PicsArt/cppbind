...
const char* IEGEN_IEGEN_EXAMPLE_CHILD3 = "iegen::example::Child3";
...
IEGenCObject create_IegenExample_Child1(char* _Nonnull name, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_CHILD1), this_object};
...
IEGenCObject create_IegenExample_Child3(char* _Nonnull name, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_CHILD3), this_object};
    } catch (const std::exception& e) {
        iegen_err->type = strdup(IEGEN_STD_STDEXCEPTION);
        iegen_err->ptr = new std::exception(e);
    } catch (...) {
...
IEGenCObject create_IegenExample_Child2(char* _Nonnull name, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_CHILD2), new std::shared_ptr<iegen::example::Child2>(this_object)};
    } catch (const std::exception& e) {
        iegen_err->type = strdup(IEGEN_STD_STDEXCEPTION);
        iegen_err->ptr = new std::exception(e);
    } catch (...) {
...
IEGenCObject create_IegenExample_Parent1(char* _Nonnull name, IEGenCObject child1, IEGenCObject child2, IEGenCObject _child3, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_PARENT1), this_object};
    } catch (const std::exception& e) {
        iegen_err->type = strdup(IEGEN_STD_STDEXCEPTION);
        iegen_err->ptr = new std::exception(e);
    } catch (...) {
...
IEGenCObject _prop_get_IegenExample_Parent1_child2(IEGenCObject cself, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        cxxtocresult_ptr = new std::shared_ptr<iegen::example::Child2>(std::const_pointer_cast<iegen::example::Child2>(result));
...
IEGenCObject _prop_get_IegenExample_Parent1_child3(IEGenCObject cself) {
    ...
    char* type_result = strdup(IEGEN_IEGEN_EXAMPLE_CHILD3);
...
IEGenCObject create_IegenExample_Parent2(char* _Nonnull name, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_PARENT2), this_object};
    } catch (const std::exception& e) {
        iegen_err->type = strdup(IEGEN_STD_STDEXCEPTION);
        iegen_err->ptr = new std::exception(e);
    } catch (...) {
...
IEGenCDataArray _prop_get_IegenExample_Parent2_children2(IEGenCObject cself, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        for (int _i_result = 0; _i_result < result.size(); ++_i_result) {
            ...
            cxxtocvalue_result_ptr = new std::shared_ptr<iegen::example::Child2>(std::const_pointer_cast<iegen::example::Child2>(value_result));
