...
extern "C" {
    ...
    char* _Nonnull _prop_get_Child1_name(IEGenCObject cself);
    ...
    char* _Nonnull _prop_get_Parent1_name(IEGenCObject cself);
    IEGenCObject _prop_get_Parent1_child1(IEGenCObject cself);

    void _prop_set_Parent1_child1(IEGenCObject cself, IEGenCObject child1);

    IEGenCObject _prop_get_Parent1_child2(IEGenCObject cself);
    ...
    char* _Nonnull _prop_get_Parent2_name(IEGenCObject cself);
    IEGenCDataArray _prop_get_Parent2_children1(IEGenCObject cself);
    ...
    IEGenCDataArray _prop_get_Parent2_children2(IEGenCObject cself);
#if __cplusplus
}
#endif
