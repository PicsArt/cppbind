...
void _func_Car_setCostWithCarSharedPtr(void* _Nonnull cself , void* _Nonnull sp, ErrorObj* _Nonnull err){
    ...
    auto baseptr = *reinterpret_cast<std::shared_ptr<Example::Car>*>(sp);
    c_to_cxx_sp = std::dynamic_pointer_cast<Example::Car>(baseptr);
...
void* _Nonnull _func_Car_getNewCarSharedPtr(void* _Nonnull cself , ErrorObj* _Nonnull err){
    ...
    void* _Nonnull cxx_to_c_result;
    std::shared_ptr<Example::Car> baseptr = std::static_pointer_cast<Example::Car>(result);
    cxx_to_c_result = reinterpret_cast<void* _Nonnull>(new std::shared_ptr<Example::Car>(baseptr));
