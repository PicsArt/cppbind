...
const char* IEGEN_EXAMPLE_CAR = "Example::Car";
const char* IEGEN_EXAMPLE_CARUSAGE = "Example::CarUsage";
...
IEGenCObject create_Example_Car(int cost, IEGenCObject* _Nonnull iegen_err) {
    try {
        ...
        return {strdup(IEGEN_EXAMPLE_CAR), new std::shared_ptr<Example::Car>(this_object)};
...
IEGenCObject create_Example_CarUsage(IEGenCObject car, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        return {strdup(IEGEN_EXAMPLE_CARUSAGE), this_object};
    } catch (const std::exception& e) {
        iegen_err->type = strdup(IEGEN_STD_STDEXCEPTION);
        iegen_err->ptr = new std::exception(e);
    } catch (...) {
