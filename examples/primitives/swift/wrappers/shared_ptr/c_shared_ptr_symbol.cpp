 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 01/25/2022-08:44.
...
char* _Nonnull _func_DigitShared_typeName(CObject cself, ErrorObj* _Nonnull err){
    ...
    if (strcmp(cself.type, "iegen::example::DigitShared") == 0)
        ctocxxcself = *static_cast<std::shared_ptr<iegen::example::DigitShared>*>(cself.ptr);
    else {
        std::cerr << "Unexpected object type: " << cself.type << std::endl;
        exit(1);
...
CObject create_SymbolUsageShared_1(CObject d, ErrorObj* _Nonnull err){
    ...
    if (strcmp(d.type, "iegen::example::DigitShared") == 0)
...
char* _Nonnull _func_SymbolUsageShared_getTextType(CObject cself, CObject t, ErrorObj* _Nonnull err){
    ...
    iegen::example::SymbolUsageShared* ctocxxcself_ptr = nullptr;
    if (cself.ptr) {
        if (strcmp(cself.type, "iegen::example::SymbolUsageShared") == 0)
            ctocxxcself_ptr = static_cast<iegen::example::SymbolUsageShared*>(cself.ptr);
        else {
            std::cerr << "Unexpected object type: " << cself.type << std::endl;
            exit(1);
        }
