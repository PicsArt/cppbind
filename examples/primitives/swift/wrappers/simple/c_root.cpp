...
IEGenCObject create_Root(char* _Nonnull _path, IEGenCObject* _Nonnull err) {
...
void _func_Root_setPath(IEGenCObject cself, char* _Nonnull _path, IEGenCObject* _Nonnull err) {
    auto ctocxx_path = std::string(_path);
    free(_path);
