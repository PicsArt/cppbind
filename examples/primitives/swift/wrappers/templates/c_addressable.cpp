...
char* _Nonnull _func_AddressableRoot_absPath(void* _Nonnull cself, ErrorObj* _Nonnull err){
    ...
    auto c_to_cxx_cself = std::dynamic_pointer_cast<iegen::example::Addressable<iegen::example::Root>>(*static_cast<std::shared_ptr<iegen::example::Addressable<iegen::example::Root>>*>(cself));
    try {
