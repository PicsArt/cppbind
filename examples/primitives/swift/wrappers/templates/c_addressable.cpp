...
std::shared_ptr<iegen::example::Addressable<iegen::example::Root>> recover_obj_from_IegenExample_AddressableRoot(IEGenCObject iegenObj) {
    if (iegenObj.ptr) {
...
char* _Nonnull _func_IegenExample_AddressableRoot_absPath(IEGenCObject cself, IEGenCObject* _Nonnull iegen_err) {
    ...
    ctocxxcself = recover_obj_from_IegenExample_AddressableRoot(cself);
    try {
