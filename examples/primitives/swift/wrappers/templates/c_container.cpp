...
const char* IEGEN_IEGEN_EXAMPLE_CONTAINER = "iegen::example::Container";
...
void release_IegenExample_ContainerImpl(IEGenCObject cself, bool owner) {
    ...
    if (owner) {
        if (strcmp(cself.type, IEGEN_IEGEN_EXAMPLE_CONTAINER) == 0)
            delete static_cast<iegen::example::Container*>(cself.ptr);
        else if (strcmp(cself.type, IEGEN_IEGEN_EXAMPLE_STACKPRJ) == 0)
            delete static_cast<iegen::example::Stack<iegen::example::Project>*>(cself.ptr);
        else if (strcmp(cself.type, IEGEN_IEGEN_EXAMPLE_STACKTASK) == 0)
            delete static_cast<iegen::example::Stack<iegen::example::Task>*>(cself.ptr);
        else if (strcmp(cself.type, IEGEN_IEGEN_EXAMPLE_STACKNUMINT) == 0)
...
iegen::example::Container* recover_obj_from_IegenExample_Container(IEGenCObject iegenObj) {
    if (iegenObj.ptr) {
        if (strcmp(iegenObj.type, IEGEN_IEGEN_EXAMPLE_CONTAINER) == 0)
            return static_cast<iegen::example::Container*>(iegenObj.ptr);
        else if (strcmp(iegenObj.type, IEGEN_IEGEN_EXAMPLE_STACKPRJ) == 0)
            return static_cast<iegen::example::Stack<iegen::example::Project>*>(iegenObj.ptr);
        else if (strcmp(iegenObj.type, IEGEN_IEGEN_EXAMPLE_STACKTASK) == 0)
            return static_cast<iegen::example::Stack<iegen::example::Task>*>(iegenObj.ptr);
        else if (strcmp(iegenObj.type, IEGEN_IEGEN_EXAMPLE_STACKNUMINT) == 0)
...
IEGenCObject create_IegenExample_ContainerHolder(IEGenCObject container, IEGenCObject* _Nonnull iegen_err) {
    ...
    iegen::example::Container* ctocxxcontainer = recover_obj_from_IegenExample_Container(container);
    try {
        auto this_object = new iegen::example::ContainerHolder(ctocxxcontainer);
        return {strdup(IEGEN_IEGEN_EXAMPLE_CONTAINERHOLDER), this_object};
...
IEGenCObject _prop_get_IegenExample_ContainerHolder_container(IEGenCObject cself, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        if (status == 0) {
            ...
            type_result = strdup(IEGEN_IEGEN_EXAMPLE_CONTAINER);
        }
