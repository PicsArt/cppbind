...
void* _Nonnull create_PairEmployee(char* _Nonnull first, void* _Nonnull second){
    ...
    c_to_cxx_second = *static_cast<std::shared_ptr<iegen::example::Employee>*>(second);
...
char* _Nonnull _prop_get_PairEmployee_first(void* _Nonnull cself){
    auto c_to_cxx_cself = static_cast<iegen::example::Pair<std::string, std::shared_ptr<iegen::example::Employee>>*>(cself);
...
void* _Nonnull _prop_get_PairEmployee_second(void* _Nonnull cself){
    ...
    cxx_to_c_result = reinterpret_cast<void*>(new std::shared_ptr<iegen::example::Employee>(result));
    return cxx_to_c_result;
}
...
void* _Nonnull create_PairStudent(char* _Nonnull first, void* _Nonnull second){
    ...
    c_to_cxx_second = *static_cast<std::shared_ptr<iegen::example::Student>*>(second);
...
char* _Nonnull _prop_get_PairStudent_first(void* _Nonnull cself){
    auto c_to_cxx_cself = static_cast<iegen::example::Pair<std::string, std::shared_ptr<iegen::example::Student>>*>(cself);
    const auto& result = c_to_cxx_cself->first();
    auto cxx_to_c_result = strdup(result.data());
    return cxx_to_c_result;
}
...
void* _Nonnull _prop_get_PairStudent_second(void* _Nonnull cself){
    ...
    void* cxx_to_c_result;
    cxx_to_c_result = reinterpret_cast<void*>(new std::shared_ptr<iegen::example::Student>(result));
    return cxx_to_c_result;
}