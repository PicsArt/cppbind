...
IEGenCObject create_IegenExample_StackPrj(IEGenCObject* _Nonnull iegen_err) {
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_STACKPRJ), this_object};
...
IEGenCObject create_IegenExample_StackTask(IEGenCObject* _Nonnull iegen_err) {
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_STACKTASK), this_object};
    } catch (const std::exception& e) {
        iegen_err->type = strdup(IEGEN_STD_STDEXCEPTION);
        iegen_err->ptr = new std::exception(e);
    } catch (...) {
...
IEGenCObject create_IegenExample_StackNumInt(IEGenCObject* _Nonnull iegen_err) {
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_STACKNUMINT), this_object};
    } catch (const std::exception& e) {
        iegen_err->type = strdup(IEGEN_STD_STDEXCEPTION);
        iegen_err->ptr = new std::exception(e);
    } catch (...) {
