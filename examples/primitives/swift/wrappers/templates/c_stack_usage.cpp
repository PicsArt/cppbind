 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 10/06/2021-10:11.
...
void* _Nonnull _func_StackUsage_firstItemOfSpecializedStack(void* _Nonnull cself, void* _Nonnull p, ErrorObj* _Nonnull err){
    ...
    auto c_to_cxx_p = dynamic_cast<iegen::example::Stack<Project>*>(static_cast<iegen::example::Stack<iegen::example::Project>*>(p));
