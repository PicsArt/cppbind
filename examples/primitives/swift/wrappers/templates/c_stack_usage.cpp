 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 01/27/2022-14:25.
...
CObject _func_StackUsage_firstItemOfSpecializedStack(CObject cself, CObject p, ErrorObj* _Nonnull err){
    ...
    auto ctocxxp = dynamic_cast<iegen::example::Stack<iegen::example::Project>*>(static_cast<iegen::example::Container*>(p.ptr));
