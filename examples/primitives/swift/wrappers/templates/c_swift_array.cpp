 ...
 * 
 * This file is generated by cppbind on 10/24/2022-06:44.
...
int _func_CppbindExample_getLastElementInt2(CppBindCObject a, CppBindCObject* _Nonnull cppbind_err) {
    using namespace cppbind::example;
    
    auto& ctocxxa = *static_cast<cppbind::example::Array<int, 2>*>(a.ptr);
    try {
        decltype(auto) result = cppbind::example::getLastElement<int, 2>(ctocxxa);
...
void release_CppbindExample_Array4Float(CppBindCObject cself, bool owner) {
    using namespace cppbind::example;
    if (owner) {
        delete static_cast<std::shared_ptr<cppbind::example::Array<float, 4>>*>(cself.ptr);
    }
    free(cself.type);
}

CppBindCObject create_CppbindExample_Array4Float(CppBindCDataArray array, CppBindCObject* _Nonnull cppbind_err) {
    using namespace cppbind::example;
    std::array<float, 4> ctocxxarray {};
    auto data_array = reinterpret_cast<float*>(array.data);
    std::copy_n(data_array, 4, ctocxxarray.begin());
    try {
        auto this_object = new cppbind::example::Array<float, 4>(ctocxxarray);
        return {strdup(CPPBIND_CPPBIND_EXAMPLE_ARRAY4FLOAT), new std::shared_ptr<cppbind::example::Array<float, 4>>(this_object)};
    } catch (const std::exception& e) {
        cppbind_err->type = strdup(CPPBIND_STD_STDEXCEPTION);
        cppbind_err->ptr = new std::exception(e);
    } catch (...) {
...
float _func_CppbindExample_Array4Float__getitem_(CppBindCObject cself,int idx) {
    using namespace cppbind::example;
    std::shared_ptr<cppbind::example::Array<float, 4>> ctocxxcself;
    ctocxxcself = *static_cast<std::shared_ptr<cppbind::example::Array<float, 4>>*>(cself.ptr);
    decltype(auto) result = ctocxxcself->operator[](idx);
    
    return result;
}

void _func_CppbindExample_Array4Float__setitem_(CppBindCObject cself, int idx, float value) {
    using namespace cppbind::example;
...
void release_CppbindExample_Array4Int(CppBindCObject cself, bool owner) {
    using namespace cppbind::example;
    if (owner) {
        delete static_cast<std::shared_ptr<cppbind::example::Array<int, 4>>*>(cself.ptr);
    }
    free(cself.type);
}

CppBindCObject create_CppbindExample_Array4Int(CppBindCDataArray array, CppBindCObject* _Nonnull cppbind_err) {
    using namespace cppbind::example;
    std::array<int, 4> ctocxxarray {};
    auto data_array = reinterpret_cast<int*>(array.data);
    std::copy_n(data_array, 4, ctocxxarray.begin());
    try {
        auto this_object = new cppbind::example::Array<int, 4>(ctocxxarray);
        return {strdup(CPPBIND_CPPBIND_EXAMPLE_ARRAY4INT), new std::shared_ptr<cppbind::example::Array<int, 4>>(this_object)};
    } catch (const std::exception& e) {
        cppbind_err->type = strdup(CPPBIND_STD_STDEXCEPTION);
        cppbind_err->ptr = new std::exception(e);
    } catch (...) {
...
int _func_CppbindExample_Array4Int__getitem_(CppBindCObject cself,int idx) {
    using namespace cppbind::example;
    std::shared_ptr<cppbind::example::Array<int, 4>> ctocxxcself;
    ctocxxcself = *static_cast<std::shared_ptr<cppbind::example::Array<int, 4>>*>(cself.ptr);
    decltype(auto) result = ctocxxcself->operator[](idx);
    
    return result;
}

void _func_CppbindExample_Array4Int__setitem_(CppBindCObject cself, int idx, int value) {
    using namespace cppbind::example;
