...
void _prop_set_WrapperPairStrings_setValue(void* _Nonnull cself, CDataPair value){
...
void* _Nonnull create_WrapperPairIntInt(CDataPair value){
    ...
    return static_cast<iegen::example::Wrapper<std::pair<int, int>>*>(this_object);
}

CDataPair _prop_get_WrapperPairIntInt_value(void* _Nonnull cself){
    // we might need to avoid dynamic_cast if there is no multiple inheritance
    auto c_to_cxx_cself = dynamic_cast<iegen::example::Wrapper<std::pair<int, int>>*>(static_cast<iegen::example::Wrapper<std::pair<int, int>>*>(cself));
    auto result = c_to_cxx_cself->value();
...
void _prop_set_WrapperPairIntInt_setValue(void* _Nonnull cself, CDataPair value){
...
void* _Nonnull create_WrapperString(char* _Nonnull value){
    ...
    return static_cast<iegen::example::Wrapper<std::string>*>(this_object);
}

char* _Nonnull _prop_get_WrapperString_value(void* _Nonnull cself){
    // we might need to avoid dynamic_cast if there is no multiple inheritance
    auto c_to_cxx_cself = dynamic_cast<iegen::example::Wrapper<std::string>*>(static_cast<iegen::example::Wrapper<std::string>*>(cself));
    auto result = c_to_cxx_cself->value();
    auto cxx_to_c_result = strdup(result.c_str()); 
    return cxx_to_c_result;
}

void _prop_set_WrapperString_setValue(void* _Nonnull cself, char* _Nonnull value){
