...
CDataPair _prop_get_WrapperPairStrings_value(CObject cself){
    iegen::example::Wrapper<std::pair<std::string, std::string>>* ctocxxcself_ptr = nullptr;
    if (cself.ptr) {
        if (strcmp(cself.type, "iegen::example::Wrapper<std::pair<std::string, std::string>>") == 0)
            ctocxxcself_ptr = static_cast<iegen::example::Wrapper<std::pair<std::string, std::string>>*>(cself.ptr);
        else {
...
CDataPair _prop_get_WrapperPairIntInt_value(CObject cself){
    iegen::example::Wrapper<std::pair<int, int>>* ctocxxcself_ptr = nullptr;
    if (cself.ptr) {
        if (strcmp(cself.type, "iegen::example::Wrapper<std::pair<int, int>>") == 0)
            ctocxxcself_ptr = static_cast<iegen::example::Wrapper<std::pair<int, int>>*>(cself.ptr);
        else {
            std::cerr << "Unexpected object type: " << cself.type << std::endl;
            exit(1);
        }
...
char* _Nonnull _prop_get_WrapperString_value(CObject cself){
    iegen::example::Wrapper<std::string>* ctocxxcself_ptr = nullptr;
    if (cself.ptr) {
        if (strcmp(cself.type, "iegen::example::Wrapper<std::string>") == 0)
            ctocxxcself_ptr = static_cast<iegen::example::Wrapper<std::string>*>(cself.ptr);
        else {
            std::cerr << "Unexpected object type: " << cself.type << std::endl;
            exit(1);
        }
