...
IEGenCObject create_QueueIntShared(IEGenCErrorObj* _Nonnull err){
    try {
...
void _func_QueueIntShared_push_back(IEGenCObject cself, int element, IEGenCErrorObj* _Nonnull err){
...
int _func_QueueIntShared_get_size(IEGenCObject cself, IEGenCErrorObj* _Nonnull err){
...
IEGenCObject create_QueueIntSharedUsage(IEGenCObject q, IEGenCErrorObj* _Nonnull err){
...
int _func_QueueIntSharedUsage_getSize(IEGenCObject q, IEGenCErrorObj* _Nonnull err){
...
int _func_QueueIntSharedUsage_getLastElement(IEGenCObject q, IEGenCErrorObj* _Nonnull err){
...
int _func_QueueIntSharedUsage_getFirstElement(IEGenCObject q, IEGenCErrorObj* _Nonnull err){
...
IEGenCObject _func_QueueIntSharedUsage_getInvQueue(IEGenCDataArray v, IEGenCErrorObj* _Nonnull err){
...
IEGenCObject _func_QueueIntSharedUsage_getSavedQueue(IEGenCObject cself, IEGenCErrorObj* _Nonnull err){
