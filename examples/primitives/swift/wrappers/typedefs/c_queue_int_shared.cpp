...
IEGenCObject create_IegenExample_QueueIntShared(IEGenCObject* _Nonnull iegen_err) {
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_QUEUEINTSHARED), new std::shared_ptr<iegen::example::QueueIntShared>(this_object)};
...
IEGenCObject create_IegenExample_QueueIntSharedUsage(IEGenCObject q, IEGenCObject* _Nonnull iegen_err) {
    ...
    try {
        ...
        return {strdup(IEGEN_IEGEN_EXAMPLE_QUEUEINTSHAREDUSAGE), this_object};
    } catch (const std::exception& e) {
        iegen_err->type = strdup(IEGEN_STD_STDEXCEPTION);
        iegen_err->ptr = new std::exception(e);
    } catch (...) {
