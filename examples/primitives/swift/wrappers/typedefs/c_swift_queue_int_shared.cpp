 ...
 * 
 * This file is generated by cppbind on 09/07/2022-10:54.
...
#include <memory>
#include <type_traits>
#include "swift/wrappers/typedefs/c_swift_queue_int_shared.h"
...
int _func_CppbindExample_QueueIntSharedUsage_getSize(CppBindCObject q, CppBindCObject* _Nonnull cppbind_err) {
    ...
    try {
        decltype(auto) result = cppbind::example::QueueIntSharedUsage::getSize(ctocxxq);
...
int _func_CppbindExample_QueueIntSharedUsage_getLastElement(CppBindCObject q, CppBindCObject* _Nonnull cppbind_err) {
    ...
    try {
        decltype(auto) result = cppbind::example::QueueIntSharedUsage::getLastElement(ctocxxq);
...
int _func_CppbindExample_QueueIntSharedUsage_getFirstElement(CppBindCObject q, CppBindCObject* _Nonnull cppbind_err) {
    ...
    try {
        decltype(auto) result = cppbind::example::QueueIntSharedUsage::getFirstElement(ctocxxq);
...
CppBindCObject _func_CppbindExample_QueueIntSharedUsage_getInvQueue(CppBindCDataArray v, CppBindCObject* _Nonnull cppbind_err) {
    ...
    try {
        decltype(auto) result = cppbind::example::QueueIntSharedUsage::getInvQueue(ctocxxv);
        
        char* type_result = nullptr;
        void* cxxtocresult_ptr = nullptr;
        cxxtocresult_ptr = new std::shared_ptr<cppbind::example::QueueIntShared>(result);
