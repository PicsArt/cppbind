 ...
 * 
 * This file is generated by cppbind on 06/02/2022-09:26.
...
extern "C" JNIEXPORT void Java_example_1lib_cppbind_exception_1helpers_StdException_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
...
extern "C" JNIEXPORT jlong Java_example_1lib_cppbind_exception_1helpers_StdException_jGetcxxid(JNIEnv* env, jobject obj, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
...
extern "C" JNIEXPORT jstring Java_example_1lib_cppbind_exception_1helpers_StdException_jWhat(JNIEnv* env, jobject obj, jobjectid id){
...
extern "C" JNIEXPORT jstring Java_example_1lib_cppbind_exception_1helpers_Std_1exc_1classesKt_jGettypebyid(JNIEnv* env, jclass cls, jobjectid id) {
    validateID(id);
