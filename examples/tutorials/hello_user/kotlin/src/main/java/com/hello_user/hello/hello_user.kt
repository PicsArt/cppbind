 ...
 * `--'`------' `------' `------'`--'  `--' 
 * 
 * This file is generated by iegen on 11/04/2021-07:25.
...
internal constructor(_id: Long) : AutoCloseable {
    ...
    fun hello(user: UserInfo): String {
        val kotlin_to_jdk_user = user.id
        val result = jHello(id, kotlin_to_jdk_user)
    ...
    fun welcome(user: UserInfo): String {
        val kotlin_to_jdk_user = user.id
        val result = jWelcome(id, kotlin_to_jdk_user)
