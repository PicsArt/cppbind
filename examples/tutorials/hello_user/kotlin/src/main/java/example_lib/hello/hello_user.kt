 ...
 * 
 * This file is generated by cppbind on 08/08/2022-14:23.
...
internal constructor(obj: CppBindObject) : AutoCloseable {
    companion object {
         ...
         * Creates user
         */
        protected fun constructHelper(user_name: String, user_age: Long): Long {
     ...
     * Creates user
     */
    constructor(user_name: String, user_age: Long): this(CppBindObject(constructHelper(user_name, user_age), true)) {
    }
