...
extern "C" JNIEXPORT void Java_com_hello_1user_cppbind_exception_1helpers_StdException_jFinalize(JNIEnv* env, jobject obj, jobjectid id){
...
extern "C" JNIEXPORT jstring Java_com_hello_1user_cppbind_exception_1helpers_StdException_jWhat(JNIEnv* env, jobject obj, jobjectid id){
...
extern "C" JNIEXPORT jstring Java_com_hello_1user_cppbind_exception_1helpers_Std_1exc_1classesKt_jGettypebyid(JNIEnv* env, jclass cls, jobjectid id) {
    validateID(id);
