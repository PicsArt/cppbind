...
extern "C" JNIEXPORT void Java_example_1lib_cppbind_exception_1helpers_StdException_jFinalize(JNIEnv*, jobject, jobjectid id){
...
extern "C" JNIEXPORT jlong Java_example_1lib_cppbind_exception_1helpers_StdException_jGetcxxid(JNIEnv*, jobject, jobjectid id) {
    auto cppbind_obj_id = reinterpret_cast<CppBindCObject*>(id);
...
extern "C" JNIEXPORT jstring Java_example_1lib_cppbind_exception_1helpers_StdException_jWhat([[maybe_unused]] JNIEnv* env, jobject, jobjectid id){
...
extern "C" JNIEXPORT jstring Java_example_1lib_cppbind_exception_1helpers_Std_1exc_1classesKt_jGettypebyid(JNIEnv* env, jclass, jobjectid id) {
    validateID(id);
